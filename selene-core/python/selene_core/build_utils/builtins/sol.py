...
class SolObjectFileToSeleneExecutableStep(Step):
    """
    Link sol object with the shared Sol runtime and any shared utilities.
    """
    ...
    def apply(cls, build_ctx: BuildCtx, input_artifact: Artifact) -> Artifact:
        ...
        if build_ctx.verbose:
            print("Linking sol object file with shared Sol runtime")
...
def register_sol_builtins(planner: BuildPlanner) -> None:
    ...
    planner.add_step(SolObjectFileToSeleneExecutableStep)
