...
define private fastcc void @__hugr__.__main__.cx_within_tail.1() unnamed_addr {
alloca_block:
...
id_bb.i:                                          ; preds = %reset_bb.i, %alloca_block
  ...
  br i1 %.fca.0.extract.i, label %__hugr__.__tk2_qalloc.402.exit, label %cond_397_case_0.i

cond_397_case_0.i:                                ; preds = %id_bb.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.402.exit:                   ; preds = %id_bb.i
...
mask_block_ok.i.i.i:                              ; preds = %cond_exit_557.i
  %34 = load i64, i64* %3, align 4
  %35 = or i64 %34, -1048576
  store i64 %35, i64* %3, align 4
  %36 = icmp eq i64 %35, -1
  br i1 %36, label %"__hugr__.$guppylang.std.quantum.measure_array$$n(20).480.exit", label %mask_block_err.i.i.i

"__hugr__.$guppylang.std.quantum.measure_array$$n(20).480.exit": ; preds = %mask_block_ok.i.i.i
...
43:                                               ; preds = %29, %cond_exit_557.i
  %"506_0.sroa.15.0.i737" = phi i64 [ 0, %29 ], [ %44, %cond_exit_557.i ]
  %44 = add nuw nsw i64 %"506_0.sroa.15.0.i737", 1
  %45 = lshr i64 %"506_0.sroa.15.0.i737", 6
  %46 = getelementptr inbounds i64, i64* %3, i64 %45
  %47 = load i64, i64* %46, align 4
  %48 = shl nuw nsw i64 1, %"506_0.sroa.15.0.i737"
  %49 = and i64 %47, %48
  %.not.i101.i.i = icmp eq i64 %49, 0
...
__barray_check_bounds.exit.i:                     ; preds = %43
  ...
  %51 = getelementptr inbounds i64, i64* %1, i64 %"506_0.sroa.15.0.i737"
  ...
  br i1 %.not.i.i, label %panic.i.i, label %cond_exit_557.i

panic.i.i:                                        ; preds = %__barray_check_bounds.exit.i
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"e_Array alre.5A300C2A.0", i64 0, i64 0))
  unreachable

cond_exit_557.i:                                  ; preds = %__barray_check_bounds.exit.i
  %"571_054.fca.1.insert.i" = insertvalue { i1, i64, i1 } { i1 true, i64 poison, i1 poison }, i64 %lazy_measure.i, 1
  %56 = xor i64 %54, %48
  store i64 %56, i64* %53, align 4
  %57 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %31, i64 %"506_0.sroa.15.0.i737"
  store { i1, i64, i1 } %"571_054.fca.1.insert.i", { i1, i64, i1 }* %57, align 4
...
cond_21_case_1:                                   ; preds = %__hugr__.__tk2_qalloc.402.exit, %cond_exit_21
  %"16_0.sroa.0.0734" = phi i64 [ 0, %__hugr__.__tk2_qalloc.402.exit ], [ %58, %cond_exit_21 ]
...
id_bb.i668:                                       ; preds = %reset_bb.i666, %cond_21_case_1
  ...
  br i1 %.fca.0.extract.i667, label %__barray_check_bounds.exit673, label %cond_397_case_0.i670

cond_397_case_0.i670:                             ; preds = %id_bb.i668
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable
...
75:                                               ; preds = %cond_exit_91
  ...
  br i1 %.not, label %cond_150_case_0, label %cond_342_case_0
...
84:                                               ; preds = %__barray_check_none_borrowed.exit, %__hugr__.const_fun_328.331.exit
  %storemerge642742 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %102, %__hugr__.const_fun_328.331.exit ]
  %85 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %100, %__hugr__.const_fun_328.331.exit ]
  ...
  br i1 %.fca.0.extract118.i, label %cond_685_case_1.i, label %cond_exit_685.i

cond_685_case_1.i:                                ; preds = %84
  ...
  br label %cond_exit_685.i

cond_exit_685.i:                                  ; preds = %cond_685_case_1.i, %84
  %.pn.i = phi { i1, i64, i1 } [ %88, %cond_685_case_1.i ], [ %87, %84 ]
  %"04.sroa.6.0.i" = extractvalue { i1, i64, i1 } %.pn.i, 2
  %89 = icmp ult i64 %85, 20
  br i1 %89, label %90, label %cond_688_case_0.i

90:                                               ; preds = %cond_exit_685.i
  %91 = lshr i64 %85, 6
...
cond_688_case_1.i:                                ; preds = %90
  ...
  br i1 %99, label %cond_689_case_1.i, label %__hugr__.const_fun_328.331.exit

cond_689_case_1.i:                                ; preds = %cond_688_case_1.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @"e_Expected v.2F17E0A9.0", i64 0, i64 0))
  unreachable

__hugr__.const_fun_328.331.exit:                  ; preds = %cond_688_case_1.i
...
mask_block_ok.i694:                               ; preds = %__hugr__.const_fun_328.331.exit
...
__barray_check_none_borrowed.exit696:             ; preds = %mask_block_ok.i694
  ...
  br i1 %.fca.0.extract11.i, label %__hugr__.const_fun_324.328.exit, label %cond_730_case_0.i

cond_730_case_0.i:                                ; preds = %__hugr__.const_fun_324.328.exit.18, %__hugr__.const_fun_324.328.exit.17, %__hugr__.const_fun_324.328.exit.16, %__hugr__.const_fun_324.328.exit.15, %__hugr__.const_fun_324.328.exit.14, %__hugr__.const_fun_324.328.exit.13, %__hugr__.const_fun_324.328.exit.12, %__hugr__.const_fun_324.328.exit.11, %__hugr__.const_fun_324.328.exit.10, %__hugr__.const_fun_324.328.exit.9, %__hugr__.const_fun_324.328.exit.8, %__hugr__.const_fun_324.328.exit.7, %__hugr__.const_fun_324.328.exit.6, %__hugr__.const_fun_324.328.exit.5, %__hugr__.const_fun_324.328.exit.4, %__hugr__.const_fun_324.328.exit.3, %__hugr__.const_fun_324.328.exit.2, %__hugr__.const_fun_324.328.exit.1, %__hugr__.const_fun_324.328.exit, %__barray_check_none_borrowed.exit696
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @"e_Expected v.E6312129.0", i64 0, i64 0))
  unreachable

__hugr__.const_fun_324.328.exit:                  ; preds = %__barray_check_none_borrowed.exit696
  ...
  br i1 %.fca.0.extract11.i.1, label %__hugr__.const_fun_324.328.exit.1, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.1:                ; preds = %__hugr__.const_fun_324.328.exit
  ...
  br i1 %.fca.0.extract11.i.2, label %__hugr__.const_fun_324.328.exit.2, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.2:                ; preds = %__hugr__.const_fun_324.328.exit.1
  ...
  br i1 %.fca.0.extract11.i.3, label %__hugr__.const_fun_324.328.exit.3, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.3:                ; preds = %__hugr__.const_fun_324.328.exit.2
  ...
  br i1 %.fca.0.extract11.i.4, label %__hugr__.const_fun_324.328.exit.4, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.4:                ; preds = %__hugr__.const_fun_324.328.exit.3
  ...
  br i1 %.fca.0.extract11.i.5, label %__hugr__.const_fun_324.328.exit.5, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.5:                ; preds = %__hugr__.const_fun_324.328.exit.4
  ...
  br i1 %.fca.0.extract11.i.6, label %__hugr__.const_fun_324.328.exit.6, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.6:                ; preds = %__hugr__.const_fun_324.328.exit.5
  ...
  br i1 %.fca.0.extract11.i.7, label %__hugr__.const_fun_324.328.exit.7, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.7:                ; preds = %__hugr__.const_fun_324.328.exit.6
  ...
  br i1 %.fca.0.extract11.i.8, label %__hugr__.const_fun_324.328.exit.8, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.8:                ; preds = %__hugr__.const_fun_324.328.exit.7
  ...
  br i1 %.fca.0.extract11.i.9, label %__hugr__.const_fun_324.328.exit.9, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.9:                ; preds = %__hugr__.const_fun_324.328.exit.8
  ...
  br i1 %.fca.0.extract11.i.10, label %__hugr__.const_fun_324.328.exit.10, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.10:               ; preds = %__hugr__.const_fun_324.328.exit.9
  ...
  br i1 %.fca.0.extract11.i.11, label %__hugr__.const_fun_324.328.exit.11, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.11:               ; preds = %__hugr__.const_fun_324.328.exit.10
  ...
  br i1 %.fca.0.extract11.i.12, label %__hugr__.const_fun_324.328.exit.12, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.12:               ; preds = %__hugr__.const_fun_324.328.exit.11
  ...
  br i1 %.fca.0.extract11.i.13, label %__hugr__.const_fun_324.328.exit.13, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.13:               ; preds = %__hugr__.const_fun_324.328.exit.12
  ...
  br i1 %.fca.0.extract11.i.14, label %__hugr__.const_fun_324.328.exit.14, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.14:               ; preds = %__hugr__.const_fun_324.328.exit.13
  ...
  br i1 %.fca.0.extract11.i.15, label %__hugr__.const_fun_324.328.exit.15, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.15:               ; preds = %__hugr__.const_fun_324.328.exit.14
  ...
  br i1 %.fca.0.extract11.i.16, label %__hugr__.const_fun_324.328.exit.16, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.16:               ; preds = %__hugr__.const_fun_324.328.exit.15
  ...
  br i1 %.fca.0.extract11.i.17, label %__hugr__.const_fun_324.328.exit.17, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.17:               ; preds = %__hugr__.const_fun_324.328.exit.16
  ...
  br i1 %.fca.0.extract11.i.18, label %__hugr__.const_fun_324.328.exit.18, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.18:               ; preds = %__hugr__.const_fun_324.328.exit.17
  ...
  br i1 %.fca.0.extract11.i.19, label %__hugr__.const_fun_324.328.exit.19, label %cond_730_case_0.i

__hugr__.const_fun_324.328.exit.19:               ; preds = %__hugr__.const_fun_324.328.exit.18
...
cond_644_case_0:                                  ; preds = %cond_exit_644
...
mask_block_err.i700:                              ; preds = %cond_644_case_0
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([70 x i8], [70 x i8]* @"e_Array cont.EFA5AC45.0", i64 0, i64 0))
  unreachable

__barray_check_bounds.exit702:                    ; preds = %__hugr__.const_fun_324.328.exit.19, %cond_exit_644
  %"641_0.0755" = phi i64 [ 0, %__hugr__.const_fun_324.328.exit.19 ], [ %229, %cond_exit_644 ]
  %229 = add nuw nsw i64 %"641_0.0755", 1
  %230 = lshr i64 %"641_0.0755", 6
  %231 = getelementptr inbounds i64, i64* %109, i64 %230
  %232 = load i64, i64* %231, align 4
  %233 = shl nuw nsw i64 1, %"641_0.0755"
  %234 = and i64 %232, %233
  %.not732 = icmp eq i64 %234, 0
  br i1 %.not732, label %__barray_mask_borrow.exit707, label %cond_exit_644

__barray_mask_borrow.exit707:                     ; preds = %__barray_check_bounds.exit702
  %235 = xor i64 %232, %233
  store i64 %235, i64* %231, align 4
  %236 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %107, i64 %"641_0.0755"
  %237 = load { i1, i64, i1 }, { i1, i64, i1 }* %236, align 4
  %.fca.0.extract399 = extractvalue { i1, i64, i1 } %237, 0
  br i1 %.fca.0.extract399, label %cond_667_case_1, label %cond_exit_644

cond_exit_644:                                    ; preds = %cond_667_case_1, %__barray_mask_borrow.exit707, %__barray_check_bounds.exit702
  %238 = icmp ult i64 %"641_0.0755", 19
  br i1 %238, label %__barray_check_bounds.exit702, label %cond_644_case_0

loop_out312:                                      ; preds = %cond_644_case_0
...
cond_667_case_1:                                  ; preds = %__barray_mask_borrow.exit707
  %.fca.1.extract400 = extractvalue { i1, i64, i1 } %237, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract400)
  br label %cond_exit_644

245:                                              ; preds = %__barray_check_none_borrowed.exit712, %__hugr__.array.__read_bool.3.364.exit
  %storemerge744 = phi i64 [ 0, %__barray_check_none_borrowed.exit712 ], [ %250, %__hugr__.array.__read_bool.3.364.exit ]
  ...
  br i1 %.fca.0.extract.i713, label %cond_376_case_1.i, label %cond_376_case_0.i

cond_376_case_0.i:                                ; preds = %245
  %.fca.2.extract.i = extractvalue { i1, i64, i1 } %247, 2
  br label %__hugr__.array.__read_bool.3.364.exit

cond_376_case_1.i:                                ; preds = %245
...
__hugr__.array.__read_bool.3.364.exit:            ; preds = %cond_376_case_0.i, %cond_376_case_1.i
  %"03.0.i" = phi i1 [ %read_bool.i, %cond_376_case_1.i ], [ %.fca.2.extract.i, %cond_376_case_0.i ]
...
mask_block_ok.i717:                               ; preds = %__hugr__.array.__read_bool.3.364.exit
...
entry:
  ...
  tail call fastcc void @__hugr__.__main__.cx_within_tail.1()
