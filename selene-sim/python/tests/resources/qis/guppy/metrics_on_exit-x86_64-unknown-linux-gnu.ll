...
define private fastcc i64 @__hugr__.__tk2_qalloc.39() unnamed_addr {
alloca_block:
...
id_bb:                                            ; preds = %alloca_block, %reset_bb
  ...
  br i1 %.fca.0.extract, label %cond_43_case_1, label %cond_43_case_0

cond_43_case_1:                                   ; preds = %id_bb
  %.fca.1.extract = extractvalue { i1, i64 } %1, 1
  ret i64 %.fca.1.extract

cond_43_case_0:                                   ; preds = %id_bb
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable
}

define private fastcc i64 @__hugr__.__tk2_h.53(i64 returned %0) unnamed_addr {
alloca_block:
...
define private fastcc i64 @__hugr__.__tk2_toffoli.64(i64 returned %0, i64 %1, i64 %2) unnamed_addr {
alloca_block:
...
entry:
  ...
  %2 = tail call fastcc i64 @__hugr__.__tk2_h.53(i64 %1)
  %3 = tail call fastcc i64 @__hugr__.__tk2_qalloc.39()
  %4 = tail call fastcc i64 @__hugr__.__tk2_qalloc.39()
  %5 = tail call fastcc i64 @__hugr__.__tk2_toffoli.64(i64 %1, i64 %3, i64 %4)
