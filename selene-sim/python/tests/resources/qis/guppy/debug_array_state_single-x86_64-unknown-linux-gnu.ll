...
define private fastcc void @__hugr__.__main__.debug_array_state_single.1() unnamed_addr {
alloca_block:
...
id_bb.i:                                          ; preds = %reset_bb.i, %alloca_block
  ...
  br i1 %.fca.0.extract.i, label %__hugr__.__tk2_qalloc.275.exit, label %cond_270_case_0.i

cond_270_case_0.i:                                ; preds = %id_bb.i.1, %id_bb.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.275.exit:                   ; preds = %id_bb.i
  %20 = load i64, i64* %3, align 4
  %21 = and i64 %20, 1
  %.not.i353 = icmp eq i64 %21, 0
  br i1 %.not.i353, label %panic.i354, label %cond_exit_20

panic.i354:                                       ; preds = %__barray_check_bounds.exit352.1, %__hugr__.__tk2_qalloc.275.exit
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"e_Array alre.5A300C2A.0", i64 0, i64 0))
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_qalloc.275.exit
...
id_bb.i.1:                                        ; preds = %reset_bb.i.1, %cond_exit_20
  ...
  br i1 %.fca.0.extract.i.1, label %__barray_check_bounds.exit352.1, label %cond_270_case_0.i
...
__barray_mask_return.exit363:                     ; preds = %__barray_mask_check_not_borrowed.exit
  ...
  %50 = and i64 %49, 1
  %.not.i364 = icmp eq i64 %50, 0
  br i1 %.not.i364, label %__barray_mask_borrow.exit.i, label %__barray_check_bounds.exit.1.i

__barray_check_bounds.exit.1.i:                   ; preds = %__barray_mask_borrow.exit.i, %__barray_mask_return.exit363
  %51 = phi i64 [ %.pre, %__barray_mask_borrow.exit.i ], [ %49, %__barray_mask_return.exit363 ]
  %52 = and i64 %51, 2
  %.not.1.i = icmp eq i64 %52, 0
  br i1 %.not.1.i, label %__barray_mask_borrow.exit.1.i, label %cond_exit_371.i

__barray_mask_borrow.exit.1.i:                    ; preds = %__barray_check_bounds.exit.1.i
  %53 = xor i64 %51, 2
  store i64 %53, i64* %3, align 4
  %54 = getelementptr inbounds i8, i8* %0, i64 8
  %55 = bitcast i8* %54 to i64*
  %56 = load i64, i64* %55, align 4
  call void @___qfree(i64 %56)
  %.pre.i = load i64, i64* %3, align 4
  br label %cond_exit_371.i

cond_exit_371.i:                                  ; preds = %__barray_mask_borrow.exit.1.i, %__barray_check_bounds.exit.1.i
  %57 = phi i64 [ %.pre.i, %__barray_mask_borrow.exit.1.i ], [ %51, %__barray_check_bounds.exit.1.i ]
  %58 = or i64 %57, -4
  store i64 %58, i64* %3, align 4
  %59 = icmp eq i64 %58, -1
  br i1 %59, label %"__hugr__.$guppylang.std.quantum.discard_array$$n(2).328.exit", label %mask_block_err.i.i
...
__barray_mask_borrow.exit.i:                      ; preds = %__barray_mask_return.exit363
  %60 = xor i64 %49, 1
  store i64 %60, i64* %3, align 4
  %61 = load i64, i64* %1, align 4
  call void @___qfree(i64 %61)
...
entry:
  ...
  tail call fastcc void @__hugr__.__main__.debug_array_state_single.1()
