...
id_bb.i.i:                                        ; preds = %reset_bb.i.i, %entry
  ...
  br i1 %.fca.0.extract.i.i, label %__hugr__.__main__.broken_plugin_prog.1.exit, label %cond_21_case_0.i.i

cond_21_case_0.i.i:                               ; preds = %id_bb.i.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__main__.broken_plugin_prog.1.exit:      ; preds = %id_bb.i.i
