...
id_bb.i.i:                                        ; preds = %reset_bb.i.i, %entry
  ...
  br i1 %.fca.0.extract.i.i, label %__hugr__.__tk2_qalloc.24.exit.i, label %cond_28_case_0.i.i

cond_28_case_0.i.i:                               ; preds = %id_bb.i.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.24.exit.i:                  ; preds = %id_bb.i.i
  ...
  %qalloc.i48.i = tail call i64 @___qalloc()
  %not_max.not.i49.i = icmp eq i64 %qalloc.i48.i, -1
  br i1 %not_max.not.i49.i, label %id_bb.i52.i, label %reset_bb.i50.i

reset_bb.i50.i:                                   ; preds = %__hugr__.__tk2_qalloc.24.exit.i
  tail call void @___reset(i64 %qalloc.i48.i)
  br label %id_bb.i52.i

id_bb.i52.i:                                      ; preds = %reset_bb.i50.i, %__hugr__.__tk2_qalloc.24.exit.i
  %3 = insertvalue { i1, i64 } { i1 true, i64 poison }, i64 %qalloc.i48.i, 1
  %4 = select i1 %not_max.not.i49.i, { i1, i64 } { i1 false, i64 poison }, { i1, i64 } %3
  %.fca.0.extract.i51.i = extractvalue { i1, i64 } %4, 0
  br i1 %.fca.0.extract.i51.i, label %__hugr__.__main__.depolarising_2q_measure.1.exit, label %cond_28_case_0.i54.i

cond_28_case_0.i54.i:                             ; preds = %id_bb.i52.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__main__.depolarising_2q_measure.1.exit: ; preds = %id_bb.i52.i
  %.fca.1.extract.i53.i = extractvalue { i1, i64 } %4, 1
  ...
  tail call void @___rxy(i64 %.fca.1.extract.i53.i, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %.fca.1.extract.i53.i, double 0x400921FB54442D18)
  %lazy_measure22.i = tail call i64 @___lazy_measure(i64 %.fca.1.extract.i53.i)
  tail call void @___qfree(i64 %.fca.1.extract.i53.i)
  ...
  tail call void @print_bool(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @res_c2.60825383.0, i64 0, i64 0), i64 12, i1 %read_bool35.i)
