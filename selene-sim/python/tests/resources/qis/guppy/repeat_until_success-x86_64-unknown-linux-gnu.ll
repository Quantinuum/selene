...
cond_191_case_1.i.i:                              ; preds = %__hugr__.__tk2_qalloc.83.exit135.i.i
  ...
  br i1 %read_bool80.i.i, label %__hugr__.__main__.repeat_until_success.1.exit, label %8
...
__hugr__.__main__.repeat_until_success.1.exit:    ; preds = %cond_191_case_1.i.i
