...
define private fastcc void @__hugr__.__main__.debug_qubit_ordering.1() unnamed_addr {
alloca_block:
...
id_bb.i:                                          ; preds = %reset_bb.i, %alloca_block
  ...
  br i1 %.fca.0.extract.i, label %__hugr__.__tk2_qalloc.244.exit, label %cond_239_case_0.i

cond_239_case_0.i:                                ; preds = %id_bb.i.1, %id_bb.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.244.exit:                   ; preds = %id_bb.i
  %6 = load i64, i64* %3, align 4
  %7 = and i64 %6, 1
  %.not.i = icmp eq i64 %7, 0
  br i1 %.not.i, label %panic.i, label %cond_exit_20

panic.i:                                          ; preds = %__barray_check_bounds.exit.1, %__hugr__.__tk2_qalloc.244.exit
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"e_Array alre.5A300C2A.0", i64 0, i64 0))
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_qalloc.244.exit
...
id_bb.i.1:                                        ; preds = %reset_bb.i.1, %cond_exit_20
  ...
  br i1 %.fca.0.extract.i.1, label %__barray_check_bounds.exit.1, label %cond_239_case_0.i
...
__barray_mask_return.exit282:                     ; preds = %__barray_mask_return.exit279
  ...
  %82 = and i64 %81, 1
  %.not.i283 = icmp eq i64 %82, 0
  br i1 %.not.i283, label %__barray_mask_borrow.exit.i, label %__barray_check_bounds.exit.1.i

__barray_check_bounds.exit.1.i:                   ; preds = %__barray_mask_borrow.exit.i, %__barray_mask_return.exit282
  %83 = phi i64 [ %.pre, %__barray_mask_borrow.exit.i ], [ %81, %__barray_mask_return.exit282 ]
  %84 = and i64 %83, 2
  %.not.1.i = icmp eq i64 %84, 0
  br i1 %.not.1.i, label %__barray_mask_borrow.exit.1.i, label %cond_exit_342.i

__barray_mask_borrow.exit.1.i:                    ; preds = %__barray_check_bounds.exit.1.i
  %85 = xor i64 %83, 2
  store i64 %85, i64* %3, align 4
  %86 = load i64, i64* %30, align 4
  call void @___qfree(i64 %86)
...
cond_exit_342.i:                                  ; preds = %__barray_mask_borrow.exit.1.i, %__barray_check_bounds.exit.1.i
  %87 = phi i64 [ %.pre.i, %__barray_mask_borrow.exit.1.i ], [ %83, %__barray_check_bounds.exit.1.i ]
  %88 = or i64 %87, -4
  store i64 %88, i64* %3, align 4
  %89 = icmp eq i64 %88, -1
  br i1 %89, label %"__hugr__.$guppylang.std.quantum.discard_array$$n(2).298.exit", label %mask_block_err.i.i
...
__barray_mask_borrow.exit.i:                      ; preds = %__barray_mask_return.exit282
  %90 = xor i64 %81, 1
  store i64 %90, i64* %3, align 4
  %91 = load i64, i64* %1, align 4
  call void @___qfree(i64 %91)
...
entry:
  ...
  tail call fastcc void @__hugr__.__main__.debug_qubit_ordering.1()
