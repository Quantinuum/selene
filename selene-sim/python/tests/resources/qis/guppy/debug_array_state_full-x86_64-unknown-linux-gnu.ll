...
define private fastcc void @__hugr__.__main__.debug_array_state_full.1() unnamed_addr {
alloca_block:
...
__barray_mask_return.exit.1:                      ; preds = %__barray_check_bounds.exit321.1
  ...
  %18 = icmp eq i64 %17, 0
  br i1 %18, label %__barray_check_bounds.exit.1.i, label %mask_block_err.i
...
id_bb.i:                                          ; preds = %reset_bb.i, %alloca_block
  ...
  br i1 %.fca.0.extract.i, label %__hugr__.__tk2_qalloc.266.exit, label %cond_261_case_0.i

cond_261_case_0.i:                                ; preds = %id_bb.i.1, %id_bb.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.266.exit:                   ; preds = %id_bb.i
  %21 = load i64, i64* %3, align 4
  %22 = and i64 %21, 1
  %.not.i332 = icmp eq i64 %22, 0
  br i1 %.not.i332, label %panic.i333, label %cond_exit_20

panic.i333:                                       ; preds = %__barray_check_bounds.exit331.1, %__hugr__.__tk2_qalloc.266.exit
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"e_Array alre.5A300C2A.0", i64 0, i64 0))
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_qalloc.266.exit
...
id_bb.i.1:                                        ; preds = %reset_bb.i.1, %cond_exit_20
  ...
  br i1 %.fca.0.extract.i.1, label %__barray_check_bounds.exit331.1, label %cond_261_case_0.i
...
__barray_check_bounds.exit.1.i:                   ; preds = %__barray_mask_return.exit.1
  ...
  %39 = and i64 %38, 2
  %.not.1.i = icmp eq i64 %39, 0
  br i1 %.not.1.i, label %__barray_mask_borrow.exit.1.i, label %cond_exit_361.i
...
__barray_mask_borrow.exit.1.i:                    ; preds = %__barray_check_bounds.exit.1.i
  ...
  %.pre.i = load i64, i64* %36, align 4
  br label %cond_exit_361.i

cond_exit_361.i:                                  ; preds = %__barray_mask_borrow.exit.1.i, %__barray_check_bounds.exit.1.i
  %44 = phi i64 [ %.pre.i, %__barray_mask_borrow.exit.1.i ], [ %38, %__barray_check_bounds.exit.1.i ]
  %45 = or i64 %44, -4
  store i64 %45, i64* %36, align 4
  %46 = icmp eq i64 %45, -1
  br i1 %46, label %"__hugr__.$guppylang.std.quantum.discard_array$$n(2).318.exit", label %mask_block_err.i.i
...
entry:
  ...
  tail call fastcc void @__hugr__.__main__.debug_array_state_full.1()
