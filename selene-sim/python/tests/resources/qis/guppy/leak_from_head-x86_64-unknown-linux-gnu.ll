...
define private fastcc void @__hugr__.__main__.cx_from_head.1() unnamed_addr {
alloca_block:
...
id_bb.i:                                          ; preds = %reset_bb.i, %alloca_block
  ...
  br i1 %.fca.0.extract.i, label %__hugr__.__tk2_qalloc.385.exit, label %cond_380_case_0.i

cond_380_case_0.i:                                ; preds = %id_bb.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.385.exit:                   ; preds = %id_bb.i
...
mask_block_ok.i.i.i:                              ; preds = %cond_exit_522.i
  %23 = load i64, i64* %3, align 4
  %24 = or i64 %23, -1048576
  store i64 %24, i64* %3, align 4
  %25 = icmp eq i64 %24, -1
  br i1 %25, label %"__hugr__.$guppylang.std.quantum.measure_array$$n(20).445.exit", label %mask_block_err.i.i.i

"__hugr__.$guppylang.std.quantum.measure_array$$n(20).445.exit": ; preds = %mask_block_ok.i.i.i
...
32:                                               ; preds = %18, %cond_exit_522.i
  %"471_0.sroa.15.0.i686" = phi i64 [ 0, %18 ], [ %33, %cond_exit_522.i ]
  %33 = add nuw nsw i64 %"471_0.sroa.15.0.i686", 1
  %34 = lshr i64 %"471_0.sroa.15.0.i686", 6
  %35 = getelementptr inbounds i64, i64* %3, i64 %34
  %36 = load i64, i64* %35, align 4
  %37 = shl nuw nsw i64 1, %"471_0.sroa.15.0.i686"
  %38 = and i64 %36, %37
  %.not.i101.i.i = icmp eq i64 %38, 0
...
__barray_check_bounds.exit.i:                     ; preds = %32
  ...
  %40 = getelementptr inbounds i64, i64* %1, i64 %"471_0.sroa.15.0.i686"
  ...
  br i1 %.not.i.i, label %panic.i.i, label %cond_exit_522.i

panic.i.i:                                        ; preds = %__barray_check_bounds.exit.i
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"e_Array alre.5A300C2A.0", i64 0, i64 0))
  unreachable

cond_exit_522.i:                                  ; preds = %__barray_check_bounds.exit.i
  %"536_054.fca.1.insert.i" = insertvalue { i1, i64, i1 } { i1 true, i64 poison, i1 poison }, i64 %lazy_measure.i, 1
  %45 = xor i64 %43, %37
  store i64 %45, i64* %42, align 4
  %46 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %20, i64 %"471_0.sroa.15.0.i686"
  store { i1, i64, i1 } %"536_054.fca.1.insert.i", { i1, i64, i1 }* %46, align 4
...
cond_21_case_1:                                   ; preds = %__hugr__.__tk2_qalloc.385.exit, %cond_exit_21
  %"16_0.sroa.0.0683" = phi i64 [ 0, %__hugr__.__tk2_qalloc.385.exit ], [ %47, %cond_exit_21 ]
...
id_bb.i625:                                       ; preds = %reset_bb.i623, %cond_21_case_1
  ...
  br i1 %.fca.0.extract.i624, label %__barray_check_bounds.exit630, label %cond_380_case_0.i627

cond_380_case_0.i627:                             ; preds = %id_bb.i625
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable
...
57:                                               ; preds = %cond_exit_82
  ...
  br i1 %.not, label %cond_133_case_0, label %cond_326_case_0
...
66:                                               ; preds = %__barray_check_none_borrowed.exit, %__hugr__.const_fun_312.315.exit
  %storemerge609691 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %84, %__hugr__.const_fun_312.315.exit ]
  %67 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %82, %__hugr__.const_fun_312.315.exit ]
  ...
  br i1 %.fca.0.extract118.i, label %cond_649_case_1.i, label %cond_exit_649.i

cond_649_case_1.i:                                ; preds = %66
  ...
  br label %cond_exit_649.i

cond_exit_649.i:                                  ; preds = %cond_649_case_1.i, %66
  %.pn.i = phi { i1, i64, i1 } [ %70, %cond_649_case_1.i ], [ %69, %66 ]
  %"04.sroa.6.0.i" = extractvalue { i1, i64, i1 } %.pn.i, 2
  %71 = icmp ult i64 %67, 20
  br i1 %71, label %72, label %cond_652_case_0.i

72:                                               ; preds = %cond_exit_649.i
  %73 = lshr i64 %67, 6
...
cond_652_case_1.i:                                ; preds = %72
  ...
  br i1 %81, label %cond_653_case_1.i, label %__hugr__.const_fun_312.315.exit

cond_653_case_1.i:                                ; preds = %cond_652_case_1.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @"e_Expected v.2F17E0A9.0", i64 0, i64 0))
  unreachable

__hugr__.const_fun_312.315.exit:                  ; preds = %cond_652_case_1.i
...
mask_block_ok.i643:                               ; preds = %__hugr__.const_fun_312.315.exit
...
__barray_check_none_borrowed.exit645:             ; preds = %mask_block_ok.i643
  ...
  br i1 %.fca.0.extract11.i, label %__hugr__.const_fun_308.312.exit, label %cond_694_case_0.i

cond_694_case_0.i:                                ; preds = %__hugr__.const_fun_308.312.exit.18, %__hugr__.const_fun_308.312.exit.17, %__hugr__.const_fun_308.312.exit.16, %__hugr__.const_fun_308.312.exit.15, %__hugr__.const_fun_308.312.exit.14, %__hugr__.const_fun_308.312.exit.13, %__hugr__.const_fun_308.312.exit.12, %__hugr__.const_fun_308.312.exit.11, %__hugr__.const_fun_308.312.exit.10, %__hugr__.const_fun_308.312.exit.9, %__hugr__.const_fun_308.312.exit.8, %__hugr__.const_fun_308.312.exit.7, %__hugr__.const_fun_308.312.exit.6, %__hugr__.const_fun_308.312.exit.5, %__hugr__.const_fun_308.312.exit.4, %__hugr__.const_fun_308.312.exit.3, %__hugr__.const_fun_308.312.exit.2, %__hugr__.const_fun_308.312.exit.1, %__hugr__.const_fun_308.312.exit, %__barray_check_none_borrowed.exit645
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @"e_Expected v.E6312129.0", i64 0, i64 0))
  unreachable

__hugr__.const_fun_308.312.exit:                  ; preds = %__barray_check_none_borrowed.exit645
  ...
  br i1 %.fca.0.extract11.i.1, label %__hugr__.const_fun_308.312.exit.1, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.1:                ; preds = %__hugr__.const_fun_308.312.exit
  ...
  br i1 %.fca.0.extract11.i.2, label %__hugr__.const_fun_308.312.exit.2, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.2:                ; preds = %__hugr__.const_fun_308.312.exit.1
  ...
  br i1 %.fca.0.extract11.i.3, label %__hugr__.const_fun_308.312.exit.3, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.3:                ; preds = %__hugr__.const_fun_308.312.exit.2
  ...
  br i1 %.fca.0.extract11.i.4, label %__hugr__.const_fun_308.312.exit.4, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.4:                ; preds = %__hugr__.const_fun_308.312.exit.3
  ...
  br i1 %.fca.0.extract11.i.5, label %__hugr__.const_fun_308.312.exit.5, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.5:                ; preds = %__hugr__.const_fun_308.312.exit.4
  ...
  br i1 %.fca.0.extract11.i.6, label %__hugr__.const_fun_308.312.exit.6, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.6:                ; preds = %__hugr__.const_fun_308.312.exit.5
  ...
  br i1 %.fca.0.extract11.i.7, label %__hugr__.const_fun_308.312.exit.7, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.7:                ; preds = %__hugr__.const_fun_308.312.exit.6
  ...
  br i1 %.fca.0.extract11.i.8, label %__hugr__.const_fun_308.312.exit.8, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.8:                ; preds = %__hugr__.const_fun_308.312.exit.7
  ...
  br i1 %.fca.0.extract11.i.9, label %__hugr__.const_fun_308.312.exit.9, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.9:                ; preds = %__hugr__.const_fun_308.312.exit.8
  ...
  br i1 %.fca.0.extract11.i.10, label %__hugr__.const_fun_308.312.exit.10, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.10:               ; preds = %__hugr__.const_fun_308.312.exit.9
  ...
  br i1 %.fca.0.extract11.i.11, label %__hugr__.const_fun_308.312.exit.11, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.11:               ; preds = %__hugr__.const_fun_308.312.exit.10
  ...
  br i1 %.fca.0.extract11.i.12, label %__hugr__.const_fun_308.312.exit.12, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.12:               ; preds = %__hugr__.const_fun_308.312.exit.11
  ...
  br i1 %.fca.0.extract11.i.13, label %__hugr__.const_fun_308.312.exit.13, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.13:               ; preds = %__hugr__.const_fun_308.312.exit.12
  ...
  br i1 %.fca.0.extract11.i.14, label %__hugr__.const_fun_308.312.exit.14, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.14:               ; preds = %__hugr__.const_fun_308.312.exit.13
  ...
  br i1 %.fca.0.extract11.i.15, label %__hugr__.const_fun_308.312.exit.15, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.15:               ; preds = %__hugr__.const_fun_308.312.exit.14
  ...
  br i1 %.fca.0.extract11.i.16, label %__hugr__.const_fun_308.312.exit.16, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.16:               ; preds = %__hugr__.const_fun_308.312.exit.15
  ...
  br i1 %.fca.0.extract11.i.17, label %__hugr__.const_fun_308.312.exit.17, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.17:               ; preds = %__hugr__.const_fun_308.312.exit.16
  ...
  br i1 %.fca.0.extract11.i.18, label %__hugr__.const_fun_308.312.exit.18, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.18:               ; preds = %__hugr__.const_fun_308.312.exit.17
  ...
  br i1 %.fca.0.extract11.i.19, label %__hugr__.const_fun_308.312.exit.19, label %cond_694_case_0.i

__hugr__.const_fun_308.312.exit.19:               ; preds = %__hugr__.const_fun_308.312.exit.18
...
cond_608_case_0:                                  ; preds = %cond_exit_608
...
mask_block_err.i649:                              ; preds = %cond_608_case_0
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([70 x i8], [70 x i8]* @"e_Array cont.EFA5AC45.0", i64 0, i64 0))
  unreachable

__barray_check_bounds.exit651:                    ; preds = %__hugr__.const_fun_308.312.exit.19, %cond_exit_608
  %"605_0.0704" = phi i64 [ 0, %__hugr__.const_fun_308.312.exit.19 ], [ %211, %cond_exit_608 ]
  %211 = add nuw nsw i64 %"605_0.0704", 1
  %212 = lshr i64 %"605_0.0704", 6
  %213 = getelementptr inbounds i64, i64* %91, i64 %212
  %214 = load i64, i64* %213, align 4
  %215 = shl nuw nsw i64 1, %"605_0.0704"
  %216 = and i64 %214, %215
  %.not681 = icmp eq i64 %216, 0
  br i1 %.not681, label %__barray_mask_borrow.exit656, label %cond_exit_608

__barray_mask_borrow.exit656:                     ; preds = %__barray_check_bounds.exit651
  %217 = xor i64 %214, %215
  store i64 %217, i64* %213, align 4
  %218 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %89, i64 %"605_0.0704"
  %219 = load { i1, i64, i1 }, { i1, i64, i1 }* %218, align 4
  %.fca.0.extract369 = extractvalue { i1, i64, i1 } %219, 0
  br i1 %.fca.0.extract369, label %cond_631_case_1, label %cond_exit_608

cond_exit_608:                                    ; preds = %cond_631_case_1, %__barray_mask_borrow.exit656, %__barray_check_bounds.exit651
  %220 = icmp ult i64 %"605_0.0704", 19
  br i1 %220, label %__barray_check_bounds.exit651, label %cond_608_case_0

loop_out282:                                      ; preds = %cond_608_case_0
...
cond_631_case_1:                                  ; preds = %__barray_mask_borrow.exit656
  %.fca.1.extract370 = extractvalue { i1, i64, i1 } %219, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract370)
  br label %cond_exit_608

227:                                              ; preds = %__barray_check_none_borrowed.exit661, %__hugr__.array.__read_bool.3.347.exit
  %storemerge693 = phi i64 [ 0, %__barray_check_none_borrowed.exit661 ], [ %232, %__hugr__.array.__read_bool.3.347.exit ]
  ...
  br i1 %.fca.0.extract.i662, label %cond_360_case_1.i, label %cond_360_case_0.i

cond_360_case_0.i:                                ; preds = %227
  %.fca.2.extract.i = extractvalue { i1, i64, i1 } %229, 2
  br label %__hugr__.array.__read_bool.3.347.exit

cond_360_case_1.i:                                ; preds = %227
...
__hugr__.array.__read_bool.3.347.exit:            ; preds = %cond_360_case_0.i, %cond_360_case_1.i
  %"03.0.i" = phi i1 [ %read_bool.i, %cond_360_case_1.i ], [ %.fca.2.extract.i, %cond_360_case_0.i ]
...
mask_block_ok.i666:                               ; preds = %__hugr__.array.__read_bool.3.347.exit
...
entry:
  ...
  tail call fastcc void @__hugr__.__main__.cx_from_head.1()
