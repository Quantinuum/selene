...
__hugr__.__tk2_helios_qalloc.36.exit:             ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i101, label %cond_54_case_0.i, label %__hugr__.__tk2_helios_qalloc.50.exit
...
__hugr__.__tk2_helios_qalloc.50.exit:             ; preds = %__hugr__.__tk2_helios_qalloc.36.exit
  ...
  tail call void @___rxy(i64 %qalloc.i100, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i100, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i100, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i100, double 0xBFF921FB54442D18)
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.50.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_mask_check_not_borrowed.exit103:         ; preds = %__hugr__.__tk2_helios_qalloc.50.exit
