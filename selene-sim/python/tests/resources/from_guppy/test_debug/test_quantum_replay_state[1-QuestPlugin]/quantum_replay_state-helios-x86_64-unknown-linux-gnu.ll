...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_40_case_0.i, label %__hugr__.__tk2_qalloc.36.exit
...
__hugr__.__tk2_qalloc.36.exit:                    ; preds = %alloca_block
  ...
  %qalloc.i127 = tail call i64 @___qalloc()
  %not_max.not.not.i128 = icmp eq i64 %qalloc.i127, -1
  br i1 %not_max.not.not.i128, label %cond_54_case_0.i, label %__hugr__.__tk2_qalloc.50.exit
...
__hugr__.__tk2_qalloc.50.exit:                    ; preds = %__hugr__.__tk2_qalloc.36.exit
  tail call void @___reset(i64 %qalloc.i127)
  tail call void @___rxy(i64 %qalloc.i127, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i127, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i127, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i127, double 0xBFF921FB54442D18)
  ...
  store i64 %qalloc.i127, ptr %2, align 4
  %3 = load i64, ptr %1, align 4
  %4 = and i64 %3, 3
  store i64 %4, ptr %1, align 4
  %5 = icmp eq i64 %4, 0
  br i1 %5, label %__barray_mask_check_not_borrowed.exit130, label %mask_block_err.i

mask_block_err.i:                                 ; preds = %__hugr__.__tk2_qalloc.50.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_mask_check_not_borrowed.exit130:         ; preds = %__hugr__.__tk2_qalloc.50.exit
  ...
  %.repack126 = getelementptr inbounds nuw i8, ptr %6, i64 1
  store i1 false, ptr %.repack126, align 1
  ...
  %14 = icmp eq i64 %13, 0
  br i1 %14, label %__barray_mask_check_not_borrowed.exit134, label %mask_block_err.i131

mask_block_err.i131:                              ; preds = %__barray_mask_check_not_borrowed.exit130
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_mask_check_not_borrowed.exit134:         ; preds = %__barray_mask_check_not_borrowed.exit130
  ...
  %out_arr_alloca47 = alloca <{ i32, i32, ptr, ptr }>, align 8
  %y_ptr49 = getelementptr inbounds nuw i8, ptr %out_arr_alloca47, i64 4
  %arr_ptr50 = getelementptr inbounds nuw i8, ptr %out_arr_alloca47, i64 8
  %mask_ptr51 = getelementptr inbounds nuw i8, ptr %out_arr_alloca47, i64 16
  %15 = alloca i1, align 1
  store i1 false, ptr %15, align 1
  store i32 1, ptr %out_arr_alloca47, align 8
  store i32 1, ptr %y_ptr49, align 4
  store ptr %10, ptr %arr_ptr50, align 8
  store ptr %15, ptr %mask_ptr51, align 8
  call void @print_state_result(ptr nonnull @res_post_measu.3B49B396.0, i64 33, ptr nonnull %out_arr_alloca47)
  %16 = call ptr @heap_alloc(i64 8)
  store i64 0, ptr %16, align 1
  %17 = load i64, ptr %10, align 4
  %lazy_measure62 = call i64 @___lazy_measure(i64 %17)
  call void @___qfree(i64 %17)
  %read_bool75 = call i1 @___read_future_bool(i64 %lazy_measure62)
  call void @___dec_future_refcount(i64 %lazy_measure62)
  call void @print_bool(ptr nonnull @res_c1.1F7A6571.0, i64 12, i1 %read_bool75)
  ret void
}
