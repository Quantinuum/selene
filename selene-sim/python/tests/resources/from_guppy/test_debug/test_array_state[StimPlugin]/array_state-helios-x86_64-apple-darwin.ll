...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_244_case_0.i, label %__hugr__.__tk2_qalloc.248.exit

cond_244_case_0.i:                                ; preds = %cond_exit_20, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.248.exit:                   ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %2 = load i64, ptr %1, align 4
  %3 = trunc i64 %2 to i1
  br i1 %3, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.1, %__hugr__.__tk2_qalloc.248.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_qalloc.248.exit
  %4 = and i64 %2, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_244_case_0.i, label %__barray_check_bounds.exit.1
...
cond_exit_20.1:                                   ; preds = %__barray_check_bounds.exit.1
  ...
  br i1 %10, label %panic.i321, label %__barray_check_bounds.exit323

panic.i321:                                       ; preds = %__barray_check_bounds.exit320.1, %cond_exit_20.1
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

__barray_check_bounds.exit323:                    ; preds = %cond_exit_20.1
  ...
  br i1 %14, label %__barray_check_bounds.exit320.1, label %panic.i324

panic.i324:                                       ; preds = %__barray_check_bounds.exit323.1, %__barray_check_bounds.exit323
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

__barray_check_bounds.exit320.1:                  ; preds = %__barray_check_bounds.exit323
  %15 = and i64 %13, -2
  store i64 %15, ptr %1, align 4
  store i64 %12, ptr %0, align 4
  %16 = load i64, ptr %1, align 4
  %17 = and i64 %16, 2
  %.not341 = icmp eq i64 %17, 0
  br i1 %.not341, label %__barray_check_bounds.exit323.1, label %panic.i321

__barray_check_bounds.exit323.1:                  ; preds = %__barray_check_bounds.exit320.1
  ...
  %21 = and i64 %20, 2
  %.not342 = icmp eq i64 %21, 0
  br i1 %.not342, label %panic.i324, label %__barray_mask_return.exit325.1

__barray_mask_return.exit325.1:                   ; preds = %__barray_check_bounds.exit323.1
  %22 = and i64 %20, -3
...
mask_block_err.i:                                 ; preds = %__barray_mask_return.exit325.1
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_bounds.exit.1.i:                   ; preds = %__barray_mask_return.exit325.1
  ...
  %.repack312 = getelementptr inbounds nuw i8, ptr %26, i64 1
  store i1 false, ptr %.repack312, align 1
  ...
  br i1 %.not.i, label %__barray_mask_borrow.exit.1.i, label %cond_exit_361.i
...
__barray_mask_borrow.exit.1.i:                    ; preds = %__barray_check_bounds.exit.1.i
  ...
  br label %cond_exit_361.i

cond_exit_361.i:                                  ; preds = %__barray_mask_borrow.exit.1.i, %__barray_check_bounds.exit.1.i
  %33 = phi i64 [ %.pre.i, %__barray_mask_borrow.exit.1.i ], [ %29, %__barray_check_bounds.exit.1.i ]
  %34 = or i64 %33, -4
  store i64 %34, ptr %27, align 4
  %35 = icmp eq i64 %34, -1
  br i1 %35, label %"__hugr__.$guppylang.std.quantum.discard_array$$n(2).318.exit", label %mask_block_err.i.i

mask_block_err.i.i:                               ; preds = %cond_exit_361.i
  call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable

"__hugr__.$guppylang.std.quantum.discard_array$$n(2).318.exit": ; preds = %cond_exit_361.i
