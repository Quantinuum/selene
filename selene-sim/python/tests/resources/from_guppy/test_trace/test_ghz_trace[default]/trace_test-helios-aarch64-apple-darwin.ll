...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit

cond_442_case_0.i:                                ; preds = %cond_exit_12.8, %cond_exit_12.7, %cond_exit_12.6, %cond_exit_12.5, %cond_exit_12.4, %cond_exit_12.3, %cond_exit_12.2, %cond_exit_12.1, %cond_exit_12, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.438.exit:            ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %6 = load i64, ptr %5, align 4
  %7 = trunc i64 %6 to i1
  br i1 %7, label %cond_exit_12, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.9, %__hugr__.__tk2_helios_qalloc.438.exit.8, %__hugr__.__tk2_helios_qalloc.438.exit.7, %__hugr__.__tk2_helios_qalloc.438.exit.6, %__hugr__.__tk2_helios_qalloc.438.exit.5, %__hugr__.__tk2_helios_qalloc.438.exit.4, %__hugr__.__tk2_helios_qalloc.438.exit.3, %__hugr__.__tk2_helios_qalloc.438.exit.2, %__hugr__.__tk2_helios_qalloc.438.exit.1, %__hugr__.__tk2_helios_qalloc.438.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_12:                                     ; preds = %__hugr__.__tk2_helios_qalloc.438.exit
  %8 = and i64 %6, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.1

__hugr__.__tk2_helios_qalloc.438.exit.1:          ; preds = %cond_exit_12
...
cond_exit_12.1:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.1
  %11 = and i64 %9, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.2

__hugr__.__tk2_helios_qalloc.438.exit.2:          ; preds = %cond_exit_12.1
...
cond_exit_12.2:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.2
  %15 = and i64 %13, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.3

__hugr__.__tk2_helios_qalloc.438.exit.3:          ; preds = %cond_exit_12.2
...
cond_exit_12.3:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.3
  %19 = and i64 %17, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.4

__hugr__.__tk2_helios_qalloc.438.exit.4:          ; preds = %cond_exit_12.3
...
cond_exit_12.4:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.4
  %23 = and i64 %21, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.5

__hugr__.__tk2_helios_qalloc.438.exit.5:          ; preds = %cond_exit_12.4
...
cond_exit_12.5:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.5
  %27 = and i64 %25, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.6

__hugr__.__tk2_helios_qalloc.438.exit.6:          ; preds = %cond_exit_12.5
...
cond_exit_12.6:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.6
  %31 = and i64 %29, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.7

__hugr__.__tk2_helios_qalloc.438.exit.7:          ; preds = %cond_exit_12.6
...
cond_exit_12.7:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.7
  %35 = and i64 %33, -129
  ...
  br i1 %not_max.not.not.i.8, label %cond_442_case_0.i, label %__hugr__.__tk2_helios_qalloc.438.exit.8

__hugr__.__tk2_helios_qalloc.438.exit.8:          ; preds = %cond_exit_12.7
...
cond_exit_12.8:                                   ; preds = %__hugr__.__tk2_helios_qalloc.438.exit.8
  %39 = and i64 %37, -257
  ...
  br i1 %not_max.not.not.i.9, label %cond_442_case_0.i, label %__barray_check_bounds.exit.9
...
__barray_mask_borrow.exit:                        ; preds = %cond_exit_12.9
  ...
  tail call void @___rxy(i64 %48, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit1129:                   ; preds = %__barray_check_bounds.exit1125
  ...
  tail call void @___rxy(i64 %65, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %59, i64 %65, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %59, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %65, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %65, double 0xBFF921FB54442D18)
...
.thread:                                          ; preds = %loop_body346.preheader
  ...
  %___lazy_measure = tail call i64 @___lazy_measure(i64 %88)
...
cond_exit_241:                                    ; preds = %__barray_check_bounds.exit1137
  ...
  store i64 %___lazy_measure, ptr %93, align 4
...
mask_block_err.i1159:                             ; preds = %cond_exit_488.9
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable
...
__barray_mask_borrow.exit1167:                    ; preds = %__barray_check_bounds.exit1163.preheader
  ...
  br label %cond_exit_488

cond_exit_488:                                    ; preds = %__barray_mask_borrow.exit1167, %__barray_check_bounds.exit1163.preheader
  %112 = load i64, ptr %3, align 4
  %113 = and i64 %112, 2
  %.not1206 = icmp eq i64 %113, 0
  br i1 %.not1206, label %__barray_mask_borrow.exit1167.1, label %cond_exit_488.1

__barray_mask_borrow.exit1167.1:                  ; preds = %cond_exit_488
  %114 = or disjoint i64 %112, 2
  store i64 %114, ptr %3, align 4
  %115 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %116 = load i64, ptr %115, align 4
  tail call void @___dec_future_refcount(i64 %116)
  br label %cond_exit_488.1

cond_exit_488.1:                                  ; preds = %__barray_mask_borrow.exit1167.1, %cond_exit_488
  %117 = load i64, ptr %3, align 4
  %118 = and i64 %117, 4
  %.not1207 = icmp eq i64 %118, 0
  br i1 %.not1207, label %__barray_mask_borrow.exit1167.2, label %cond_exit_488.2

__barray_mask_borrow.exit1167.2:                  ; preds = %cond_exit_488.1
  ...
  br label %cond_exit_488.2

cond_exit_488.2:                                  ; preds = %__barray_mask_borrow.exit1167.2, %cond_exit_488.1
  %122 = load i64, ptr %3, align 4
  %123 = and i64 %122, 8
  %.not1208 = icmp eq i64 %123, 0
  br i1 %.not1208, label %__barray_mask_borrow.exit1167.3, label %cond_exit_488.3

__barray_mask_borrow.exit1167.3:                  ; preds = %cond_exit_488.2
  ...
  br label %cond_exit_488.3

cond_exit_488.3:                                  ; preds = %__barray_mask_borrow.exit1167.3, %cond_exit_488.2
  %127 = load i64, ptr %3, align 4
  %128 = and i64 %127, 16
  %.not1209 = icmp eq i64 %128, 0
  br i1 %.not1209, label %__barray_mask_borrow.exit1167.4, label %cond_exit_488.4

__barray_mask_borrow.exit1167.4:                  ; preds = %cond_exit_488.3
  ...
  br label %cond_exit_488.4

cond_exit_488.4:                                  ; preds = %__barray_mask_borrow.exit1167.4, %cond_exit_488.3
  %132 = load i64, ptr %3, align 4
  %133 = and i64 %132, 32
  %.not1210 = icmp eq i64 %133, 0
  br i1 %.not1210, label %__barray_mask_borrow.exit1167.5, label %cond_exit_488.5

__barray_mask_borrow.exit1167.5:                  ; preds = %cond_exit_488.4
  ...
  br label %cond_exit_488.5

cond_exit_488.5:                                  ; preds = %__barray_mask_borrow.exit1167.5, %cond_exit_488.4
  %137 = load i64, ptr %3, align 4
  %138 = and i64 %137, 64
  %.not1211 = icmp eq i64 %138, 0
  br i1 %.not1211, label %__barray_mask_borrow.exit1167.6, label %cond_exit_488.6

__barray_mask_borrow.exit1167.6:                  ; preds = %cond_exit_488.5
  ...
  br label %cond_exit_488.6

cond_exit_488.6:                                  ; preds = %__barray_mask_borrow.exit1167.6, %cond_exit_488.5
  %142 = load i64, ptr %3, align 4
  %143 = and i64 %142, 128
  %.not1212 = icmp eq i64 %143, 0
  br i1 %.not1212, label %__barray_mask_borrow.exit1167.7, label %cond_exit_488.7

__barray_mask_borrow.exit1167.7:                  ; preds = %cond_exit_488.6
  ...
  br label %cond_exit_488.7

cond_exit_488.7:                                  ; preds = %__barray_mask_borrow.exit1167.7, %cond_exit_488.6
  %147 = load i64, ptr %3, align 4
  %148 = and i64 %147, 256
  %.not1213 = icmp eq i64 %148, 0
  br i1 %.not1213, label %__barray_mask_borrow.exit1167.8, label %cond_exit_488.8

__barray_mask_borrow.exit1167.8:                  ; preds = %cond_exit_488.7
  ...
  br label %cond_exit_488.8

cond_exit_488.8:                                  ; preds = %__barray_mask_borrow.exit1167.8, %cond_exit_488.7
  %152 = load i64, ptr %3, align 4
  %153 = and i64 %152, 512
  %.not1214 = icmp eq i64 %153, 0
  br i1 %.not1214, label %__barray_mask_borrow.exit1167.9, label %cond_exit_488.9

__barray_mask_borrow.exit1167.9:                  ; preds = %cond_exit_488.8
  ...
  br label %cond_exit_488.9

cond_exit_488.9:                                  ; preds = %__barray_mask_borrow.exit1167.9, %cond_exit_488.8
...
__barray_check_bounds.exit1163.preheader:         ; preds = %cond_exit_307
  ...
  br i1 %164, label %cond_exit_488, label %__barray_mask_borrow.exit1167

loop_out454:                                      ; preds = %cond_exit_488.9
