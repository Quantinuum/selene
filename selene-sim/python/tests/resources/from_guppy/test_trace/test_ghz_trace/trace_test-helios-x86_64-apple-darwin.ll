...
cond_exit_20:                                     ; preds = %__barray_check_bounds.exit
  ...
  br i1 %not_max.not.not.i.1, label %cond_492_case_0.i, label %__barray_check_bounds.exit.1
...
cond_exit_20.1:                                   ; preds = %__barray_check_bounds.exit.1
  ...
  br i1 %not_max.not.not.i.2, label %cond_492_case_0.i, label %__barray_check_bounds.exit.2
...
cond_exit_20.2:                                   ; preds = %__barray_check_bounds.exit.2
  ...
  br i1 %not_max.not.not.i.3, label %cond_492_case_0.i, label %__barray_check_bounds.exit.3
...
cond_exit_20.3:                                   ; preds = %__barray_check_bounds.exit.3
  ...
  br i1 %not_max.not.not.i.4, label %cond_492_case_0.i, label %__barray_check_bounds.exit.4
...
cond_exit_20.4:                                   ; preds = %__barray_check_bounds.exit.4
  ...
  br i1 %not_max.not.not.i.5, label %cond_492_case_0.i, label %__barray_check_bounds.exit.5
...
cond_exit_20.5:                                   ; preds = %__barray_check_bounds.exit.5
  ...
  br i1 %not_max.not.not.i.6, label %cond_492_case_0.i, label %__barray_check_bounds.exit.6
...
cond_exit_20.6:                                   ; preds = %__barray_check_bounds.exit.6
  ...
  br i1 %not_max.not.not.i.7, label %cond_492_case_0.i, label %__barray_check_bounds.exit.7
...
cond_exit_20.7:                                   ; preds = %__barray_check_bounds.exit.7
  ...
  br i1 %not_max.not.not.i.8, label %cond_492_case_0.i, label %__barray_check_bounds.exit.8
...
loop_body.preheader.i.i:                          ; preds = %loop_body.i386
  %"512_1.sroa.10.0.i.i" = extractvalue { ptr, ptr, i64 } %175, 2
  %"512_1.sroa.5.0.i.i" = extractvalue { ptr, ptr, i64 } %175, 1
  %"512_1.sroa.0.0.i.i" = extractvalue { ptr, ptr, i64 } %175, 0
...
cond_515_case_0.i.i:                              ; preds = %cond_exit_515.thread.i.i
  %134 = lshr i64 %"512_1.sroa.10.0.i.i", 6
  %135 = getelementptr i64, ptr %"512_1.sroa.5.0.i.i", i64 %134
  %136 = load i64, ptr %135, align 4
  %137 = and i64 %"512_1.sroa.10.0.i.i", 63
  ...
  %last_valid.i.i.i388 = add i64 %"512_1.sroa.10.0.i.i", 9
  %143 = lshr i64 %last_valid.i.i.i388, 6
  %144 = getelementptr inbounds nuw i64, ptr %"512_1.sroa.5.0.i.i", i64 %143
...
mask_block_ok.i.i.i391:                           ; preds = %cond_515_case_0.i.i, %151
  %.02.i.i.i392 = phi i64 [ %152, %151 ], [ 0, %cond_515_case_0.i.i ]
...
__barray_check_bounds.exit224.i.i:                ; preds = %cond_exit_515.thread.i.i, %loop_body.preheader.i.i
  %"512_0.0239.i.i" = phi i64 [ 0, %loop_body.preheader.i.i ], [ %155, %cond_exit_515.thread.i.i ]
  %155 = add nuw nsw i64 %"512_0.0239.i.i", 1
  %156 = add i64 %"512_0.0239.i.i", %"512_1.sroa.10.0.i.i"
  %157 = lshr i64 %156, 6
  %158 = getelementptr inbounds nuw i64, ptr %"512_1.sroa.5.0.i.i", i64 %157
  %159 = load i64, ptr %158, align 4
  %160 = and i64 %156, 63
  %161 = lshr i64 %159, %160
  %162 = trunc i64 %161 to i1
  br i1 %162, label %cond_exit_515.thread.i.i, label %__barray_mask_borrow.exit228.i.i
...
__barray_mask_borrow.exit228.i.i:                 ; preds = %__barray_check_bounds.exit224.i.i
  ...
  %165 = getelementptr inbounds i64, ptr %"512_1.sroa.0.0.i.i", i64 %156
  %166 = load i64, ptr %165, align 4
  tail call void @___dec_future_refcount(i64 %166)
  br label %cond_exit_515.thread.i.i

cond_exit_515.thread.i.i:                         ; preds = %__barray_mask_borrow.exit228.i.i, %__barray_check_bounds.exit224.i.i
  %exitcond.i.i = icmp eq i64 %155, 10
  br i1 %exitcond.i.i, label %cond_515_case_0.i.i, label %__barray_check_bounds.exit224.i.i
...
"__hugr__.guppylang.std.quantum.collect_measurements$10.215.exit": ; preds = %151, %cond_515_case_0.i.i
