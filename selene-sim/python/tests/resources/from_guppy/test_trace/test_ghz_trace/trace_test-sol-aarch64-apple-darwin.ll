...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit
...
__hugr__.__tk2_sol_qalloc.464.exit:               ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %2 = load i64, ptr %1, align 4
  %3 = trunc i64 %2 to i1
  br i1 %3, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.9, %__hugr__.__tk2_sol_qalloc.464.exit.8, %__hugr__.__tk2_sol_qalloc.464.exit.7, %__hugr__.__tk2_sol_qalloc.464.exit.6, %__hugr__.__tk2_sol_qalloc.464.exit.5, %__hugr__.__tk2_sol_qalloc.464.exit.4, %__hugr__.__tk2_sol_qalloc.464.exit.3, %__hugr__.__tk2_sol_qalloc.464.exit.2, %__hugr__.__tk2_sol_qalloc.464.exit.1, %__hugr__.__tk2_sol_qalloc.464.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_sol_qalloc.464.exit
  %4 = and i64 %2, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.1

__hugr__.__tk2_sol_qalloc.464.exit.1:             ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.1
  %7 = and i64 %5, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.2

__hugr__.__tk2_sol_qalloc.464.exit.2:             ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.2
  %11 = and i64 %9, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.3

__hugr__.__tk2_sol_qalloc.464.exit.3:             ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.3
  %15 = and i64 %13, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.4

__hugr__.__tk2_sol_qalloc.464.exit.4:             ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.4
  %19 = and i64 %17, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.5

__hugr__.__tk2_sol_qalloc.464.exit.5:             ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.5
  %23 = and i64 %21, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.6

__hugr__.__tk2_sol_qalloc.464.exit.6:             ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.6
  %27 = and i64 %25, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.7

__hugr__.__tk2_sol_qalloc.464.exit.7:             ; preds = %cond_exit_20.6
...
cond_exit_20.7:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.7
  %31 = and i64 %29, -129
  ...
  br i1 %not_max.not.not.i.8, label %cond_491_case_0.i, label %__hugr__.__tk2_sol_qalloc.464.exit.8

__hugr__.__tk2_sol_qalloc.464.exit.8:             ; preds = %cond_exit_20.7
...
cond_exit_20.8:                                   ; preds = %__hugr__.__tk2_sol_qalloc.464.exit.8
  %35 = and i64 %33, -257
...
loop_body.preheader.i.i:                          ; preds = %loop_body.i386
  %"511_1.sroa.10.0.i.i" = extractvalue { ptr, ptr, i64 } %266, 2
  %"511_1.sroa.5.0.i.i" = extractvalue { ptr, ptr, i64 } %266, 1
  %"511_1.sroa.0.0.i.i" = extractvalue { ptr, ptr, i64 } %266, 0
  %118 = lshr i64 %"511_1.sroa.10.0.i.i", 6
  %119 = getelementptr i64, ptr %"511_1.sroa.5.0.i.i", i64 %118
  %120 = load i64, ptr %119, align 4
  %121 = and i64 %"511_1.sroa.10.0.i.i", 63
  %122 = lshr i64 %120, %121
  %123 = trunc i64 %122 to i1
  br i1 %123, label %cond_exit_514.thread.i.i, label %__barray_mask_borrow.exit228.i.i
...
mask_block_ok.i.i.i390:                           ; preds = %cond_exit_514.thread.9.i.i, %140
  %.02.i.i.i391 = phi i64 [ %141, %140 ], [ 0, %cond_exit_514.thread.9.i.i ]
...
__barray_mask_borrow.exit228.i.i:                 ; preds = %loop_body.preheader.i.i
  ...
  %146 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %"511_1.sroa.10.0.i.i"
  %147 = load i64, ptr %146, align 4
  tail call void @___dec_future_refcount(i64 %147)
  br label %cond_exit_514.thread.i.i

cond_exit_514.thread.i.i:                         ; preds = %__barray_mask_borrow.exit228.i.i, %loop_body.preheader.i.i
  %148 = add i64 %"511_1.sroa.10.0.i.i", 1
  %149 = lshr i64 %148, 6
  %150 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %149
  %151 = load i64, ptr %150, align 4
  %152 = and i64 %148, 63
  %153 = lshr i64 %151, %152
  %154 = trunc i64 %153 to i1
  br i1 %154, label %cond_exit_514.thread.1.i.i, label %__barray_mask_borrow.exit228.1.i.i

__barray_mask_borrow.exit228.1.i.i:               ; preds = %cond_exit_514.thread.i.i
  %155 = shl nuw i64 1, %152
  %156 = xor i64 %151, %155
  store i64 %156, ptr %150, align 4
  %157 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %148
  %158 = load i64, ptr %157, align 4
  tail call void @___dec_future_refcount(i64 %158)
  br label %cond_exit_514.thread.1.i.i

cond_exit_514.thread.1.i.i:                       ; preds = %__barray_mask_borrow.exit228.1.i.i, %cond_exit_514.thread.i.i
  %159 = add i64 %"511_1.sroa.10.0.i.i", 2
  %160 = lshr i64 %159, 6
  %161 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %160
  %162 = load i64, ptr %161, align 4
  %163 = and i64 %159, 63
  %164 = lshr i64 %162, %163
  %165 = trunc i64 %164 to i1
  br i1 %165, label %cond_exit_514.thread.2.i.i, label %__barray_mask_borrow.exit228.2.i.i

__barray_mask_borrow.exit228.2.i.i:               ; preds = %cond_exit_514.thread.1.i.i
  %166 = shl nuw i64 1, %163
  %167 = xor i64 %162, %166
  store i64 %167, ptr %161, align 4
  %168 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %159
  %169 = load i64, ptr %168, align 4
  tail call void @___dec_future_refcount(i64 %169)
  br label %cond_exit_514.thread.2.i.i

cond_exit_514.thread.2.i.i:                       ; preds = %__barray_mask_borrow.exit228.2.i.i, %cond_exit_514.thread.1.i.i
  %170 = add i64 %"511_1.sroa.10.0.i.i", 3
  %171 = lshr i64 %170, 6
  %172 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %171
  %173 = load i64, ptr %172, align 4
  %174 = and i64 %170, 63
  %175 = lshr i64 %173, %174
  %176 = trunc i64 %175 to i1
  br i1 %176, label %cond_exit_514.thread.3.i.i, label %__barray_mask_borrow.exit228.3.i.i

__barray_mask_borrow.exit228.3.i.i:               ; preds = %cond_exit_514.thread.2.i.i
  %177 = shl nuw i64 1, %174
  %178 = xor i64 %173, %177
  store i64 %178, ptr %172, align 4
  %179 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %170
  %180 = load i64, ptr %179, align 4
  tail call void @___dec_future_refcount(i64 %180)
  br label %cond_exit_514.thread.3.i.i

cond_exit_514.thread.3.i.i:                       ; preds = %__barray_mask_borrow.exit228.3.i.i, %cond_exit_514.thread.2.i.i
  %181 = add i64 %"511_1.sroa.10.0.i.i", 4
  %182 = lshr i64 %181, 6
  %183 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %182
  %184 = load i64, ptr %183, align 4
  %185 = and i64 %181, 63
  %186 = lshr i64 %184, %185
  %187 = trunc i64 %186 to i1
  br i1 %187, label %cond_exit_514.thread.4.i.i, label %__barray_mask_borrow.exit228.4.i.i

__barray_mask_borrow.exit228.4.i.i:               ; preds = %cond_exit_514.thread.3.i.i
  %188 = shl nuw i64 1, %185
  %189 = xor i64 %184, %188
  store i64 %189, ptr %183, align 4
  %190 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %181
  %191 = load i64, ptr %190, align 4
  tail call void @___dec_future_refcount(i64 %191)
  br label %cond_exit_514.thread.4.i.i

cond_exit_514.thread.4.i.i:                       ; preds = %__barray_mask_borrow.exit228.4.i.i, %cond_exit_514.thread.3.i.i
  %192 = add i64 %"511_1.sroa.10.0.i.i", 5
  %193 = lshr i64 %192, 6
  %194 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %193
  %195 = load i64, ptr %194, align 4
  %196 = and i64 %192, 63
  %197 = lshr i64 %195, %196
  %198 = trunc i64 %197 to i1
  br i1 %198, label %cond_exit_514.thread.5.i.i, label %__barray_mask_borrow.exit228.5.i.i

__barray_mask_borrow.exit228.5.i.i:               ; preds = %cond_exit_514.thread.4.i.i
  %199 = shl nuw i64 1, %196
  %200 = xor i64 %195, %199
  store i64 %200, ptr %194, align 4
  %201 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %192
  %202 = load i64, ptr %201, align 4
  tail call void @___dec_future_refcount(i64 %202)
  br label %cond_exit_514.thread.5.i.i

cond_exit_514.thread.5.i.i:                       ; preds = %__barray_mask_borrow.exit228.5.i.i, %cond_exit_514.thread.4.i.i
  %203 = add i64 %"511_1.sroa.10.0.i.i", 6
  %204 = lshr i64 %203, 6
  %205 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %204
  %206 = load i64, ptr %205, align 4
  %207 = and i64 %203, 63
  %208 = lshr i64 %206, %207
  %209 = trunc i64 %208 to i1
  br i1 %209, label %cond_exit_514.thread.6.i.i, label %__barray_mask_borrow.exit228.6.i.i

__barray_mask_borrow.exit228.6.i.i:               ; preds = %cond_exit_514.thread.5.i.i
  %210 = shl nuw i64 1, %207
  %211 = xor i64 %206, %210
  store i64 %211, ptr %205, align 4
  %212 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %203
  %213 = load i64, ptr %212, align 4
  tail call void @___dec_future_refcount(i64 %213)
  br label %cond_exit_514.thread.6.i.i

cond_exit_514.thread.6.i.i:                       ; preds = %__barray_mask_borrow.exit228.6.i.i, %cond_exit_514.thread.5.i.i
  %214 = add i64 %"511_1.sroa.10.0.i.i", 7
  %215 = lshr i64 %214, 6
  %216 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %215
  %217 = load i64, ptr %216, align 4
  %218 = and i64 %214, 63
  %219 = lshr i64 %217, %218
  %220 = trunc i64 %219 to i1
  br i1 %220, label %cond_exit_514.thread.7.i.i, label %__barray_mask_borrow.exit228.7.i.i

__barray_mask_borrow.exit228.7.i.i:               ; preds = %cond_exit_514.thread.6.i.i
  %221 = shl nuw i64 1, %218
  %222 = xor i64 %217, %221
  store i64 %222, ptr %216, align 4
  %223 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %214
  %224 = load i64, ptr %223, align 4
  tail call void @___dec_future_refcount(i64 %224)
  br label %cond_exit_514.thread.7.i.i

cond_exit_514.thread.7.i.i:                       ; preds = %__barray_mask_borrow.exit228.7.i.i, %cond_exit_514.thread.6.i.i
  %225 = add i64 %"511_1.sroa.10.0.i.i", 8
  %226 = lshr i64 %225, 6
  %227 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %226
  %228 = load i64, ptr %227, align 4
  %229 = and i64 %225, 63
  %230 = lshr i64 %228, %229
  %231 = trunc i64 %230 to i1
  br i1 %231, label %cond_exit_514.thread.8.i.i, label %__barray_mask_borrow.exit228.8.i.i

__barray_mask_borrow.exit228.8.i.i:               ; preds = %cond_exit_514.thread.7.i.i
  %232 = shl nuw i64 1, %229
  %233 = xor i64 %228, %232
  store i64 %233, ptr %227, align 4
  %234 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %225
  %235 = load i64, ptr %234, align 4
  tail call void @___dec_future_refcount(i64 %235)
  br label %cond_exit_514.thread.8.i.i

cond_exit_514.thread.8.i.i:                       ; preds = %__barray_mask_borrow.exit228.8.i.i, %cond_exit_514.thread.7.i.i
  %236 = add i64 %"511_1.sroa.10.0.i.i", 9
  %237 = lshr i64 %236, 6
  %238 = getelementptr inbounds nuw i64, ptr %"511_1.sroa.5.0.i.i", i64 %237
  %239 = load i64, ptr %238, align 4
  %240 = and i64 %236, 63
  %241 = lshr i64 %239, %240
  %242 = trunc i64 %241 to i1
  br i1 %242, label %cond_exit_514.thread.9.i.i, label %__barray_mask_borrow.exit228.9.i.i

__barray_mask_borrow.exit228.9.i.i:               ; preds = %cond_exit_514.thread.8.i.i
  %243 = shl nuw i64 1, %240
  %244 = xor i64 %239, %243
  store i64 %244, ptr %238, align 4
  %245 = getelementptr inbounds i64, ptr %"511_1.sroa.0.0.i.i", i64 %236
  %246 = load i64, ptr %245, align 4
  tail call void @___dec_future_refcount(i64 %246)
  br label %cond_exit_514.thread.9.i.i

cond_exit_514.thread.9.i.i:                       ; preds = %__barray_mask_borrow.exit228.9.i.i, %cond_exit_514.thread.8.i.i
...
"__hugr__.guppylang.std.quantum.collect_measurements$10.215.exit": ; preds = %140, %cond_exit_514.thread.9.i.i
