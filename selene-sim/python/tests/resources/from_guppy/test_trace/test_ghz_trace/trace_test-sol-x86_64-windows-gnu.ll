...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_373_case_0.i, label %__barray_check_bounds.exit

cond_373_case_0.i:                                ; preds = %cond_exit_20.8, %cond_exit_20.7, %cond_exit_20.6, %cond_exit_20.5, %cond_exit_20.4, %cond_exit_20.3, %cond_exit_20.2, %cond_exit_20.1, %cond_exit_20, %alloca_block
...
cond_exit_20:                                     ; preds = %__barray_check_bounds.exit
  ...
  br i1 %not_max.not.not.i.1, label %cond_373_case_0.i, label %__barray_check_bounds.exit.1
...
cond_exit_20.1:                                   ; preds = %__barray_check_bounds.exit.1
  ...
  br i1 %not_max.not.not.i.2, label %cond_373_case_0.i, label %__barray_check_bounds.exit.2
...
cond_exit_20.2:                                   ; preds = %__barray_check_bounds.exit.2
  ...
  br i1 %not_max.not.not.i.3, label %cond_373_case_0.i, label %__barray_check_bounds.exit.3
...
cond_exit_20.3:                                   ; preds = %__barray_check_bounds.exit.3
  ...
  br i1 %not_max.not.not.i.4, label %cond_373_case_0.i, label %__barray_check_bounds.exit.4
...
cond_exit_20.4:                                   ; preds = %__barray_check_bounds.exit.4
  ...
  br i1 %not_max.not.not.i.5, label %cond_373_case_0.i, label %__barray_check_bounds.exit.5
...
cond_exit_20.5:                                   ; preds = %__barray_check_bounds.exit.5
  ...
  br i1 %not_max.not.not.i.6, label %cond_373_case_0.i, label %__barray_check_bounds.exit.6
...
cond_exit_20.6:                                   ; preds = %__barray_check_bounds.exit.6
  ...
  br i1 %not_max.not.not.i.7, label %cond_373_case_0.i, label %__barray_check_bounds.exit.7
...
cond_exit_20.7:                                   ; preds = %__barray_check_bounds.exit.7
  ...
  br i1 %not_max.not.not.i.8, label %cond_373_case_0.i, label %__barray_check_bounds.exit.8
...
cond_exit_20.8:                                   ; preds = %__barray_check_bounds.exit.8
  ...
  br i1 %not_max.not.not.i.9, label %cond_373_case_0.i, label %__barray_check_bounds.exit.9
...
72:                                               ; preds = %__barray_check_none_borrowed.exit, %"__hugr__.$__copy_scan$$n(10)$t([Bool]+[Future(Bool)])$n(1).418.exit"
  %storemerge479580 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %80, %"__hugr__.$__copy_scan$$n(10)$t([Bool]+[Future(Bool)])$n(1).418.exit" ]
  ...
  br i1 %.fca.0.extract118.i, label %cond_422_case_1.i, label %cond_422_case_0.i

cond_422_case_0.i:                                ; preds = %72
  %.fca.2.extract120.i = extractvalue { i1, i64, i1 } %74, 2
  br label %cond_exit_422.i

cond_422_case_1.i:                                ; preds = %72
  %.fca.1.extract119.i = extractvalue { i1, i64, i1 } %74, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i)
  br label %cond_exit_422.i

cond_exit_422.i:                                  ; preds = %cond_422_case_0.i, %cond_422_case_1.i
  %"04.sroa.3.0.i" = phi i64 [ %.fca.1.extract119.i, %cond_422_case_1.i ], [ undef, %cond_422_case_0.i ]
  %"04.sroa.6.0.i" = phi i1 [ undef, %cond_422_case_1.i ], [ %.fca.2.extract120.i, %cond_422_case_0.i ]
  %75 = load i64, ptr %290, align 4
  %76 = lshr i64 %75, %storemerge479580
  %77 = trunc i64 %76 to i1
  br i1 %77, label %panic.i.i, label %cond_425_case_1.i

panic.i.i:                                        ; preds = %cond_exit_422.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_425_case_1.i:                                ; preds = %cond_exit_422.i
  ...
  br i1 %.fca.2.0.extract.i, label %cond_426_case_1.i, label %"__hugr__.$__copy_scan$$n(10)$t([Bool]+[Future(Bool)])$n(1).418.exit"

cond_426_case_1.i:                                ; preds = %cond_425_case_1.i
  tail call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(10)$t([Bool]+[Future(Bool)])$n(1).418.exit": ; preds = %cond_425_case_1.i
...
mask_block_ok.i530:                               ; preds = %"__hugr__.$__copy_scan$$n(10)$t([Bool]+[Future(Bool)])$n(1).418.exit"
...
__barray_check_none_borrowed.exit535:             ; preds = %mask_block_ok.i530
  ...
  %88 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %87)
  ...
  %92 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %91)
  ...
  %97 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %96)
  ...
  %102 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %101)
  ...
  %107 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %106)
  ...
  %112 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %111)
  ...
  %117 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %116)
  ...
  %122 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %121)
  ...
  %127 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %126)
  ...
  %132 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %131)
  ...
  br i1 %136, label %cond_exit_536, label %__barray_mask_borrow.exit546

mask_block_err.i533:                              ; preds = %mask_block_ok.i530
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i539:                              ; preds = %cond_exit_536.9
...
__barray_mask_borrow.exit546:                     ; preds = %__barray_check_none_borrowed.exit535
  ...
  br i1 %.fca.0.extract325, label %cond_559_case_1, label %cond_exit_536

cond_exit_536:                                    ; preds = %cond_559_case_1, %__barray_mask_borrow.exit546, %__barray_check_none_borrowed.exit535
  %139 = load i64, ptr %86, align 4
  %140 = and i64 %139, 2
  %.not597 = icmp eq i64 %140, 0
  br i1 %.not597, label %__barray_mask_borrow.exit546.1, label %cond_exit_536.1

__barray_mask_borrow.exit546.1:                   ; preds = %cond_exit_536
  ...
  br i1 %.fca.0.extract325.1, label %cond_559_case_1.1, label %cond_exit_536.1

cond_559_case_1.1:                                ; preds = %__barray_mask_borrow.exit546.1
  %.fca.1.extract326.1 = extractvalue { i1, i64, i1 } %143, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.1)
  br label %cond_exit_536.1

cond_exit_536.1:                                  ; preds = %cond_559_case_1.1, %__barray_mask_borrow.exit546.1, %cond_exit_536
  %144 = load i64, ptr %86, align 4
  %145 = and i64 %144, 4
  %.not598 = icmp eq i64 %145, 0
  br i1 %.not598, label %__barray_mask_borrow.exit546.2, label %cond_exit_536.2

__barray_mask_borrow.exit546.2:                   ; preds = %cond_exit_536.1
  ...
  br i1 %.fca.0.extract325.2, label %cond_559_case_1.2, label %cond_exit_536.2

cond_559_case_1.2:                                ; preds = %__barray_mask_borrow.exit546.2
  %.fca.1.extract326.2 = extractvalue { i1, i64, i1 } %148, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.2)
  br label %cond_exit_536.2

cond_exit_536.2:                                  ; preds = %cond_559_case_1.2, %__barray_mask_borrow.exit546.2, %cond_exit_536.1
  %149 = load i64, ptr %86, align 4
  %150 = and i64 %149, 8
  %.not599 = icmp eq i64 %150, 0
  br i1 %.not599, label %__barray_mask_borrow.exit546.3, label %cond_exit_536.3

__barray_mask_borrow.exit546.3:                   ; preds = %cond_exit_536.2
  ...
  br i1 %.fca.0.extract325.3, label %cond_559_case_1.3, label %cond_exit_536.3

cond_559_case_1.3:                                ; preds = %__barray_mask_borrow.exit546.3
  %.fca.1.extract326.3 = extractvalue { i1, i64, i1 } %153, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.3)
  br label %cond_exit_536.3

cond_exit_536.3:                                  ; preds = %cond_559_case_1.3, %__barray_mask_borrow.exit546.3, %cond_exit_536.2
  %154 = load i64, ptr %86, align 4
  %155 = and i64 %154, 16
  %.not600 = icmp eq i64 %155, 0
  br i1 %.not600, label %__barray_mask_borrow.exit546.4, label %cond_exit_536.4

__barray_mask_borrow.exit546.4:                   ; preds = %cond_exit_536.3
  ...
  br i1 %.fca.0.extract325.4, label %cond_559_case_1.4, label %cond_exit_536.4

cond_559_case_1.4:                                ; preds = %__barray_mask_borrow.exit546.4
  %.fca.1.extract326.4 = extractvalue { i1, i64, i1 } %158, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.4)
  br label %cond_exit_536.4

cond_exit_536.4:                                  ; preds = %cond_559_case_1.4, %__barray_mask_borrow.exit546.4, %cond_exit_536.3
  %159 = load i64, ptr %86, align 4
  %160 = and i64 %159, 32
  %.not601 = icmp eq i64 %160, 0
  br i1 %.not601, label %__barray_mask_borrow.exit546.5, label %cond_exit_536.5

__barray_mask_borrow.exit546.5:                   ; preds = %cond_exit_536.4
  ...
  br i1 %.fca.0.extract325.5, label %cond_559_case_1.5, label %cond_exit_536.5

cond_559_case_1.5:                                ; preds = %__barray_mask_borrow.exit546.5
  %.fca.1.extract326.5 = extractvalue { i1, i64, i1 } %163, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.5)
  br label %cond_exit_536.5

cond_exit_536.5:                                  ; preds = %cond_559_case_1.5, %__barray_mask_borrow.exit546.5, %cond_exit_536.4
  %164 = load i64, ptr %86, align 4
  %165 = and i64 %164, 64
  %.not602 = icmp eq i64 %165, 0
  br i1 %.not602, label %__barray_mask_borrow.exit546.6, label %cond_exit_536.6

__barray_mask_borrow.exit546.6:                   ; preds = %cond_exit_536.5
  ...
  br i1 %.fca.0.extract325.6, label %cond_559_case_1.6, label %cond_exit_536.6

cond_559_case_1.6:                                ; preds = %__barray_mask_borrow.exit546.6
  %.fca.1.extract326.6 = extractvalue { i1, i64, i1 } %168, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.6)
  br label %cond_exit_536.6

cond_exit_536.6:                                  ; preds = %cond_559_case_1.6, %__barray_mask_borrow.exit546.6, %cond_exit_536.5
  %169 = load i64, ptr %86, align 4
  %170 = and i64 %169, 128
  %.not603 = icmp eq i64 %170, 0
  br i1 %.not603, label %__barray_mask_borrow.exit546.7, label %cond_exit_536.7

__barray_mask_borrow.exit546.7:                   ; preds = %cond_exit_536.6
  ...
  br i1 %.fca.0.extract325.7, label %cond_559_case_1.7, label %cond_exit_536.7

cond_559_case_1.7:                                ; preds = %__barray_mask_borrow.exit546.7
  %.fca.1.extract326.7 = extractvalue { i1, i64, i1 } %173, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.7)
  br label %cond_exit_536.7

cond_exit_536.7:                                  ; preds = %cond_559_case_1.7, %__barray_mask_borrow.exit546.7, %cond_exit_536.6
  %174 = load i64, ptr %86, align 4
  %175 = and i64 %174, 256
  %.not604 = icmp eq i64 %175, 0
  br i1 %.not604, label %__barray_mask_borrow.exit546.8, label %cond_exit_536.8

__barray_mask_borrow.exit546.8:                   ; preds = %cond_exit_536.7
  ...
  br i1 %.fca.0.extract325.8, label %cond_559_case_1.8, label %cond_exit_536.8

cond_559_case_1.8:                                ; preds = %__barray_mask_borrow.exit546.8
  %.fca.1.extract326.8 = extractvalue { i1, i64, i1 } %178, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.8)
  br label %cond_exit_536.8

cond_exit_536.8:                                  ; preds = %cond_559_case_1.8, %__barray_mask_borrow.exit546.8, %cond_exit_536.7
  %179 = load i64, ptr %86, align 4
  %180 = and i64 %179, 512
  %.not605 = icmp eq i64 %180, 0
  br i1 %.not605, label %__barray_mask_borrow.exit546.9, label %cond_exit_536.9

__barray_mask_borrow.exit546.9:                   ; preds = %cond_exit_536.8
  ...
  br i1 %.fca.0.extract325.9, label %cond_559_case_1.9, label %cond_exit_536.9

cond_559_case_1.9:                                ; preds = %__barray_mask_borrow.exit546.9
  %.fca.1.extract326.9 = extractvalue { i1, i64, i1 } %183, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract326.9)
  br label %cond_exit_536.9

cond_exit_536.9:                                  ; preds = %cond_559_case_1.9, %__barray_mask_borrow.exit546.9, %cond_exit_536.8
...
loop_out153:                                      ; preds = %cond_exit_536.9
...
alloca_block:
  ...
  br i1 %.fca.0.extract, label %cond_386_case_1, label %cond_386_case_0

cond_386_case_0:                                  ; preds = %alloca_block
  %.fca.2.extract = extractvalue { i1, i64, i1 } %0, 2
  br label %cond_exit_386

cond_386_case_1:                                  ; preds = %alloca_block
...
cond_exit_386:                                    ; preds = %cond_386_case_1, %cond_386_case_0
  %"03.0" = phi i1 [ %read_bool, %cond_386_case_1 ], [ %.fca.2.extract, %cond_386_case_0 ]
  ret i1 %"03.0"
}

define internal { i1, i64, i1 } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).464"({ i1, { i1, i64, i1 } } %0) unnamed_addr {
alloca_block:
  %.fca.0.extract11 = extractvalue { i1, { i1, i64, i1 } } %0, 0
  br i1 %.fca.0.extract11, label %cond_467_case_1, label %cond_467_case_0

cond_467_case_1:                                  ; preds = %alloca_block
  %1 = extractvalue { i1, { i1, i64, i1 } } %0, 1
  ret { i1, i64, i1 } %1

cond_467_case_0:                                  ; preds = %alloca_block
