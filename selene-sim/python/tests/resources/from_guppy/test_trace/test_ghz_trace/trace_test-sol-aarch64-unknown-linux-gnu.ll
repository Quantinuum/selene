...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit
...
__hugr__.__tk2_sol_qalloc.369.exit:               ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %2 = load i64, ptr %1, align 4
  %3 = trunc i64 %2 to i1
  br i1 %3, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.9, %__hugr__.__tk2_sol_qalloc.369.exit.8, %__hugr__.__tk2_sol_qalloc.369.exit.7, %__hugr__.__tk2_sol_qalloc.369.exit.6, %__hugr__.__tk2_sol_qalloc.369.exit.5, %__hugr__.__tk2_sol_qalloc.369.exit.4, %__hugr__.__tk2_sol_qalloc.369.exit.3, %__hugr__.__tk2_sol_qalloc.369.exit.2, %__hugr__.__tk2_sol_qalloc.369.exit.1, %__hugr__.__tk2_sol_qalloc.369.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_sol_qalloc.369.exit
  %4 = and i64 %2, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.1

__hugr__.__tk2_sol_qalloc.369.exit.1:             ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.1
  %7 = and i64 %5, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.2

__hugr__.__tk2_sol_qalloc.369.exit.2:             ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.2
  %11 = and i64 %9, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.3

__hugr__.__tk2_sol_qalloc.369.exit.3:             ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.3
  %15 = and i64 %13, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.4

__hugr__.__tk2_sol_qalloc.369.exit.4:             ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.4
  %19 = and i64 %17, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.5

__hugr__.__tk2_sol_qalloc.369.exit.5:             ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.5
  %23 = and i64 %21, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.6

__hugr__.__tk2_sol_qalloc.369.exit.6:             ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.6
  %27 = and i64 %25, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.7

__hugr__.__tk2_sol_qalloc.369.exit.7:             ; preds = %cond_exit_20.6
...
cond_exit_20.7:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.7
  %31 = and i64 %29, -129
  ...
  br i1 %not_max.not.not.i.8, label %cond_373_case_0.i, label %__hugr__.__tk2_sol_qalloc.369.exit.8

__hugr__.__tk2_sol_qalloc.369.exit.8:             ; preds = %cond_exit_20.7
...
cond_exit_20.8:                                   ; preds = %__hugr__.__tk2_sol_qalloc.369.exit.8
  %35 = and i64 %33, -257
...
cond_536_case_0:                                  ; preds = %cond_exit_536
...
mask_block_err.i539:                              ; preds = %cond_536_case_0
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable

__barray_check_bounds.exit542:                    ; preds = %__barray_check_none_borrowed.exit535, %cond_exit_536
  %"533_0.0595" = phi i64 [ 0, %__barray_check_none_borrowed.exit535 ], [ %138, %cond_exit_536 ]
  %138 = add nuw nsw i64 %"533_0.0595", 1
  %139 = load i64, ptr %86, align 4
  %140 = lshr i64 %139, %"533_0.0595"
  %141 = trunc i64 %140 to i1
  br i1 %141, label %cond_exit_536, label %__barray_mask_borrow.exit546

__barray_mask_borrow.exit546:                     ; preds = %__barray_check_bounds.exit542
  %142 = shl nuw nsw i64 1, %"533_0.0595"
  %143 = xor i64 %139, %142
  store i64 %143, ptr %86, align 4
  %144 = getelementptr inbounds nuw { i1, i64, i1 }, ptr %85, i64 %"533_0.0595"
...
cond_exit_536:                                    ; preds = %cond_559_case_1, %__barray_mask_borrow.exit546, %__barray_check_bounds.exit542
  %146 = icmp samesign ugt i64 %"533_0.0595", 8
  br i1 %146, label %cond_536_case_0, label %__barray_check_bounds.exit542

loop_out153:                                      ; preds = %cond_536_case_0
