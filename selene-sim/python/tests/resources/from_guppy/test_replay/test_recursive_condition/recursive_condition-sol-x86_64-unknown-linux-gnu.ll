...
tailrecurse.i:                                    ; preds = %__hugr__.__tk2_sol_qalloc.32.exit.i, %alloca_block
  %qalloc.i.i = tail call i64 @___qalloc()
  %not_max.not.not.i.i = icmp eq i64 %qalloc.i.i, -1
  br i1 %not_max.not.not.i.i, label %cond_36_case_0.i.i, label %__hugr__.__tk2_sol_qalloc.32.exit.i

cond_36_case_0.i.i:                               ; preds = %tailrecurse.i
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.32.exit.i:              ; preds = %tailrecurse.i
...
__hugr__.__main__.recursive_condition.5.exit:     ; preds = %__hugr__.__tk2_sol_qalloc.32.exit.i
  ret void
}
