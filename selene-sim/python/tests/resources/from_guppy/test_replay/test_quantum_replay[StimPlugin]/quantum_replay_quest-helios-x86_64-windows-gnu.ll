...
__hugr__.__tk2_helios_qalloc.25.exit50:           ; preds = %__hugr__.__tk2_helios_qalloc.25.exit44
  ...
  %___lazy_measure14 = tail call i64 @___lazy_measure(i64 %qalloc.i37)
  tail call void @___qfree(i64 %qalloc.i37)
  %read_bool16 = tail call i1 @___read_future_bool(i64 %___lazy_measure14)
  tail call void @___dec_future_refcount(i64 %___lazy_measure14)
  tail call void @print_bool(ptr nonnull @res_c1.1F7A6571.0, i64 12, i1 %read_bool16)
  %___lazy_measure22 = tail call i64 @___lazy_measure(i64 %qalloc.i41)
  tail call void @___qfree(i64 %qalloc.i41)
  %read_bool24 = tail call i1 @___read_future_bool(i64 %___lazy_measure22)
  tail call void @___dec_future_refcount(i64 %___lazy_measure22)
  tail call void @print_bool(ptr nonnull @res_c2.60825383.0, i64 12, i1 %read_bool24)
  %___lazy_measure30 = tail call i64 @___lazy_measure(i64 %qalloc.i47)
