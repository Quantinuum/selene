...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_44_case_0.i, label %__hugr__.__tk2_sol_qalloc.40.exit

cond_44_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.40.exit:                ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i40, label %cond_58_case_0.i, label %__hugr__.__tk2_sol_qalloc.54.exit

cond_58_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.40.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.54.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.40.exit
  ...
  tail call void @___rpp(i64 %qalloc.i, i64 %qalloc.i39, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %qalloc.i39, double 0xBFF921FB54442D18, double 0.000000e+00)
  ...
  br i1 %not_max.not.not.i42, label %cond_72_case_0.i, label %__hugr__.__tk2_sol_qalloc.68.exit

cond_72_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.54.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.68.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.54.exit
  tail call void @___reset(i64 %qalloc.i41)
  tail call void @___rp(i64 %qalloc.i39, double 0x3FF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rpp(i64 %qalloc.i39, i64 %qalloc.i41, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %qalloc.i41, double 0xBFF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %qalloc.i39, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  ...
  br i1 %not_max.not.not.i46, label %cond_86_case_0.i, label %__hugr__.__tk2_sol_qalloc.82.exit

cond_86_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.68.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.82.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.68.exit
  ...
  tail call void @___rpp(i64 %qalloc.i41, i64 %qalloc.i45, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %qalloc.i45, double 0xBFF921FB54442D18, double 0.000000e+00)
