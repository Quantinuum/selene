...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_442_case_0.i, label %__barray_check_bounds.exit
...
cond_exit_12:                                     ; preds = %__barray_check_bounds.exit
  ...
  br i1 %not_max.not.not.i.1, label %cond_442_case_0.i, label %__barray_check_bounds.exit.1
...
cond_exit_12.1:                                   ; preds = %__barray_check_bounds.exit.1
  ...
  br i1 %not_max.not.not.i.2, label %cond_442_case_0.i, label %__barray_check_bounds.exit.2

__barray_check_bounds.exit.2:                     ; preds = %cond_exit_12.1
  tail call void @___reset(i64 %qalloc.i.2)
  %13 = load i64, ptr %5, align 4
  %14 = and i64 %13, 4
  %.not1199 = icmp eq i64 %14, 0
  br i1 %.not1199, label %panic.i, label %cond_exit_12.2
...
cond_exit_12.2:                                   ; preds = %__barray_check_bounds.exit.2
  ...
  br i1 %not_max.not.not.i.3, label %cond_442_case_0.i, label %__barray_check_bounds.exit.3

__barray_check_bounds.exit.3:                     ; preds = %cond_exit_12.2
  tail call void @___reset(i64 %qalloc.i.3)
  %17 = load i64, ptr %5, align 4
  %18 = and i64 %17, 8
  %.not1200 = icmp eq i64 %18, 0
  br i1 %.not1200, label %panic.i, label %cond_exit_12.3
...
cond_exit_12.3:                                   ; preds = %__barray_check_bounds.exit.3
  ...
  br i1 %not_max.not.not.i.4, label %cond_442_case_0.i, label %__barray_check_bounds.exit.4

__barray_check_bounds.exit.4:                     ; preds = %cond_exit_12.3
  tail call void @___reset(i64 %qalloc.i.4)
  %21 = load i64, ptr %5, align 4
  %22 = and i64 %21, 16
  %.not1201 = icmp eq i64 %22, 0
  br i1 %.not1201, label %panic.i, label %cond_exit_12.4
...
cond_exit_12.4:                                   ; preds = %__barray_check_bounds.exit.4
  ...
  br i1 %not_max.not.not.i.5, label %cond_442_case_0.i, label %__barray_check_bounds.exit.5

__barray_check_bounds.exit.5:                     ; preds = %cond_exit_12.4
  tail call void @___reset(i64 %qalloc.i.5)
  %25 = load i64, ptr %5, align 4
  %26 = and i64 %25, 32
  %.not1202 = icmp eq i64 %26, 0
  br i1 %.not1202, label %panic.i, label %cond_exit_12.5
...
cond_exit_12.5:                                   ; preds = %__barray_check_bounds.exit.5
  ...
  br i1 %not_max.not.not.i.6, label %cond_442_case_0.i, label %__barray_check_bounds.exit.6

__barray_check_bounds.exit.6:                     ; preds = %cond_exit_12.5
  tail call void @___reset(i64 %qalloc.i.6)
  %29 = load i64, ptr %5, align 4
  %30 = and i64 %29, 64
  %.not1203 = icmp eq i64 %30, 0
  br i1 %.not1203, label %panic.i, label %cond_exit_12.6
...
cond_exit_12.6:                                   ; preds = %__barray_check_bounds.exit.6
  ...
  br i1 %not_max.not.not.i.7, label %cond_442_case_0.i, label %__barray_check_bounds.exit.7

__barray_check_bounds.exit.7:                     ; preds = %cond_exit_12.6
  tail call void @___reset(i64 %qalloc.i.7)
  %33 = load i64, ptr %5, align 4
  %34 = and i64 %33, 128
  %.not1204 = icmp eq i64 %34, 0
  br i1 %.not1204, label %panic.i, label %cond_exit_12.7
...
cond_exit_12.7:                                   ; preds = %__barray_check_bounds.exit.7
  ...
  br i1 %not_max.not.not.i.8, label %cond_442_case_0.i, label %__barray_check_bounds.exit.8

__barray_check_bounds.exit.8:                     ; preds = %cond_exit_12.7
  tail call void @___reset(i64 %qalloc.i.8)
  %37 = load i64, ptr %5, align 4
  %38 = and i64 %37, 256
  %.not1205 = icmp eq i64 %38, 0
  br i1 %.not1205, label %panic.i, label %cond_exit_12.8
...
__barray_check_bounds.exit.9:                     ; preds = %cond_exit_12.8
  ...
  %42 = and i64 %41, 512
  %.not1206 = icmp eq i64 %42, 0
  br i1 %.not1206, label %panic.i, label %cond_exit_12.9
...
__barray_mask_return.exit1135:                    ; preds = %__barray_check_bounds.exit1133
  ...
  %exitcond1192 = icmp eq i64 %74, 10
  br i1 %exitcond1192, label %loop_body346.preheader, label %__barray_check_bounds.exit1121
...
loop_body346.preheader:                           ; preds = %__barray_mask_return.exit1135, %cond_exit_241
  %"237_0.sroa.15.01197" = phi i64 [ %81, %cond_exit_241 ], [ 0, %__barray_mask_return.exit1135 ]
  %"237_2.01196" = phi i64 [ %89, %cond_exit_241 ], [ 0, %__barray_mask_return.exit1135 ]
  %81 = add nuw nsw i64 %"237_0.sroa.15.01197", 1
  %82 = load i64, ptr %5, align 4
  %83 = lshr i64 %82, %"237_0.sroa.15.01197"
...
.thread:                                          ; preds = %loop_body346.preheader
  %85 = shl nuw nsw i64 1, %"237_0.sroa.15.01197"
  %86 = xor i64 %82, %85
  store i64 %86, ptr %5, align 4
  %87 = getelementptr inbounds nuw i64, ptr %4, i64 %"237_0.sroa.15.01197"
  %88 = load i64, ptr %87, align 4
  %89 = add i64 %"237_2.01196", 1
  %___lazy_measure = tail call i64 @___lazy_measure(i64 %88)
  tail call void @___qfree(i64 %88)
  %90 = icmp ult i64 %"237_2.01196", 10
...
cond_exit_241:                                    ; preds = %__barray_check_bounds.exit1137
  ...
  %93 = getelementptr inbounds nuw i64, ptr %2, i64 %"237_2.01196"
  store i64 %___lazy_measure, ptr %93, align 4
  %94 = icmp samesign ugt i64 %"237_0.sroa.15.01197", 8
...
cond_exit_488:                                    ; preds = %__barray_mask_borrow.exit1167, %__barray_check_bounds.exit1163.preheader
  ...
  %113 = and i64 %112, 2
  %.not1207 = icmp eq i64 %113, 0
  br i1 %.not1207, label %__barray_mask_borrow.exit1167.1, label %cond_exit_488.1
...
cond_exit_488.1:                                  ; preds = %__barray_mask_borrow.exit1167.1, %cond_exit_488
  ...
  %118 = and i64 %117, 4
  %.not1208 = icmp eq i64 %118, 0
  br i1 %.not1208, label %__barray_mask_borrow.exit1167.2, label %cond_exit_488.2
...
cond_exit_488.2:                                  ; preds = %__barray_mask_borrow.exit1167.2, %cond_exit_488.1
  ...
  %123 = and i64 %122, 8
  %.not1209 = icmp eq i64 %123, 0
  br i1 %.not1209, label %__barray_mask_borrow.exit1167.3, label %cond_exit_488.3
...
cond_exit_488.3:                                  ; preds = %__barray_mask_borrow.exit1167.3, %cond_exit_488.2
  ...
  %128 = and i64 %127, 16
  %.not1210 = icmp eq i64 %128, 0
  br i1 %.not1210, label %__barray_mask_borrow.exit1167.4, label %cond_exit_488.4
...
cond_exit_488.4:                                  ; preds = %__barray_mask_borrow.exit1167.4, %cond_exit_488.3
  ...
  %133 = and i64 %132, 32
  %.not1211 = icmp eq i64 %133, 0
  br i1 %.not1211, label %__barray_mask_borrow.exit1167.5, label %cond_exit_488.5
...
cond_exit_488.5:                                  ; preds = %__barray_mask_borrow.exit1167.5, %cond_exit_488.4
  ...
  %138 = and i64 %137, 64
  %.not1212 = icmp eq i64 %138, 0
  br i1 %.not1212, label %__barray_mask_borrow.exit1167.6, label %cond_exit_488.6
...
cond_exit_488.6:                                  ; preds = %__barray_mask_borrow.exit1167.6, %cond_exit_488.5
  ...
  %143 = and i64 %142, 128
  %.not1213 = icmp eq i64 %143, 0
  br i1 %.not1213, label %__barray_mask_borrow.exit1167.7, label %cond_exit_488.7
...
cond_exit_488.7:                                  ; preds = %__barray_mask_borrow.exit1167.7, %cond_exit_488.6
  ...
  %148 = and i64 %147, 256
  %.not1214 = icmp eq i64 %148, 0
  br i1 %.not1214, label %__barray_mask_borrow.exit1167.8, label %cond_exit_488.8
...
cond_exit_488.8:                                  ; preds = %__barray_mask_borrow.exit1167.8, %cond_exit_488.7
  ...
  %153 = and i64 %152, 512
  %.not1215 = icmp eq i64 %153, 0
  br i1 %.not1215, label %__barray_mask_borrow.exit1167.9, label %cond_exit_488.9
