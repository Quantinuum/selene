...
cond_104_case_1:                                  ; preds = %loop_body
  ...
  br i1 %not_max.not.not.i, label %cond_683_case_0.i, label %__hugr__.__tk2_helios_qalloc.679.exit

cond_683_case_0.i:                                ; preds = %cond_104_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.679.exit:            ; preds = %cond_104_case_1
  tail call void @___reset(i64 %qalloc.i)
  %13 = icmp ult i64 %"100_2.0", 10
  br i1 %13, label %__barray_check_bounds.exit, label %out_of_bounds.i

out_of_bounds.i:                                  ; preds = %__hugr__.__tk2_helios_qalloc.679.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Index out .DD115165.0")
  unreachable

__barray_check_bounds.exit:                       ; preds = %__hugr__.__tk2_helios_qalloc.679.exit
...
.thread:                                          ; preds = %loop_body321.preheader
  ...
  %___lazy_measure = tail call i64 @___lazy_measure(i64 %46)
...
cond_exit_480:                                    ; preds = %__barray_check_bounds.exit1801
  ...
  store i64 %___lazy_measure, ptr %51, align 4
...
__barray_check_bounds.exit1856:                   ; preds = %cond_exit_366, %__barray_check_none_borrowed.exit1850
  %"362_2.01892" = phi i64 [ 0, %__barray_check_none_borrowed.exit1850 ], [ %156, %cond_exit_366 ]
  %150 = lshr i64 %"362_2.01892", 6
  %151 = getelementptr inbounds nuw i64, ptr %5, i64 %150
  %152 = load i64, ptr %151, align 4
  %153 = and i64 %"362_2.01892", 63
  %154 = lshr i64 %152, %153
  %155 = trunc i64 %154 to i1
  br i1 %155, label %cond_exit_366, label %panic.i1857

panic.i1857:                                      ; preds = %__barray_check_bounds.exit1856
  call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_366:                                    ; preds = %__barray_check_bounds.exit1856
  %156 = add nuw nsw i64 %"362_2.01892", 1
  ...
  %exitcond1897 = icmp eq i64 %156, 100
  br i1 %exitcond1897, label %loop_out860, label %__barray_check_bounds.exit1856

loop_out860:                                      ; preds = %cond_exit_366
  %160 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %161 = load i64, ptr %160, align 4
  %162 = and i64 %161, 68719476735
  store i64 %162, ptr %160, align 4
  %163 = load i64, ptr %5, align 4
...
__barray_check_none_borrowed.exit1863:            ; preds = %loop_out860
  %166 = call ptr @heap_alloc(i64 800)
  %167 = call ptr @heap_alloc(i64 16)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %167, i8 0, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(800) %166, ptr noundef nonnull align 1 dereferenceable(800) %4, i64 800, i1 false)
  call void @heap_free(ptr nonnull %166)
  %168 = load i64, ptr %160, align 4
  %169 = and i64 %168, 68719476735
  store i64 %169, ptr %160, align 4
  %170 = load i64, ptr %5, align 4
  %171 = icmp eq i64 %170, 0
  %172 = icmp eq i64 %169, 0
  %or.cond1902 = select i1 %171, i1 %172, i1 false
...
__barray_check_none_borrowed.exit1868:            ; preds = %__barray_check_none_borrowed.exit1863
  ...
  %173 = alloca [100 x i1], align 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(100) %173, i8 0, i64 100, i1 false)
  store i32 100, ptr %out_arr_alloca1023, align 8
  store i32 1, ptr %y_ptr1025, align 4
  store ptr %4, ptr %arr_ptr1026, align 8
  store ptr %173, ptr %mask_ptr1027, align 8
