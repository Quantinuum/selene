...
__barray_check_none_borrowed.exit:                ; preds = %"__hugr__.$measure_array$$n(10).484.exit"
  ...
  %30 = bitcast i8* %251 to { i1, { i1, i64, i1 } }*
  br label %31
...
31:                                               ; preds = %__barray_check_none_borrowed.exit, %__hugr__.const_fun_386.389.exit
  ...
  %33 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %245, i64 %storemerge9061026
...
cond_exit_653.i:                                  ; preds = %cond_653_case_1.i, %31
  ...
  %exitcond1039.not = icmp eq i64 %storemerge9061026, 10
  br i1 %exitcond1039.not, label %cond_656_case_0.i, label %36

36:                                               ; preds = %cond_exit_653.i
  %37 = lshr i64 %32, 6
  %38 = getelementptr inbounds i64, i64* %253, i64 %37
...
__hugr__.const_fun_386.389.exit:                  ; preds = %cond_656_case_1.i
  ...
  %exitcond1040.not = icmp eq i64 %49, 10
  br i1 %exitcond1040.not, label %mask_block_ok.i926, label %31

mask_block_ok.i926:                               ; preds = %__hugr__.const_fun_386.389.exit
  tail call void @heap_free(i8* nonnull %244)
  tail call void @heap_free(i8* %246)
  %50 = load i64, i64* %253, align 4
  %51 = and i64 %50, 1023
  store i64 %51, i64* %253, align 4
  %52 = icmp eq i64 %51, 0
...
__hugr__.const_fun_382.386.exit:                  ; preds = %__barray_check_none_borrowed.exit928
  ...
  %59 = getelementptr inbounds i8, i8* %251, i64 32
...
__hugr__.const_fun_382.386.exit.1:                ; preds = %__hugr__.const_fun_382.386.exit
  ...
  %65 = getelementptr inbounds i8, i8* %251, i64 64
...
__hugr__.const_fun_382.386.exit.2:                ; preds = %__hugr__.const_fun_382.386.exit.1
  ...
  %71 = getelementptr inbounds i8, i8* %251, i64 96
...
__hugr__.const_fun_382.386.exit.3:                ; preds = %__hugr__.const_fun_382.386.exit.2
  ...
  %77 = getelementptr inbounds i8, i8* %251, i64 128
...
__hugr__.const_fun_382.386.exit.4:                ; preds = %__hugr__.const_fun_382.386.exit.3
  ...
  %83 = getelementptr inbounds i8, i8* %251, i64 160
...
__hugr__.const_fun_382.386.exit.5:                ; preds = %__hugr__.const_fun_382.386.exit.4
  ...
  %89 = getelementptr inbounds i8, i8* %251, i64 192
...
__hugr__.const_fun_382.386.exit.6:                ; preds = %__hugr__.const_fun_382.386.exit.5
  ...
  %95 = getelementptr inbounds i8, i8* %251, i64 224
...
__hugr__.const_fun_382.386.exit.7:                ; preds = %__hugr__.const_fun_382.386.exit.6
  ...
  %101 = getelementptr inbounds i8, i8* %251, i64 256
...
__hugr__.const_fun_382.386.exit.8:                ; preds = %__hugr__.const_fun_382.386.exit.7
  ...
  %107 = getelementptr inbounds i8, i8* %251, i64 288
...
__hugr__.const_fun_382.386.exit.9:                ; preds = %__hugr__.const_fun_382.386.exit.8
  ...
  tail call void @heap_free(i8* nonnull %251)
  tail call void @heap_free(i8* nonnull %252)
...
__barray_check_bounds.exit933:                    ; preds = %__hugr__.const_fun_382.386.exit.9, %cond_exit_606
  %"603_0.01050" = phi i64 [ 0, %__hugr__.const_fun_382.386.exit.9 ], [ %116, %cond_exit_606 ]
  %116 = add nuw nsw i64 %"603_0.01050", 1
  %117 = lshr i64 %"603_0.01050", 6
  %118 = getelementptr inbounds i64, i64* %56, i64 %117
  %119 = load i64, i64* %118, align 4
  %120 = shl nuw nsw i64 1, %"603_0.01050"
  %121 = and i64 %119, %120
...
__barray_mask_borrow.exit938:                     ; preds = %__barray_check_bounds.exit933
  ...
  %123 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %54, i64 %"603_0.01050"
...
cond_exit_606:                                    ; preds = %cond_629_case_1, %__barray_mask_borrow.exit938, %__barray_check_bounds.exit933
  %125 = icmp ult i64 %"603_0.01050", 9
...
pow.i.preheader:                                  ; preds = %__barray_check_none_borrowed.exit950, %cond_exit_91
  %"86_2.01051" = phi i64 [ 0, %__barray_check_none_borrowed.exit950 ], [ %185, %cond_exit_91 ]
  %185 = add nuw nsw i64 %"86_2.01051", 1
  br label %pow.i

pow.i:                                            ; preds = %pow.i.preheader, %pow_body.i
  %storemerge1.i = phi i64 [ %new_acc.i, %pow_body.i ], [ 2, %pow.i.preheader ]
  %storemerge.i = phi i64 [ %new_exp.i, %pow_body.i ], [ %"86_2.01051", %pow.i.preheader ]
...
__barray_check_bounds.exit958:                    ; preds = %pow.i, %__barray_check_bounds.exit958.loopexit
  ...
  %186 = lshr i64 %"86_2.01051", 6
  %187 = getelementptr inbounds i64, i64* %243, i64 %186
  %188 = load i64, i64* %187, align 4
  %189 = shl nuw nsw i64 1, %"86_2.01051"
  %190 = and i64 %188, %189
...
cond_exit_91:                                     ; preds = %__barray_check_bounds.exit958
  ...
  %194 = getelementptr inbounds double, double* %241, i64 %"86_2.01051"
  store double %192, double* %194, align 8
  %exitcond1043.not = icmp eq i64 %185, 10
  br i1 %exitcond1043.not, label %loop_out223, label %pow.i.preheader

loop_out223:                                      ; preds = %cond_exit_91
  %195 = load i64, i64* %243, align 4
  %196 = and i64 %195, 1023
  store i64 %196, i64* %243, align 4
...
__barray_check_none_borrowed.exit966:             ; preds = %loop_out223
  ...
  call void @llvm.memcpy.p0f64.p0f64.i64(double* noundef nonnull align 1 dereferenceable(80) %199, double* noundef nonnull align 1 dereferenceable(80) %241, i64 80, i1 false)
  call void @heap_free(i8* %198)
  %202 = load i64, i64* %243, align 4
  %203 = and i64 %202, 1023
  store i64 %203, i64* %243, align 4
...
__barray_check_bounds.exit979:                    ; preds = %cond_exit_133, %__barray_check_none_borrowed.exit971
  %"128_0.sroa.0.01030" = phi i64 [ 0, %__barray_check_none_borrowed.exit971 ], [ %208, %cond_exit_133 ]
  %208 = add nuw nsw i64 %"128_0.sroa.0.01030", 1
  %209 = lshr i64 %"128_0.sroa.0.01030", 6
  %210 = getelementptr inbounds i64, i64* %239, i64 %209
  %211 = load i64, i64* %210, align 4
  %212 = and i64 %"128_0.sroa.0.01030", 63
  %213 = shl nuw i64 1, %212
  %214 = and i64 %211, %213
  %.not.i980 = icmp eq i64 %214, 0
  br i1 %.not.i980, label %panic.i981, label %cond_exit_133

panic.i981:                                       ; preds = %__barray_check_bounds.exit979
  call void @panic(i32 1002, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @"e_Array alre.5A300C2A.0", i64 0, i64 0))
  unreachable
...
cond_exit_133:                                    ; preds = %__barray_check_bounds.exit979
  ...
  %216 = getelementptr inbounds i64, i64* %237, i64 %"128_0.sroa.0.01030"
  store i64 %"128_0.sroa.0.01030", i64* %216, align 4
  %exitcond1044.not = icmp eq i64 %208, 100
  br i1 %exitcond1044.not, label %loop_out315, label %__barray_check_bounds.exit979

loop_out315:                                      ; preds = %cond_exit_133
  %217 = getelementptr inbounds i8, i8* %238, i64 8
  %218 = bitcast i8* %217 to i64*
  %219 = load i64, i64* %218, align 4
  %220 = and i64 %219, 68719476735
  store i64 %220, i64* %218, align 4
  %221 = load i64, i64* %239, align 4
...
__barray_check_none_borrowed.exit987:             ; preds = %loop_out315
  %224 = call i8* @heap_alloc(i64 800)
  %225 = bitcast i8* %224 to i64*
  %226 = call i8* @heap_alloc(i64 16)
  %227 = bitcast i8* %226 to i64*
  call void @llvm.memset.p0i64.i64(i64* noundef nonnull align 1 dereferenceable(16) %227, i8 0, i64 16, i1 false)
  call void @llvm.memcpy.p0i64.p0i64.i64(i64* noundef nonnull align 1 dereferenceable(800) %225, i64* noundef nonnull align 1 dereferenceable(800) %237, i64 800, i1 false)
  call void @heap_free(i8* %224)
  %228 = load i64, i64* %218, align 4
  %229 = and i64 %228, 68719476735
  store i64 %229, i64* %218, align 4
  %230 = load i64, i64* %239, align 4
  %231 = icmp eq i64 %230, 0
  %232 = icmp eq i64 %229, 0
  %or.cond1047 = select i1 %231, i1 %232, i1 false
  br i1 %or.cond1047, label %__barray_check_none_borrowed.exit992, label %mask_block_err.i991
...
__barray_check_none_borrowed.exit992:             ; preds = %__barray_check_none_borrowed.exit987
  ...
  %233 = alloca [100 x i1], align 1
  %.sub792 = getelementptr inbounds [100 x i1], [100 x i1]* %233, i64 0, i64 0
  %234 = bitcast [100 x i1]* %233 to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(100) %234, i8 0, i64 100, i1 false)
  store i32 100, i32* %x_ptr391, align 8
  store i32 1, i32* %y_ptr392, align 4
  %235 = bitcast i64** %arr_ptr393 to i8**
...
cond_exit_163:                                    ; preds = %__barray_mask_return.exit
  %236 = tail call i8* @heap_alloc(i64 800)
  %237 = bitcast i8* %236 to i64*
  %238 = tail call i8* @heap_alloc(i64 16)
  %239 = bitcast i8* %238 to i64*
  tail call void @llvm.memset.p0i64.i64(i64* noundef nonnull align 1 dereferenceable(16) %239, i8 -1, i64 16, i1 false)
  %240 = tail call i8* @heap_alloc(i64 80)
  %241 = bitcast i8* %240 to double*
  %242 = tail call i8* @heap_alloc(i64 8)
  %243 = bitcast i8* %242 to i64*
  store i64 -1, i64* %243, align 1
  %244 = tail call i8* @heap_alloc(i64 240)
  %245 = bitcast i8* %244 to { i1, i64, i1 }*
  %246 = tail call i8* @heap_alloc(i64 8)
  %247 = bitcast i8* %246 to i64*
  store i64 -1, i64* %247, align 1
  br label %257

mask_block_ok.i.i.i:                              ; preds = %cond_exit_560.i
  %248 = load i64, i64* %3, align 4
  %249 = or i64 %248, -1024
  store i64 %249, i64* %3, align 4
  %250 = icmp eq i64 %249, -1
  br i1 %250, label %"__hugr__.$measure_array$$n(10).484.exit", label %mask_block_err.i.i.i
...
"__hugr__.$measure_array$$n(10).484.exit":        ; preds = %mask_block_ok.i.i.i
  ...
  %251 = tail call i8* @heap_alloc(i64 320)
  %252 = tail call i8* @heap_alloc(i64 8)
  %253 = bitcast i8* %252 to i64*
  store i64 0, i64* %253, align 1
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 4 dereferenceable(320) %251, i8 0, i64 320, i1 false)
  %254 = load i64, i64* %247, align 4
  %255 = and i64 %254, 1023
  store i64 %255, i64* %247, align 4
  %256 = icmp eq i64 %255, 0
  br i1 %256, label %__barray_check_none_borrowed.exit, label %mask_block_err.i

mask_block_err.i.i.i:                             ; preds = %mask_block_ok.i.i.i
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([70 x i8], [70 x i8]* @"e_Array cont.EFA5AC45.0", i64 0, i64 0))
  unreachable

257:                                              ; preds = %cond_exit_163, %cond_exit_560.i
  %"510_0.sroa.15.0.i1021" = phi i64 [ 0, %cond_exit_163 ], [ %258, %cond_exit_560.i ]
  %258 = add nuw nsw i64 %"510_0.sroa.15.0.i1021", 1
  %259 = lshr i64 %"510_0.sroa.15.0.i1021", 6
  %260 = getelementptr inbounds i64, i64* %3, i64 %259
  %261 = load i64, i64* %260, align 4
  %262 = shl nuw nsw i64 1, %"510_0.sroa.15.0.i1021"
  %263 = and i64 %261, %262
  %.not.i99.i.i = icmp eq i64 %263, 0
  br i1 %.not.i99.i.i, label %__barray_check_bounds.exit.i, label %panic.i.i.i

panic.i.i.i:                                      ; preds = %257
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @"e_Array elem.E746B1A3.0", i64 0, i64 0))
  unreachable

__barray_check_bounds.exit.i:                     ; preds = %257
  %264 = xor i64 %261, %262
  store i64 %264, i64* %260, align 4
  %265 = getelementptr inbounds i64, i64* %1, i64 %"510_0.sroa.15.0.i1021"
  %266 = load i64, i64* %265, align 4
  %lazy_measure.i = tail call i64 @___lazy_measure(i64 %266)
  tail call void @___qfree(i64 %266)
  %267 = getelementptr inbounds i64, i64* %247, i64 %259
  %268 = load i64, i64* %267, align 4
  %269 = and i64 %268, %262
  %.not.i.i994 = icmp eq i64 %269, 0
...
cond_exit_560.i:                                  ; preds = %__barray_check_bounds.exit.i
  ...
  %270 = xor i64 %268, %262
  store i64 %270, i64* %267, align 4
  %271 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %245, i64 %"510_0.sroa.15.0.i1021"
  store { i1, i64, i1 } %"574_054.fca.1.insert.i", { i1, i64, i1 }* %271, align 4
  %exitcond1038.not = icmp eq i64 %258, 10
  br i1 %exitcond1038.not, label %mask_block_ok.i.i.i, label %257
}
