...
alloca_block:
  ...
  br i1 %not_max.not.not.i13, label %cond_30_case_0.i, label %__hugr__.__tk2_sol_qalloc.26.exit

cond_30_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.26.exit, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.26.exit:                ; preds = %alloca_block, %__hugr__.__tk2_sol_qalloc.26.exit
  %qalloc.i14 = phi i64 [ %qalloc.i, %__hugr__.__tk2_sol_qalloc.26.exit ], [ %qalloc.i12, %alloca_block ]
  tail call void @___reset(i64 %qalloc.i14)
  tail call void @___rp(i64 %qalloc.i14, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  ...
  br i1 %not_max.not.not.i, label %cond_30_case_0.i, label %__hugr__.__tk2_sol_qalloc.26.exit
}
