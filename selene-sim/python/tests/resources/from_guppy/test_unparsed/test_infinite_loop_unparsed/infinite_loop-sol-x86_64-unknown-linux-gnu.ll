...
alloca_block:
  ...
  br i1 %not_max.not.not.i9, label %cond_20_case_0.i, label %__hugr__.__tk2_sol_qalloc.16.exit

cond_20_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.16.exit, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.16.exit:                ; preds = %alloca_block, %__hugr__.__tk2_sol_qalloc.16.exit
  %qalloc.i10 = phi i64 [ %qalloc.i, %__hugr__.__tk2_sol_qalloc.16.exit ], [ %qalloc.i8, %alloca_block ]
