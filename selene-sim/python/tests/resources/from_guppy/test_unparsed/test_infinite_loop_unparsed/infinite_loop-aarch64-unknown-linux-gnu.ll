...
entry:
  ...
  br label %cond_58_case_1.i

cond_58_case_1.i:                                 ; preds = %__hugr__.__tk2_qalloc.26.exit.i, %entry
...
reset_bb.i.i:                                     ; preds = %cond_58_case_1.i
  tail call void @___reset(i64 %qalloc.i.i)
  br label %id_bb.i.i

id_bb.i.i:                                        ; preds = %reset_bb.i.i, %cond_58_case_1.i
  ...
  br i1 %.fca.0.extract.i.i, label %__hugr__.__tk2_qalloc.26.exit.i, label %cond_30_case_0.i.i

cond_30_case_0.i.i:                               ; preds = %id_bb.i.i
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @"e_No more qu.3B2EEBF0.0", i64 0, i64 0))
  unreachable

__hugr__.__tk2_qalloc.26.exit.i:                  ; preds = %id_bb.i.i
  ...
  tail call void @print_bool(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @res_r.F13F95F2.0, i64 0, i64 0), i64 11, i1 %read_bool.i)
  br label %cond_58_case_1.i
}
