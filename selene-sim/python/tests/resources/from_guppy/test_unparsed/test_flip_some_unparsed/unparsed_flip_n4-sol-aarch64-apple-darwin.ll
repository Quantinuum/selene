...
__hugr__.__tk2_qalloc.64.exit.i:                  ; preds = %__hugr__.__tk2_qalloc.50.exit.i
  ...
  tail call void @___rp(i64 %qalloc.i103.i, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i105.i = tail call i64 @___qalloc()
  %not_max.not.not.i106.i = icmp eq i64 %qalloc.i105.i, -1
  br i1 %not_max.not.not.i106.i, label %cond_82_case_0.i.i, label %__hugr__.__main__.main.1.exit

cond_82_case_0.i.i:                               ; preds = %__hugr__.__tk2_qalloc.64.exit.i
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__main__.main.1.exit:                    ; preds = %__hugr__.__tk2_qalloc.64.exit.i
  ...
  tail call void @___rp(i64 %qalloc.i105.i, double 0x400921FB54442D18, double 0.000000e+00)
