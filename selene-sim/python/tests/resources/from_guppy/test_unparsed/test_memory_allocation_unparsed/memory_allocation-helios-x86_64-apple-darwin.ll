...
cond_132_case_1:                                  ; preds = %loop_body
  ...
  br i1 %not_max.not.not.i, label %cond_436_case_0.i, label %__hugr__.__tk2_helios_qalloc.432.exit

cond_436_case_0.i:                                ; preds = %cond_132_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.432.exit:            ; preds = %cond_132_case_1
  tail call void @___reset(i64 %qalloc.i)
  %9 = icmp ult i64 %"128_2.0", 70
  br i1 %9, label %__barray_check_bounds.exit, label %out_of_bounds.i

out_of_bounds.i:                                  ; preds = %__hugr__.__tk2_helios_qalloc.432.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Index out .DD115165.0")
  unreachable

__barray_check_bounds.exit:                       ; preds = %__hugr__.__tk2_helios_qalloc.432.exit
...
__barray_check_bounds.exit1277:                   ; preds = %__barray_check_bounds.exit1274
  ...
  tail call void @___rxy(i64 %32, double 0x400921FB54442D18, double 0.000000e+00)
...
.thread:                                          ; preds = %__barray_check_bounds.exit1285
  ...
  %___lazy_measure = tail call i64 @___lazy_measure(i64 %58)
...
cond_exit_255:                                    ; preds = %__barray_check_bounds.exit1281
  ...
  store i64 %___lazy_measure, ptr %63, align 4
