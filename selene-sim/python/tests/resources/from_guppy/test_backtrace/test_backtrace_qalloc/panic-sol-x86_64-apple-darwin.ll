...
__hugr__.__tk2_sol_qalloc.55.exit:                ; preds = %alloca_block
...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_59_case_0.i, label %__hugr__.__tk2_sol_qalloc.55.exit, !dbg !16
...
__hugr__.__tk2_sol_qalloc.55.exit:                ; preds = %alloca_block
  ...
  tail call void @___rpp(i64 %0, i64 %qalloc.i, double 0x3FF921FB54442D18, double 0.000000e+00)
...
4:                                                ; preds = %__hugr__.__tk2_sol_qalloc.55.exit
