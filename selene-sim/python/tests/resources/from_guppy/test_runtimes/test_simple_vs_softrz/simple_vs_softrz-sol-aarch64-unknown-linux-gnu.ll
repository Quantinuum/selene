...
.thread:                                          ; preds = %__barray_mask_return.exit738
  ...
  %___future_measure = tail call i64 @___future_measure(i64 %41, i64 0)
...
__barray_check_bounds.exit740.2:                  ; preds = %__barray_check_bounds.exit744.2
  ...
  %___future_measure.2 = tail call i64 @___future_measure(i64 %56, i64 0)
...
cond_exit_180.2:                                  ; preds = %__barray_check_bounds.exit740.2
  ...
  store i64 %___future_measure.2, ptr %60, align 4
