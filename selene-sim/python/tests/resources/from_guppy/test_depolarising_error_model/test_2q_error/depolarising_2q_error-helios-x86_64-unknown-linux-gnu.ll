...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_17_case_0.i, label %__hugr__.__tk2_helios_qalloc.13.exit

cond_17_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.13.exit:             ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i15, label %cond_17_case_0.i16, label %__hugr__.__tk2_helios_qalloc.13.exit17

cond_17_case_0.i16:                               ; preds = %__hugr__.__tk2_helios_qalloc.13.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.13.exit17:           ; preds = %__hugr__.__tk2_helios_qalloc.13.exit
  ...
  %___lazy_measure7 = tail call i64 @___lazy_measure(i64 %qalloc.i14)
  tail call void @___qfree(i64 %qalloc.i14)
  %read_bool9 = tail call i1 @___read_future_bool(i64 %___lazy_measure7)
