...
__hugr__.__tk2_sol_qalloc.13.exit17:              ; preds = %__hugr__.__tk2_sol_qalloc.13.exit
  ...
  %___future_measure7 = tail call i64 @___future_measure(i64 %qalloc.i14, i64 0)
  tail call void @___qfree(i64 %qalloc.i14)
  %read_bool9 = tail call i1 @___read_future_bool(i64 %___future_measure7)
  tail call void @___dec_future_refcount(i64 %___future_measure7)
