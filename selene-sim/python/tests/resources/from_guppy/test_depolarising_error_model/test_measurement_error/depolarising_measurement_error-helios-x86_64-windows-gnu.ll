...
entry:
  ...
  br i1 %not_max.not.not.i.i, label %cond_28_case_0.i.i, label %__hugr__.__tk2_qalloc.24.exit.i

cond_28_case_0.i.i:                               ; preds = %entry
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.24.exit.i:                  ; preds = %entry
  ...
  %not_max.not.not.i49.i = icmp eq i64 %qalloc.i48.i, -1
  br i1 %not_max.not.not.i49.i, label %cond_42_case_0.i.i, label %__hugr__.__main__.main.1.exit

cond_42_case_0.i.i:                               ; preds = %__hugr__.__tk2_qalloc.24.exit.i
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__main__.main.1.exit:                    ; preds = %__hugr__.__tk2_qalloc.24.exit.i
  ...
  tail call void @___rxy(i64 %qalloc.i48.i, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i48.i, double 0x400921FB54442D18)
  %lazy_measure22.i = tail call i64 @___lazy_measure(i64 %qalloc.i48.i)
  tail call void @___qfree(i64 %qalloc.i48.i)
  ...
  tail call void @print_bool(ptr nonnull @res_c2.60825383.0, i64 12, i1 %read_bool35.i)
