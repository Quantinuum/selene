...
__hugr__.__tk2_sol_qalloc.24.exit:                ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i18, label %cond_42_case_0.i, label %__hugr__.__tk2_sol_qalloc.38.exit

cond_42_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.24.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.38.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.24.exit
  ...
  tail call void @___rp(i64 %qalloc.i17, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
