...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_16_case_0.i, label %__hugr__.__tk2_helios_qalloc.12.exit

cond_16_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.12.exit:             ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %qalloc.i13 = tail call i64 @___qalloc()
  %not_max.not.not.i14 = icmp eq i64 %qalloc.i13, -1
  br i1 %not_max.not.not.i14, label %cond_16_case_0.i15, label %__hugr__.__tk2_helios_qalloc.12.exit16

cond_16_case_0.i15:                               ; preds = %__hugr__.__tk2_helios_qalloc.12.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.12.exit16:           ; preds = %__hugr__.__tk2_helios_qalloc.12.exit
  ...
  %___lazy_measure6 = tail call i64 @___lazy_measure(i64 %qalloc.i13)
  tail call void @___qfree(i64 %qalloc.i13)
  %read_bool8 = tail call i1 @___read_future_bool(i64 %___lazy_measure6)
