...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_24_case_0.i, label %__hugr__.__tk2_helios_qalloc.20.exit

cond_24_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.20.exit:             ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %qalloc.i15 = tail call i64 @___qalloc()
  %not_max.not.not.i16 = icmp eq i64 %qalloc.i15, -1
  br i1 %not_max.not.not.i16, label %cond_38_case_0.i, label %__hugr__.__tk2_helios_qalloc.34.exit

cond_38_case_0.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.20.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.34.exit:             ; preds = %__hugr__.__tk2_helios_qalloc.20.exit
