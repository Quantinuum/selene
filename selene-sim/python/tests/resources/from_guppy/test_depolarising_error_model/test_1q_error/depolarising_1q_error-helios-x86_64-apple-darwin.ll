...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_34_case_0.i, label %__hugr__.__tk2_helios_qalloc.30.exit
...
__hugr__.__tk2_helios_qalloc.30.exit:             ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i23, label %cond_48_case_0.i, label %__hugr__.__tk2_helios_qalloc.44.exit

cond_48_case_0.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.30.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.44.exit:             ; preds = %__hugr__.__tk2_helios_qalloc.30.exit
  tail call void @___reset(i64 %qalloc.i22)
  tail call void @___rxy(i64 %qalloc.i22, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i22, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i22, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i22, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i22, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i22, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i22, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i22, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i22, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
