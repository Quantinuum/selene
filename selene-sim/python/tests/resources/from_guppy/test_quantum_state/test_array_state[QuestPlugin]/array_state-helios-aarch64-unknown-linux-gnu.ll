...
cond_104_case_1:
  ...
  br i1 %not_max.not.not.i, label %cond_398_case_0.i, label %__barray_check_bounds.exit

cond_398_case_0.i:                                ; preds = %cond_104_case_1.1, %cond_104_case_1
...
cond_104_case_1.1:                                ; preds = %__barray_check_bounds.exit
  ...
  br i1 %not_max.not.not.i.1, label %cond_398_case_0.i, label %__barray_check_bounds.exit.1
...
cond_exit_104.2:                                  ; preds = %__barray_check_bounds.exit.1
  ...
  br i1 %9, label %panic.i528, label %__barray_check_bounds.exit530

panic.i528:                                       ; preds = %__barray_check_bounds.exit527.1, %cond_exit_104.2
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

__barray_check_bounds.exit530:                    ; preds = %cond_exit_104.2
  ...
  br i1 %13, label %__barray_check_bounds.exit527.1, label %panic.i531

panic.i531:                                       ; preds = %__barray_check_bounds.exit530.1, %__barray_check_bounds.exit530
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

__barray_check_bounds.exit527.1:                  ; preds = %__barray_check_bounds.exit530
  %14 = and i64 %12, -2
  store i64 %14, ptr %1, align 4
  store i64 %11, ptr %0, align 4
  %15 = load i64, ptr %1, align 4
  %16 = and i64 %15, 2
  %.not534 = icmp eq i64 %16, 0
  br i1 %.not534, label %__barray_check_bounds.exit530.1, label %panic.i528

__barray_check_bounds.exit530.1:                  ; preds = %__barray_check_bounds.exit527.1
  ...
  %21 = and i64 %20, 2
  %.not535 = icmp eq i64 %21, 0
  br i1 %.not535, label %panic.i531, label %__barray_mask_return.exit532.1

__barray_mask_return.exit532.1:                   ; preds = %__barray_check_bounds.exit530.1
  %22 = and i64 %20, -3
...
mask_block_err.i:                                 ; preds = %__barray_mask_return.exit532.1
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_bounds.exit.1.i:                   ; preds = %__barray_mask_return.exit532.1
  ...
  %.repack525 = getelementptr inbounds nuw i8, ptr %26, i64 1
  store i1 false, ptr %.repack525, align 1
  ...
  br i1 %.not.i, label %__barray_mask_borrow.exit.1.i, label %cond_exit_268.1.i
...
__barray_mask_borrow.exit.1.i:                    ; preds = %__barray_check_bounds.exit.1.i
  ...
  br label %cond_exit_268.1.i

cond_exit_268.1.i:                                ; preds = %__barray_mask_borrow.exit.1.i, %__barray_check_bounds.exit.1.i
  %33 = phi i64 [ %.pre.i, %__barray_mask_borrow.exit.1.i ], [ %29, %__barray_check_bounds.exit.1.i ]
  %34 = or i64 %33, -4
  store i64 %34, ptr %27, align 4
  %35 = icmp eq i64 %34, -1
  br i1 %35, label %"__hugr__.guppylang.std.quantum.discard_array$2.222.exit", label %mask_block_err.i.i

mask_block_err.i.i:                               ; preds = %cond_exit_268.1.i
  call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable

"__hugr__.guppylang.std.quantum.discard_array$2.222.exit": ; preds = %cond_exit_268.1.i
