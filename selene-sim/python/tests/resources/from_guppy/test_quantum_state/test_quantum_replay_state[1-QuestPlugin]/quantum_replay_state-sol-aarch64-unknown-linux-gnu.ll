...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_28_case_0.i, label %__hugr__.__tk2_sol_qalloc.24.exit

cond_28_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.24.exit:                ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i99, label %cond_28_case_0.i100, label %__hugr__.__tk2_sol_qalloc.24.exit101

cond_28_case_0.i100:                              ; preds = %__hugr__.__tk2_sol_qalloc.24.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.24.exit101:             ; preds = %__hugr__.__tk2_sol_qalloc.24.exit
  ...
  tail call void @___rpp(i64 %qalloc.i, i64 %qalloc.i98, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %qalloc.i98, double 0xBFF921FB54442D18, double 0.000000e+00)
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.24.exit101
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_mask_check_not_borrowed.exit103:         ; preds = %__hugr__.__tk2_sol_qalloc.24.exit101
