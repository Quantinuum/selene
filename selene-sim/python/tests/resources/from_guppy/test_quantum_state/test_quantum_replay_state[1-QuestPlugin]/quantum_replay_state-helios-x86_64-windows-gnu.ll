...
__hugr__.__tk2_helios_qalloc.24.exit:             ; preds = %alloca_block
  ...
  %qalloc.i98 = tail call i64 @___qalloc()
  %not_max.not.not.i99 = icmp eq i64 %qalloc.i98, -1
  br i1 %not_max.not.not.i99, label %cond_28_case_0.i100, label %__hugr__.__tk2_helios_qalloc.24.exit101

cond_28_case_0.i100:                              ; preds = %__hugr__.__tk2_helios_qalloc.24.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.24.exit101:          ; preds = %__hugr__.__tk2_helios_qalloc.24.exit
  tail call void @___reset(i64 %qalloc.i98)
  tail call void @___rxy(i64 %qalloc.i98, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i98, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i98, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i98, double 0xBFF921FB54442D18)
  ...
  store i64 %qalloc.i98, ptr %2, align 4
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.24.exit101
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_mask_check_not_borrowed.exit103:         ; preds = %__hugr__.__tk2_helios_qalloc.24.exit101
  ...
  %.repack97 = getelementptr inbounds nuw i8, ptr %6, i64 1
  store i1 false, ptr %.repack97, align 1
  ...
  %___lazy_measure = call i64 @___lazy_measure(i64 %8)
...
__barray_mask_check_not_borrowed.exit107:         ; preds = %__barray_mask_check_not_borrowed.exit103
  %read_bool = call i1 @___read_future_bool(i64 %___lazy_measure)
  call void @___dec_future_refcount(i64 %___lazy_measure)
  ...
  %___lazy_measure48 = call i64 @___lazy_measure(i64 %17)
  call void @___qfree(i64 %17)
  %read_bool50 = call i1 @___read_future_bool(i64 %___lazy_measure48)
  call void @___dec_future_refcount(i64 %___lazy_measure48)
