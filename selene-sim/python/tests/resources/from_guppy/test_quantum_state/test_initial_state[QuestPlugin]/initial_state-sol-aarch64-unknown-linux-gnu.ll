...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_15_case_0.i, label %__hugr__.__tk2_sol_qalloc.11.exit

cond_15_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.11.exit:                ; preds = %alloca_block
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.11.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_mask_check_not_borrowed.exit:            ; preds = %__hugr__.__tk2_sol_qalloc.11.exit
