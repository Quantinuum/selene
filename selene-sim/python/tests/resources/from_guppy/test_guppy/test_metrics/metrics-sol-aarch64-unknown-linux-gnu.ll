...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_449_case_0.i, label %__hugr__.__tk2_sol_qalloc.422.exit

cond_449_case_0.i:                                ; preds = %cond_exit_20.1, %cond_exit_20, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.422.exit:               ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %2 = load i64, ptr %1, align 4
  %3 = trunc i64 %2 to i1
  br i1 %3, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.2, %__hugr__.__tk2_sol_qalloc.422.exit.1, %__hugr__.__tk2_sol_qalloc.422.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_sol_qalloc.422.exit
  %4 = and i64 %2, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_449_case_0.i, label %__hugr__.__tk2_sol_qalloc.422.exit.1

__hugr__.__tk2_sol_qalloc.422.exit.1:             ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.422.exit.1
  %7 = and i64 %5, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_449_case_0.i, label %__barray_check_bounds.exit.2
...
__barray_mask_borrow.exit:                        ; preds = %cond_exit_20.2
  ...
  tail call void @___rp(i64 %16, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_mask_borrow.exit187:                     ; preds = %__barray_mask_borrow.exit185
  ...
  tail call void @___rp(i64 %29, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %29, double 0xC002D97C7F3321D2)
  tail call void @___rp(i64 %26, double 0x3FF921FB54442D18, double 0xC002D97C7F3321D2)
  tail call void @___rz(i64 %26, double 0xC002D97C7F3321D2)
  tail call void @___rp(i64 %23, double 0x3FF921FB54442D18, double 0xC002D97C7F3321D2)
  tail call void @___rz(i64 %23, double 0xC002D97C7F3321D2)
  tail call void @___rpp(i64 %23, i64 %29, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %29, double 0x3FE921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %29, double 0x3FF921FB54442D18)
  tail call void @___rp(i64 %23, double 0xBFF921FB54442D18, double 0.000000e+00)
  tail call void @___rpp(i64 %23, i64 %26, double 0xBFE921FB54442D18, double 0.000000e+00)
  tail call void @___rpp(i64 %26, i64 %29, double 0x3FE921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %29, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %29, double 0x400921FB54442D18)
  tail call void @___rpp(i64 %23, i64 %29, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %29, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %29, double 0x3FF921FB54442D18)
  tail call void @___rpp(i64 %26, i64 %29, double 0xBFE921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %26, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %26, double 0x400921FB54442D18)
  tail call void @___rp(i64 %23, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %23, double 0x3FF921FB54442D18)
...
"__hugr__.guppylang.std.quantum.collect_measurements$3.186.exit": ; preds = %cond_exit_472.thread.2.i.i
...
mask_block_err.i.i.i203:                          ; preds = %cond_exit_472.thread.2.i.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable
...
__barray_mask_borrow.exit228.i.i:                 ; preds = %loop_body.2.i199
  ...
  br label %cond_exit_472.thread.i.i

cond_exit_472.thread.i.i:                         ; preds = %loop_body.2.i199, %__barray_mask_borrow.exit228.i.i
  %83 = phi i64 [ %117, %loop_body.2.i199 ], [ %.pre, %__barray_mask_borrow.exit228.i.i ]
  %84 = and i64 %83, 2
  %.not222 = icmp eq i64 %84, 0
  br i1 %.not222, label %__barray_mask_borrow.exit228.1.i.i, label %cond_exit_472.thread.1.i.i

__barray_mask_borrow.exit228.1.i.i:               ; preds = %cond_exit_472.thread.i.i
  ...
  br label %cond_exit_472.thread.1.i.i

cond_exit_472.thread.1.i.i:                       ; preds = %__barray_mask_borrow.exit228.1.i.i, %cond_exit_472.thread.i.i
  %87 = phi i64 [ %.pre226, %__barray_mask_borrow.exit228.1.i.i ], [ %83, %cond_exit_472.thread.i.i ]
  %88 = and i64 %87, 4
  %.not223 = icmp eq i64 %88, 0
  br i1 %.not223, label %__barray_mask_borrow.exit228.2.i.i, label %cond_exit_472.thread.2.i.i

__barray_mask_borrow.exit228.2.i.i:               ; preds = %cond_exit_472.thread.1.i.i
  ...
  br label %cond_exit_472.thread.2.i.i

cond_exit_472.thread.2.i.i:                       ; preds = %__barray_mask_borrow.exit228.2.i.i, %cond_exit_472.thread.1.i.i
  %91 = phi i64 [ %.pre227, %__barray_mask_borrow.exit228.2.i.i ], [ %87, %cond_exit_472.thread.1.i.i ]
  %92 = or i64 %91, -8
...
loop_body.2.i199:                                 ; preds = %__barray_check_bounds.exit.2.i198
  ...
  br i1 %118, label %cond_exit_472.thread.i.i, label %__barray_mask_borrow.exit228.i.i
