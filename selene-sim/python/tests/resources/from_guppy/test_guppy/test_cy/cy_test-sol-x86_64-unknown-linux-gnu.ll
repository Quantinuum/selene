...
__barray_mask_borrow.exit:                        ; preds = %__barray_check_none_borrowed.exit763
  ...
  br i1 %.fca.0.extract605, label %cond_371_case_1, label %cond_exit_506

cond_exit_506:                                    ; preds = %cond_371_case_1, %__barray_mask_borrow.exit, %__barray_check_none_borrowed.exit763
...
__barray_mask_borrow.exit.1:                      ; preds = %cond_exit_506
  ...
  br i1 %.fca.0.extract605.1, label %cond_371_case_1.1, label %cond_exit_506.1

cond_371_case_1.1:                                ; preds = %__barray_mask_borrow.exit.1
...
cond_exit_506.1:                                  ; preds = %cond_371_case_1.1, %__barray_mask_borrow.exit.1, %cond_exit_506
...
cond_371_case_1:                                  ; preds = %__barray_mask_borrow.exit
...
alloca_block:
  ...
  br i1 %.fca.0.extract, label %cond_391_case_1, label %cond_391_case_0

cond_391_case_0:                                  ; preds = %alloca_block
  %.fca.2.extract = extractvalue { i1, i64, i1 } %0, 2
  br label %cond_exit_391

cond_391_case_1:                                  ; preds = %alloca_block
...
cond_exit_391:                                    ; preds = %cond_391_case_1, %cond_391_case_0
  %"03.0" = phi i1 [ %read_bool, %cond_391_case_1 ], [ %.fca.2.extract, %cond_391_case_0 ]
  ret i1 %"03.0"
}
