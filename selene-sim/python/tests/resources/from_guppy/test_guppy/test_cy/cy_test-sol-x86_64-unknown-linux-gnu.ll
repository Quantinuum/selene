...
__hugr__.__tk2_sol_qalloc.60.exit252:             ; preds = %__hugr__.__tk2_sol_qalloc.60.exit
  ...
  %___future_measure6 = tail call i64 @___future_measure(i64 %qalloc.i249, i64 0)
  tail call void @___qfree(i64 %qalloc.i249)
  %read_bool = tail call i1 @___read_future_bool(i64 %___future_measure6)
  tail call void @___dec_future_refcount(i64 %___future_measure6)
  %read_bool9 = tail call i1 @___read_future_bool(i64 %___future_measure)
...
__hugr__.__tk2_sol_qalloc.60.exit264:             ; preds = %__hugr__.__tk2_sol_qalloc.60.exit260
  ...
  %___future_measure31 = call i64 @___future_measure(i64 %qalloc.i257, i64 0)
  call void @___qfree(i64 %qalloc.i257)
  call void @___rp(i64 %qalloc.i261, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___future_measure34 = call i64 @___future_measure(i64 %qalloc.i261, i64 0)
  call void @___qfree(i64 %qalloc.i261)
  %read_bool36 = call i1 @___read_future_bool(i64 %___future_measure34)
  call void @___dec_future_refcount(i64 %___future_measure34)
  %read_bool39 = call i1 @___read_future_bool(i64 %___future_measure31)
  call void @___dec_future_refcount(i64 %___future_measure31)
...
__hugr__.__tk2_sol_qalloc.60.exit282:             ; preds = %__hugr__.__tk2_sol_qalloc.60.exit278
  ...
  %___future_measure71 = call i64 @___future_measure(i64 %qalloc.i275, i64 0)
  call void @___qfree(i64 %qalloc.i275)
  call void @___rp(i64 %qalloc.i279, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___future_measure74 = call i64 @___future_measure(i64 %qalloc.i279, i64 0)
  call void @___qfree(i64 %qalloc.i279)
  %read_bool76 = call i1 @___read_future_bool(i64 %___future_measure74)
  call void @___dec_future_refcount(i64 %___future_measure74)
  %read_bool79 = call i1 @___read_future_bool(i64 %___future_measure71)
  call void @___dec_future_refcount(i64 %___future_measure71)
...
__hugr__.__tk2_sol_qalloc.60.exit300:             ; preds = %__hugr__.__tk2_sol_qalloc.60.exit296
  ...
  %___future_measure112 = call i64 @___future_measure(i64 %qalloc.i293, i64 0)
  call void @___qfree(i64 %qalloc.i293)
  call void @___rp(i64 %qalloc.i297, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___future_measure115 = call i64 @___future_measure(i64 %qalloc.i297, i64 0)
  call void @___qfree(i64 %qalloc.i297)
  %read_bool117 = call i1 @___read_future_bool(i64 %___future_measure115)
  call void @___dec_future_refcount(i64 %___future_measure115)
  %read_bool120 = call i1 @___read_future_bool(i64 %___future_measure112)
  call void @___dec_future_refcount(i64 %___future_measure112)
