...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_89_case_0.i, label %__hugr__.__tk2_helios_qalloc.85.exit

cond_89_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.85.exit:             ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %qalloc.i241 = tail call i64 @___qalloc()
  %not_max.not.not.i242 = icmp eq i64 %qalloc.i241, -1
  br i1 %not_max.not.not.i242, label %cond_103_case_0.i, label %__hugr__.__tk2_helios_qalloc.99.exit

cond_103_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.85.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.99.exit:             ; preds = %__hugr__.__tk2_helios_qalloc.85.exit
  tail call void @___reset(i64 %qalloc.i241)
  tail call void @___rxy(i64 %qalloc.i241, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i, double 0x400921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i241, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i241, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  ...
  tail call void @___rxy(i64 %qalloc.i241, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.99.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_helios_qalloc.99.exit
...
__barray_check_none_borrowed.exit244:             ; preds = %__barray_check_none_borrowed.exit
  ...
  br i1 %not_max.not.not.i246, label %cond_146_case_0.i, label %__hugr__.__tk2_helios_qalloc.142.exit

cond_146_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit244
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.142.exit:            ; preds = %__barray_check_none_borrowed.exit244
  call void @___reset(i64 %qalloc.i245)
  %qalloc.i247 = call i64 @___qalloc()
  %not_max.not.not.i248 = icmp eq i64 %qalloc.i247, -1
  br i1 %not_max.not.not.i248, label %cond_160_case_0.i, label %__hugr__.__tk2_helios_qalloc.156.exit

cond_160_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.142.exit
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.156.exit:            ; preds = %__hugr__.__tk2_helios_qalloc.142.exit
  call void @___reset(i64 %qalloc.i247)
  call void @___rxy(i64 %qalloc.i247, double 0x400921FB54442D18, double 0.000000e+00)
  call void @___rxy(i64 %qalloc.i247, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i245, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i245, i64 %qalloc.i247, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i247, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i247, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i245, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  ...
  call void @___rxy(i64 %qalloc.i247, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
mask_block_err.i251:                              ; preds = %__hugr__.__tk2_helios_qalloc.156.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit252:             ; preds = %__hugr__.__tk2_helios_qalloc.156.exit
...
__barray_check_none_borrowed.exit254:             ; preds = %__barray_check_none_borrowed.exit252
  ...
  br i1 %not_max.not.not.i256, label %cond_211_case_0.i, label %__hugr__.__tk2_helios_qalloc.207.exit

cond_211_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit254
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.207.exit:            ; preds = %__barray_check_none_borrowed.exit254
  call void @___reset(i64 %qalloc.i255)
  call void @___rxy(i64 %qalloc.i255, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i257 = call i64 @___qalloc()
  %not_max.not.not.i258 = icmp eq i64 %qalloc.i257, -1
  br i1 %not_max.not.not.i258, label %cond_225_case_0.i, label %__hugr__.__tk2_helios_qalloc.221.exit

cond_225_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.207.exit
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.221.exit:            ; preds = %__hugr__.__tk2_helios_qalloc.207.exit
  call void @___reset(i64 %qalloc.i257)
  call void @___rxy(i64 %qalloc.i257, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i255, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i255, i64 %qalloc.i257, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i257, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i257, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i255, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
mask_block_err.i261:                              ; preds = %__hugr__.__tk2_helios_qalloc.221.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit262:             ; preds = %__hugr__.__tk2_helios_qalloc.221.exit
...
__barray_check_none_borrowed.exit264:             ; preds = %__barray_check_none_borrowed.exit262
  ...
  br i1 %not_max.not.not.i266, label %cond_276_case_0.i, label %__hugr__.__tk2_helios_qalloc.272.exit

cond_276_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit264
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.272.exit:            ; preds = %__barray_check_none_borrowed.exit264
  call void @___reset(i64 %qalloc.i265)
  call void @___rxy(i64 %qalloc.i265, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i267 = call i64 @___qalloc()
  %not_max.not.not.i268 = icmp eq i64 %qalloc.i267, -1
  br i1 %not_max.not.not.i268, label %cond_290_case_0.i, label %__hugr__.__tk2_helios_qalloc.286.exit

cond_290_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.272.exit
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.286.exit:            ; preds = %__hugr__.__tk2_helios_qalloc.272.exit
  call void @___reset(i64 %qalloc.i267)
  call void @___rxy(i64 %qalloc.i267, double 0x400921FB54442D18, double 0.000000e+00)
  call void @___rxy(i64 %qalloc.i267, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i265, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i265, i64 %qalloc.i267, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i267, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i267, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i265, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  ...
  call void @___rxy(i64 %qalloc.i267, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
mask_block_err.i271:                              ; preds = %__hugr__.__tk2_helios_qalloc.286.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit272:             ; preds = %__hugr__.__tk2_helios_qalloc.286.exit
