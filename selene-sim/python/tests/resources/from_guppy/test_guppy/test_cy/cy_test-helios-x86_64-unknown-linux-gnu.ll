...
__barray_check_none_borrowed.exit763:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit.1"
  ...
  br i1 %33, label %cond_exit_374, label %__barray_mask_borrow.exit

mask_block_err.i761:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit.1"
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i767:                              ; preds = %cond_exit_374.1
...
__barray_mask_borrow.exit:                        ; preds = %__barray_check_none_borrowed.exit763
  ...
  br i1 %.fca.0.extract605, label %cond_534_case_1, label %cond_exit_374

cond_exit_374:                                    ; preds = %cond_534_case_1, %__barray_mask_borrow.exit, %__barray_check_none_borrowed.exit763
  %36 = load i64, ptr %24, align 4
  %37 = and i64 %36, 2
  %.not1010 = icmp eq i64 %37, 0
  br i1 %.not1010, label %__barray_mask_borrow.exit.1, label %cond_exit_374.1

__barray_mask_borrow.exit.1:                      ; preds = %cond_exit_374
  ...
  br i1 %.fca.0.extract605.1, label %cond_534_case_1.1, label %cond_exit_374.1

cond_534_case_1.1:                                ; preds = %__barray_mask_borrow.exit.1
  %.fca.1.extract606.1 = extractvalue { i1, i64, i1 } %40, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract606.1)
  br label %cond_exit_374.1

cond_exit_374.1:                                  ; preds = %cond_534_case_1.1, %__barray_mask_borrow.exit.1, %cond_exit_374
...
loop_out:                                         ; preds = %cond_exit_374.1
