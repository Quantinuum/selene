...
__hugr__.__tk2_qalloc.104.exit:                   ; preds = %__hugr__.__tk2_qalloc.90.exit
  ...
  tail call void @___rxy(i64 %qalloc.i755, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i, double 0x400921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i755, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i755, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i755, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  ...
  tail call void @___rxy(i64 %qalloc.i755, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_qalloc.104.exit
  ...
  br i1 %.fca.0.extract118.i, label %cond_477_case_1.i, label %cond_477_case_0.i

mask_block_err.i:                                 ; preds = %__hugr__.__tk2_qalloc.104.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_477_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit
  %.fca.2.extract120.i = extractvalue { i1, i64, i1 } %10, 2
  br label %cond_exit_477.i

cond_477_case_1.i:                                ; preds = %__barray_check_none_borrowed.exit
  %.fca.1.extract119.i = extractvalue { i1, i64, i1 } %10, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i)
  br label %cond_exit_477.i

cond_exit_477.i:                                  ; preds = %cond_477_case_1.i, %cond_477_case_0.i
  %"02.sroa.3.0.i" = phi i64 [ %.fca.1.extract119.i, %cond_477_case_1.i ], [ undef, %cond_477_case_0.i ]
  %"02.sroa.6.0.i" = phi i1 [ undef, %cond_477_case_1.i ], [ %.fca.2.extract120.i, %cond_477_case_0.i ]
  %11 = load i64, ptr %4, align 4
  %12 = trunc i64 %11 to i1
  br i1 %12, label %panic.i.i, label %cond_470_case_1.i

panic.i.i:                                        ; preds = %cond_exit_477.i.1, %cond_exit_477.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_470_case_1.i:                                ; preds = %cond_exit_477.i
  %"15.fca.1.insert.i" = insertvalue { i1, i64, i1 } %10, i64 %"02.sroa.3.0.i", 1
  %"15.fca.2.insert.i" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i", i1 %"02.sroa.6.0.i", 2
  %13 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i", 1
  %.fca.2.0.extract.i = load i1, ptr %3, align 1
  store { i1, { i1, i64, i1 } } %13, ptr %3, align 4
  br i1 %.fca.2.0.extract.i, label %cond_469_case_1.i, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit"

cond_469_case_1.i:                                ; preds = %cond_470_case_1.i.1, %cond_470_case_1.i
  tail call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit": ; preds = %cond_470_case_1.i
  store { i1, i64, i1 } %"15.fca.2.insert.i", ptr %8, align 4
  %14 = load { i1, i64, i1 }, ptr %2, align 4
  %.fca.0.extract118.i.1 = extractvalue { i1, i64, i1 } %14, 0
  br i1 %.fca.0.extract118.i.1, label %cond_477_case_1.i.1, label %cond_477_case_0.i.1

cond_477_case_0.i.1:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit"
  %.fca.2.extract120.i.1 = extractvalue { i1, i64, i1 } %14, 2
  br label %cond_exit_477.i.1

cond_477_case_1.i.1:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit"
  %.fca.1.extract119.i.1 = extractvalue { i1, i64, i1 } %14, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i.1)
  br label %cond_exit_477.i.1

cond_exit_477.i.1:                                ; preds = %cond_477_case_0.i.1, %cond_477_case_1.i.1
  %"02.sroa.3.0.i.1" = phi i64 [ %.fca.1.extract119.i.1, %cond_477_case_1.i.1 ], [ undef, %cond_477_case_0.i.1 ]
  %"02.sroa.6.0.i.1" = phi i1 [ undef, %cond_477_case_1.i.1 ], [ %.fca.2.extract120.i.1, %cond_477_case_0.i.1 ]
  %15 = load i64, ptr %4, align 4
  %16 = and i64 %15, 2
  %.not = icmp eq i64 %16, 0
  br i1 %.not, label %cond_470_case_1.i.1, label %panic.i.i

cond_470_case_1.i.1:                              ; preds = %cond_exit_477.i.1
  %"15.fca.1.insert.i.1" = insertvalue { i1, i64, i1 } %14, i64 %"02.sroa.3.0.i.1", 1
  %"15.fca.2.insert.i.1" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i.1", i1 %"02.sroa.6.0.i.1", 2
  %17 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i.1", 1
  %18 = getelementptr i8, ptr %3, i64 32
  %.fca.2.0.extract.i.1 = load i1, ptr %18, align 1
  store { i1, { i1, i64, i1 } } %17, ptr %18, align 4
  br i1 %.fca.2.0.extract.i.1, label %cond_469_case_1.i, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit.1": ; preds = %cond_470_case_1.i.1
  %19 = getelementptr inbounds nuw i8, ptr %8, i64 24
  store { i1, i64, i1 } %"15.fca.2.insert.i.1", ptr %19, align 4
...
__barray_check_none_borrowed.exit763:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit.1"
  ...
  %26 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %25)
  %27 = extractvalue { { i1, i64, i1 } } %26, 0
  store { i1, i64, i1 } %27, ptr %23, align 4
  %28 = load { i1, { i1, i64, i1 } }, ptr %18, align 4
  %29 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %28)
  ...
  br i1 %33, label %cond_exit_390, label %__barray_mask_borrow.exit

mask_block_err.i761:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit.1"
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i767:                              ; preds = %cond_exit_390.1
...
__barray_mask_borrow.exit:                        ; preds = %__barray_check_none_borrowed.exit763
  ...
  br i1 %.fca.0.extract605, label %cond_453_case_1, label %cond_exit_390

cond_exit_390:                                    ; preds = %cond_453_case_1, %__barray_mask_borrow.exit, %__barray_check_none_borrowed.exit763
  %36 = load i64, ptr %24, align 4
  %37 = and i64 %36, 2
  %.not1010 = icmp eq i64 %37, 0
  br i1 %.not1010, label %__barray_mask_borrow.exit.1, label %cond_exit_390.1

__barray_mask_borrow.exit.1:                      ; preds = %cond_exit_390
  ...
  br i1 %.fca.0.extract605.1, label %cond_453_case_1.1, label %cond_exit_390.1

cond_453_case_1.1:                                ; preds = %__barray_mask_borrow.exit.1
  %.fca.1.extract606.1 = extractvalue { i1, i64, i1 } %40, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract606.1)
  br label %cond_exit_390.1

cond_exit_390.1:                                  ; preds = %cond_453_case_1.1, %__barray_mask_borrow.exit.1, %cond_exit_390
...
loop_out:                                         ; preds = %cond_exit_390.1
...
__barray_check_none_borrowed.exit780:             ; preds = %__barray_check_none_borrowed.exit774
  ...
  br i1 %not_max.not.not.i782, label %cond_151_case_0.i, label %__hugr__.__tk2_qalloc.147.exit

mask_block_err.i778:                              ; preds = %__barray_check_none_borrowed.exit774
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_151_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit780
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.147.exit:                   ; preds = %__barray_check_none_borrowed.exit780
  call void @___reset(i64 %qalloc.i781)
  %qalloc.i783 = call i64 @___qalloc()
  %not_max.not.not.i784 = icmp eq i64 %qalloc.i783, -1
  br i1 %not_max.not.not.i784, label %cond_165_case_0.i, label %__hugr__.__tk2_qalloc.161.exit

cond_165_case_0.i:                                ; preds = %__hugr__.__tk2_qalloc.147.exit
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.161.exit:                   ; preds = %__hugr__.__tk2_qalloc.147.exit
  call void @___reset(i64 %qalloc.i783)
  call void @___rxy(i64 %qalloc.i783, double 0x400921FB54442D18, double 0.000000e+00)
  call void @___rxy(i64 %qalloc.i783, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i781, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i781, i64 %qalloc.i783, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i783, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i783, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i781, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  ...
  call void @___rxy(i64 %qalloc.i783, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
__barray_check_none_borrowed.exit792:             ; preds = %__hugr__.__tk2_qalloc.161.exit
  ...
  br i1 %.fca.0.extract118.i793, label %cond_477_case_1.i809, label %cond_477_case_0.i794

mask_block_err.i790:                              ; preds = %__hugr__.__tk2_qalloc.161.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_477_case_0.i794:                             ; preds = %__barray_check_none_borrowed.exit792
  %.fca.2.extract120.i795 = extractvalue { i1, i64, i1 } %70, 2
  br label %cond_exit_477.i796

cond_477_case_1.i809:                             ; preds = %__barray_check_none_borrowed.exit792
  %.fca.1.extract119.i810 = extractvalue { i1, i64, i1 } %70, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i810)
  br label %cond_exit_477.i796

cond_exit_477.i796:                               ; preds = %cond_477_case_1.i809, %cond_477_case_0.i794
  %"02.sroa.3.0.i797" = phi i64 [ %.fca.1.extract119.i810, %cond_477_case_1.i809 ], [ undef, %cond_477_case_0.i794 ]
  %"02.sroa.6.0.i798" = phi i1 [ undef, %cond_477_case_1.i809 ], [ %.fca.2.extract120.i795, %cond_477_case_0.i794 ]
  %71 = load i64, ptr %64, align 4
  %72 = trunc i64 %71 to i1
  br i1 %72, label %panic.i.i808, label %cond_470_case_1.i800

panic.i.i808:                                     ; preds = %cond_exit_477.i796.1, %cond_exit_477.i796
  call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_470_case_1.i800:                             ; preds = %cond_exit_477.i796
  %"15.fca.1.insert.i801" = insertvalue { i1, i64, i1 } %70, i64 %"02.sroa.3.0.i797", 1
  %"15.fca.2.insert.i802" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i801", i1 %"02.sroa.6.0.i798", 2
  %73 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i802", 1
  %.fca.2.0.extract.i803 = load i1, ptr %63, align 1
  store { i1, { i1, i64, i1 } } %73, ptr %63, align 4
  br i1 %.fca.2.0.extract.i803, label %cond_469_case_1.i807, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811"

cond_469_case_1.i807:                             ; preds = %cond_470_case_1.i800.1, %cond_470_case_1.i800
  call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811": ; preds = %cond_470_case_1.i800
  store { i1, i64, i1 } %"15.fca.2.insert.i802", ptr %68, align 4
  %74 = load { i1, i64, i1 }, ptr %62, align 4
  %.fca.0.extract118.i793.1 = extractvalue { i1, i64, i1 } %74, 0
  br i1 %.fca.0.extract118.i793.1, label %cond_477_case_1.i809.1, label %cond_477_case_0.i794.1

cond_477_case_0.i794.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811"
  %.fca.2.extract120.i795.1 = extractvalue { i1, i64, i1 } %74, 2
  br label %cond_exit_477.i796.1

cond_477_case_1.i809.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811"
  %.fca.1.extract119.i810.1 = extractvalue { i1, i64, i1 } %74, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i810.1)
  br label %cond_exit_477.i796.1

cond_exit_477.i796.1:                             ; preds = %cond_477_case_0.i794.1, %cond_477_case_1.i809.1
  %"02.sroa.3.0.i797.1" = phi i64 [ %.fca.1.extract119.i810.1, %cond_477_case_1.i809.1 ], [ undef, %cond_477_case_0.i794.1 ]
  %"02.sroa.6.0.i798.1" = phi i1 [ undef, %cond_477_case_1.i809.1 ], [ %.fca.2.extract120.i795.1, %cond_477_case_0.i794.1 ]
  %75 = load i64, ptr %64, align 4
  %76 = and i64 %75, 2
  %.not995 = icmp eq i64 %76, 0
  br i1 %.not995, label %cond_470_case_1.i800.1, label %panic.i.i808

cond_470_case_1.i800.1:                           ; preds = %cond_exit_477.i796.1
  %"15.fca.1.insert.i801.1" = insertvalue { i1, i64, i1 } %74, i64 %"02.sroa.3.0.i797.1", 1
  %"15.fca.2.insert.i802.1" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i801.1", i1 %"02.sroa.6.0.i798.1", 2
  %77 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i802.1", 1
  %78 = getelementptr i8, ptr %63, i64 32
  %.fca.2.0.extract.i803.1 = load i1, ptr %78, align 1
  store { i1, { i1, i64, i1 } } %77, ptr %78, align 4
  br i1 %.fca.2.0.extract.i803.1, label %cond_469_case_1.i807, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811.1": ; preds = %cond_470_case_1.i800.1
  %79 = getelementptr inbounds nuw i8, ptr %68, i64 24
  store { i1, i64, i1 } %"15.fca.2.insert.i802.1", ptr %79, align 4
...
__barray_check_none_borrowed.exit820:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811.1"
  %83 = call ptr @heap_alloc(i64 48)
  %84 = call ptr @heap_alloc(i64 8)
  store i64 0, ptr %84, align 1
  %85 = load { i1, { i1, i64, i1 } }, ptr %63, align 4
  %86 = call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %85)
  %87 = extractvalue { { i1, i64, i1 } } %86, 0
  store { i1, i64, i1 } %87, ptr %83, align 4
  %88 = load { i1, { i1, i64, i1 } }, ptr %78, align 4
  %89 = call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %88)
  ...
  br i1 %93, label %cond_exit_558, label %__barray_mask_borrow.exit828

mask_block_err.i818:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit811.1"
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i824:                              ; preds = %cond_exit_558.1
...
__barray_mask_borrow.exit828:                     ; preds = %__barray_check_none_borrowed.exit820
  ...
  br i1 %.fca.0.extract555, label %cond_581_case_1, label %cond_exit_558

cond_exit_558:                                    ; preds = %cond_581_case_1, %__barray_mask_borrow.exit828, %__barray_check_none_borrowed.exit820
  %96 = load i64, ptr %84, align 4
  %97 = and i64 %96, 2
  %.not1011 = icmp eq i64 %97, 0
  br i1 %.not1011, label %__barray_mask_borrow.exit828.1, label %cond_exit_558.1

__barray_mask_borrow.exit828.1:                   ; preds = %cond_exit_558
  ...
  br i1 %.fca.0.extract555.1, label %cond_581_case_1.1, label %cond_exit_558.1

cond_581_case_1.1:                                ; preds = %__barray_mask_borrow.exit828.1
...
cond_exit_558.1:                                  ; preds = %cond_581_case_1.1, %__barray_mask_borrow.exit828.1, %cond_exit_558
...
loop_out137:                                      ; preds = %cond_exit_558.1
...
cond_581_case_1:                                  ; preds = %__barray_mask_borrow.exit828
...
__barray_check_none_borrowed.exit840:             ; preds = %__barray_check_none_borrowed.exit834
  ...
  br i1 %not_max.not.not.i842, label %cond_216_case_0.i, label %__hugr__.__tk2_qalloc.212.exit

mask_block_err.i838:                              ; preds = %__barray_check_none_borrowed.exit834
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_216_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit840
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.212.exit:                   ; preds = %__barray_check_none_borrowed.exit840
  call void @___reset(i64 %qalloc.i841)
  call void @___rxy(i64 %qalloc.i841, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i843 = call i64 @___qalloc()
  %not_max.not.not.i844 = icmp eq i64 %qalloc.i843, -1
  br i1 %not_max.not.not.i844, label %cond_230_case_0.i, label %__hugr__.__tk2_qalloc.226.exit

cond_230_case_0.i:                                ; preds = %__hugr__.__tk2_qalloc.212.exit
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.226.exit:                   ; preds = %__hugr__.__tk2_qalloc.212.exit
  call void @___reset(i64 %qalloc.i843)
  call void @___rxy(i64 %qalloc.i843, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i841, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i841, i64 %qalloc.i843, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i843, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i843, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i841, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  ...
  call void @___rxy(i64 %qalloc.i843, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
__barray_check_none_borrowed.exit852:             ; preds = %__hugr__.__tk2_qalloc.226.exit
  ...
  br i1 %.fca.0.extract118.i853, label %cond_477_case_1.i869, label %cond_477_case_0.i854

mask_block_err.i850:                              ; preds = %__hugr__.__tk2_qalloc.226.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_477_case_0.i854:                             ; preds = %__barray_check_none_borrowed.exit852
  %.fca.2.extract120.i855 = extractvalue { i1, i64, i1 } %130, 2
  br label %cond_exit_477.i856

cond_477_case_1.i869:                             ; preds = %__barray_check_none_borrowed.exit852
  %.fca.1.extract119.i870 = extractvalue { i1, i64, i1 } %130, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i870)
  br label %cond_exit_477.i856

cond_exit_477.i856:                               ; preds = %cond_477_case_1.i869, %cond_477_case_0.i854
  %"02.sroa.3.0.i857" = phi i64 [ %.fca.1.extract119.i870, %cond_477_case_1.i869 ], [ undef, %cond_477_case_0.i854 ]
  %"02.sroa.6.0.i858" = phi i1 [ undef, %cond_477_case_1.i869 ], [ %.fca.2.extract120.i855, %cond_477_case_0.i854 ]
  %131 = load i64, ptr %124, align 4
  %132 = trunc i64 %131 to i1
  br i1 %132, label %panic.i.i868, label %cond_470_case_1.i860

panic.i.i868:                                     ; preds = %cond_exit_477.i856.1, %cond_exit_477.i856
  call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_470_case_1.i860:                             ; preds = %cond_exit_477.i856
  %"15.fca.1.insert.i861" = insertvalue { i1, i64, i1 } %130, i64 %"02.sroa.3.0.i857", 1
  %"15.fca.2.insert.i862" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i861", i1 %"02.sroa.6.0.i858", 2
  %133 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i862", 1
  %.fca.2.0.extract.i863 = load i1, ptr %123, align 1
  store { i1, { i1, i64, i1 } } %133, ptr %123, align 4
  br i1 %.fca.2.0.extract.i863, label %cond_469_case_1.i867, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871"

cond_469_case_1.i867:                             ; preds = %cond_470_case_1.i860.1, %cond_470_case_1.i860
  call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871": ; preds = %cond_470_case_1.i860
  store { i1, i64, i1 } %"15.fca.2.insert.i862", ptr %128, align 4
  %134 = load { i1, i64, i1 }, ptr %122, align 4
  %.fca.0.extract118.i853.1 = extractvalue { i1, i64, i1 } %134, 0
  br i1 %.fca.0.extract118.i853.1, label %cond_477_case_1.i869.1, label %cond_477_case_0.i854.1

cond_477_case_0.i854.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871"
  %.fca.2.extract120.i855.1 = extractvalue { i1, i64, i1 } %134, 2
  br label %cond_exit_477.i856.1

cond_477_case_1.i869.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871"
  %.fca.1.extract119.i870.1 = extractvalue { i1, i64, i1 } %134, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i870.1)
  br label %cond_exit_477.i856.1

cond_exit_477.i856.1:                             ; preds = %cond_477_case_0.i854.1, %cond_477_case_1.i869.1
  %"02.sroa.3.0.i857.1" = phi i64 [ %.fca.1.extract119.i870.1, %cond_477_case_1.i869.1 ], [ undef, %cond_477_case_0.i854.1 ]
  %"02.sroa.6.0.i858.1" = phi i1 [ undef, %cond_477_case_1.i869.1 ], [ %.fca.2.extract120.i855.1, %cond_477_case_0.i854.1 ]
  %135 = load i64, ptr %124, align 4
  %136 = and i64 %135, 2
  %.not996 = icmp eq i64 %136, 0
  br i1 %.not996, label %cond_470_case_1.i860.1, label %panic.i.i868

cond_470_case_1.i860.1:                           ; preds = %cond_exit_477.i856.1
  %"15.fca.1.insert.i861.1" = insertvalue { i1, i64, i1 } %134, i64 %"02.sroa.3.0.i857.1", 1
  %"15.fca.2.insert.i862.1" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i861.1", i1 %"02.sroa.6.0.i858.1", 2
  %137 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i862.1", 1
  %138 = getelementptr i8, ptr %123, i64 32
  %.fca.2.0.extract.i863.1 = load i1, ptr %138, align 1
  store { i1, { i1, i64, i1 } } %137, ptr %138, align 4
  br i1 %.fca.2.0.extract.i863.1, label %cond_469_case_1.i867, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871.1": ; preds = %cond_470_case_1.i860.1
  %139 = getelementptr inbounds nuw i8, ptr %128, i64 24
  store { i1, i64, i1 } %"15.fca.2.insert.i862.1", ptr %139, align 4
...
__barray_check_none_borrowed.exit880:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871.1"
  ...
  %146 = call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %145)
  %147 = extractvalue { { i1, i64, i1 } } %146, 0
  store { i1, i64, i1 } %147, ptr %143, align 4
  %148 = load { i1, { i1, i64, i1 } }, ptr %138, align 4
  %149 = call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %148)
  ...
  br i1 %153, label %cond_exit_604, label %__barray_mask_borrow.exit888

mask_block_err.i878:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit871.1"
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i884:                              ; preds = %cond_exit_604.1
  call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable
...
__barray_mask_borrow.exit888:                     ; preds = %__barray_check_none_borrowed.exit880
  ...
  br i1 %.fca.0.extract505, label %cond_627_case_1, label %cond_exit_604

cond_exit_604:                                    ; preds = %cond_627_case_1, %__barray_mask_borrow.exit888, %__barray_check_none_borrowed.exit880
  %156 = load i64, ptr %144, align 4
  %157 = and i64 %156, 2
  %.not1012 = icmp eq i64 %157, 0
  br i1 %.not1012, label %__barray_mask_borrow.exit888.1, label %cond_exit_604.1

__barray_mask_borrow.exit888.1:                   ; preds = %cond_exit_604
  ...
  br i1 %.fca.0.extract505.1, label %cond_627_case_1.1, label %cond_exit_604.1

cond_627_case_1.1:                                ; preds = %__barray_mask_borrow.exit888.1
  %.fca.1.extract506.1 = extractvalue { i1, i64, i1 } %160, 1
  call void @___dec_future_refcount(i64 %.fca.1.extract506.1)
  br label %cond_exit_604.1

cond_exit_604.1:                                  ; preds = %cond_627_case_1.1, %__barray_mask_borrow.exit888.1, %cond_exit_604
...
loop_out249:                                      ; preds = %cond_exit_604.1
...
__barray_check_none_borrowed.exit900:             ; preds = %__barray_check_none_borrowed.exit894
  ...
  br i1 %not_max.not.not.i902, label %cond_281_case_0.i, label %__hugr__.__tk2_qalloc.277.exit

mask_block_err.i898:                              ; preds = %__barray_check_none_borrowed.exit894
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_281_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit900
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.277.exit:                   ; preds = %__barray_check_none_borrowed.exit900
  call void @___reset(i64 %qalloc.i901)
  call void @___rxy(i64 %qalloc.i901, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i903 = call i64 @___qalloc()
  %not_max.not.not.i904 = icmp eq i64 %qalloc.i903, -1
  br i1 %not_max.not.not.i904, label %cond_295_case_0.i, label %__hugr__.__tk2_qalloc.291.exit

cond_295_case_0.i:                                ; preds = %__hugr__.__tk2_qalloc.277.exit
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.291.exit:                   ; preds = %__hugr__.__tk2_qalloc.277.exit
  call void @___reset(i64 %qalloc.i903)
  call void @___rxy(i64 %qalloc.i903, double 0x400921FB54442D18, double 0.000000e+00)
  call void @___rxy(i64 %qalloc.i903, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i901, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i901, i64 %qalloc.i903, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i903, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i903, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i901, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  ...
  call void @___rxy(i64 %qalloc.i903, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
...
__barray_check_none_borrowed.exit912:             ; preds = %__hugr__.__tk2_qalloc.291.exit
  ...
  br i1 %.fca.0.extract118.i913, label %cond_477_case_1.i929, label %cond_477_case_0.i914

mask_block_err.i910:                              ; preds = %__hugr__.__tk2_qalloc.291.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_477_case_0.i914:                             ; preds = %__barray_check_none_borrowed.exit912
  %.fca.2.extract120.i915 = extractvalue { i1, i64, i1 } %190, 2
  br label %cond_exit_477.i916

cond_477_case_1.i929:                             ; preds = %__barray_check_none_borrowed.exit912
  %.fca.1.extract119.i930 = extractvalue { i1, i64, i1 } %190, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i930)
  br label %cond_exit_477.i916

cond_exit_477.i916:                               ; preds = %cond_477_case_1.i929, %cond_477_case_0.i914
  %"02.sroa.3.0.i917" = phi i64 [ %.fca.1.extract119.i930, %cond_477_case_1.i929 ], [ undef, %cond_477_case_0.i914 ]
  %"02.sroa.6.0.i918" = phi i1 [ undef, %cond_477_case_1.i929 ], [ %.fca.2.extract120.i915, %cond_477_case_0.i914 ]
  %191 = load i64, ptr %184, align 4
  %192 = trunc i64 %191 to i1
  br i1 %192, label %panic.i.i928, label %cond_470_case_1.i920

panic.i.i928:                                     ; preds = %cond_exit_477.i916.1, %cond_exit_477.i916
  call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_470_case_1.i920:                             ; preds = %cond_exit_477.i916
  %"15.fca.1.insert.i921" = insertvalue { i1, i64, i1 } %190, i64 %"02.sroa.3.0.i917", 1
  %"15.fca.2.insert.i922" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i921", i1 %"02.sroa.6.0.i918", 2
  %193 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i922", 1
  %.fca.2.0.extract.i923 = load i1, ptr %183, align 1
  store { i1, { i1, i64, i1 } } %193, ptr %183, align 4
  br i1 %.fca.2.0.extract.i923, label %cond_469_case_1.i927, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931"

cond_469_case_1.i927:                             ; preds = %cond_470_case_1.i920.1, %cond_470_case_1.i920
  call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931": ; preds = %cond_470_case_1.i920
  store { i1, i64, i1 } %"15.fca.2.insert.i922", ptr %188, align 4
  %194 = load { i1, i64, i1 }, ptr %182, align 4
  %.fca.0.extract118.i913.1 = extractvalue { i1, i64, i1 } %194, 0
  br i1 %.fca.0.extract118.i913.1, label %cond_477_case_1.i929.1, label %cond_477_case_0.i914.1

cond_477_case_0.i914.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931"
  %.fca.2.extract120.i915.1 = extractvalue { i1, i64, i1 } %194, 2
  br label %cond_exit_477.i916.1

cond_477_case_1.i929.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931"
  %.fca.1.extract119.i930.1 = extractvalue { i1, i64, i1 } %194, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i930.1)
  br label %cond_exit_477.i916.1

cond_exit_477.i916.1:                             ; preds = %cond_477_case_0.i914.1, %cond_477_case_1.i929.1
  %"02.sroa.3.0.i917.1" = phi i64 [ %.fca.1.extract119.i930.1, %cond_477_case_1.i929.1 ], [ undef, %cond_477_case_0.i914.1 ]
  %"02.sroa.6.0.i918.1" = phi i1 [ undef, %cond_477_case_1.i929.1 ], [ %.fca.2.extract120.i915.1, %cond_477_case_0.i914.1 ]
  %195 = load i64, ptr %184, align 4
  %196 = and i64 %195, 2
  %.not997 = icmp eq i64 %196, 0
  br i1 %.not997, label %cond_470_case_1.i920.1, label %panic.i.i928

cond_470_case_1.i920.1:                           ; preds = %cond_exit_477.i916.1
  %"15.fca.1.insert.i921.1" = insertvalue { i1, i64, i1 } %194, i64 %"02.sroa.3.0.i917.1", 1
  %"15.fca.2.insert.i922.1" = insertvalue { i1, i64, i1 } %"15.fca.1.insert.i921.1", i1 %"02.sroa.6.0.i918.1", 2
  %197 = insertvalue { i1, { i1, i64, i1 } } { i1 true, { i1, i64, i1 } poison }, { i1, i64, i1 } %"15.fca.2.insert.i922.1", 1
  %198 = getelementptr i8, ptr %183, i64 32
  %.fca.2.0.extract.i923.1 = load i1, ptr %198, align 1
  store { i1, { i1, i64, i1 } } %197, ptr %198, align 4
  br i1 %.fca.2.0.extract.i923.1, label %cond_469_case_1.i927, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931.1": ; preds = %cond_470_case_1.i920.1
  %199 = getelementptr inbounds nuw i8, ptr %188, i64 24
  store { i1, i64, i1 } %"15.fca.2.insert.i922.1", ptr %199, align 4
...
__barray_check_none_borrowed.exit940:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931.1"
  ...
  %206 = call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %205)
  %207 = extractvalue { { i1, i64, i1 } } %206, 0
  store { i1, i64, i1 } %207, ptr %203, align 4
  %208 = load { i1, { i1, i64, i1 } }, ptr %198, align 4
  %209 = call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %208)
  ...
  br i1 %213, label %cond_exit_650, label %__barray_mask_borrow.exit948

mask_block_err.i938:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).476.exit931.1"
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i944:                              ; preds = %cond_exit_650.1
  call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable
...
__barray_mask_borrow.exit948:                     ; preds = %__barray_check_none_borrowed.exit940
  ...
  br i1 %.fca.0.extract455, label %cond_673_case_1, label %cond_exit_650

cond_exit_650:                                    ; preds = %cond_673_case_1, %__barray_mask_borrow.exit948, %__barray_check_none_borrowed.exit940
  %216 = load i64, ptr %204, align 4
  %217 = and i64 %216, 2
  %.not1013 = icmp eq i64 %217, 0
  br i1 %.not1013, label %__barray_mask_borrow.exit948.1, label %cond_exit_650.1

__barray_mask_borrow.exit948.1:                   ; preds = %cond_exit_650
  ...
  br i1 %.fca.0.extract455.1, label %cond_673_case_1.1, label %cond_exit_650.1

cond_673_case_1.1:                                ; preds = %__barray_mask_borrow.exit948.1
  %.fca.1.extract456.1 = extractvalue { i1, i64, i1 } %220, 1
  call void @___dec_future_refcount(i64 %.fca.1.extract456.1)
  br label %cond_exit_650.1

cond_exit_650.1:                                  ; preds = %cond_673_case_1.1, %__barray_mask_borrow.exit948.1, %cond_exit_650
...
loop_out362:                                      ; preds = %cond_exit_650.1
...
alloca_block:
  ...
  br i1 %.fca.0.extract, label %cond_518_case_1, label %cond_518_case_0

cond_518_case_0:                                  ; preds = %alloca_block
  %.fca.2.extract = extractvalue { i1, i64, i1 } %0, 2
  br label %cond_exit_518

cond_518_case_1:                                  ; preds = %alloca_block
...
cond_exit_518:                                    ; preds = %cond_518_case_1, %cond_518_case_0
  %"03.0" = phi i1 [ %read_bool, %cond_518_case_1 ], [ %.fca.2.extract, %cond_518_case_0 ]
  ret i1 %"03.0"
}
...
define internal { i1, i64, i1 } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).539"({ i1, { i1, i64, i1 } } %0) unnamed_addr {
alloca_block:
  %.fca.0.extract11 = extractvalue { i1, { i1, i64, i1 } } %0, 0
  br i1 %.fca.0.extract11, label %cond_542_case_1, label %cond_542_case_0

cond_542_case_1:                                  ; preds = %alloca_block
  %1 = extractvalue { i1, { i1, i64, i1 } } %0, 1
  ret { i1, i64, i1 } %1

cond_542_case_0:                                  ; preds = %alloca_block
