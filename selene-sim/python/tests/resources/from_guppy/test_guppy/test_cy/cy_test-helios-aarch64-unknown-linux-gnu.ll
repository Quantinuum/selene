...
__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_qalloc.104.exit
  ...
  br i1 %.fca.0.extract118.i, label %cond_490_case_1.i, label %cond_490_case_0.i

mask_block_err.i:                                 ; preds = %__hugr__.__tk2_qalloc.104.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_490_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit
  %.fca.2.extract120.i = extractvalue { i1, i64, i1 } %10, 2
  br label %cond_exit_490.i

cond_490_case_1.i:                                ; preds = %__barray_check_none_borrowed.exit
  %.fca.1.extract119.i = extractvalue { i1, i64, i1 } %10, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i)
  br label %cond_exit_490.i

cond_exit_490.i:                                  ; preds = %cond_490_case_1.i, %cond_490_case_0.i
  %"03.sroa.3.0.i" = phi i64 [ %.fca.1.extract119.i, %cond_490_case_1.i ], [ undef, %cond_490_case_0.i ]
  %"03.sroa.6.0.i" = phi i1 [ undef, %cond_490_case_1.i ], [ %.fca.2.extract120.i, %cond_490_case_0.i ]
  %11 = load i64, ptr %4, align 4
  %12 = trunc i64 %11 to i1
  br i1 %12, label %panic.i.i, label %cond_487_case_1.i

panic.i.i:                                        ; preds = %cond_exit_490.i.1, %cond_exit_490.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_487_case_1.i:                                ; preds = %cond_exit_490.i
  ...
  br i1 %.fca.2.0.extract.i, label %cond_486_case_1.i, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit"

cond_486_case_1.i:                                ; preds = %cond_487_case_1.i.1, %cond_487_case_1.i
  tail call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit": ; preds = %cond_487_case_1.i
  ...
  br i1 %.fca.0.extract118.i.1, label %cond_490_case_1.i.1, label %cond_490_case_0.i.1

cond_490_case_0.i.1:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit"
  %.fca.2.extract120.i.1 = extractvalue { i1, i64, i1 } %14, 2
  br label %cond_exit_490.i.1

cond_490_case_1.i.1:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit"
  %.fca.1.extract119.i.1 = extractvalue { i1, i64, i1 } %14, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i.1)
  br label %cond_exit_490.i.1

cond_exit_490.i.1:                                ; preds = %cond_490_case_0.i.1, %cond_490_case_1.i.1
  %"03.sroa.3.0.i.1" = phi i64 [ %.fca.1.extract119.i.1, %cond_490_case_1.i.1 ], [ undef, %cond_490_case_0.i.1 ]
  %"03.sroa.6.0.i.1" = phi i1 [ undef, %cond_490_case_1.i.1 ], [ %.fca.2.extract120.i.1, %cond_490_case_0.i.1 ]
  %15 = load i64, ptr %4, align 4
  %16 = and i64 %15, 2
  %.not = icmp eq i64 %16, 0
  br i1 %.not, label %cond_487_case_1.i.1, label %panic.i.i

cond_487_case_1.i.1:                              ; preds = %cond_exit_490.i.1
  ...
  br i1 %.fca.2.0.extract.i.1, label %cond_486_case_1.i, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit.1": ; preds = %cond_487_case_1.i.1
...
__barray_check_none_borrowed.exit763:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit.1"
  ...
  br i1 %33, label %cond_exit_369, label %__barray_mask_borrow.exit

mask_block_err.i761:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit.1"
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i767:                              ; preds = %cond_exit_369.1
...
__barray_mask_borrow.exit:                        ; preds = %__barray_check_none_borrowed.exit763
  ...
  br i1 %.fca.0.extract605, label %cond_393_case_1, label %cond_exit_369

cond_exit_369:                                    ; preds = %cond_393_case_1, %__barray_mask_borrow.exit, %__barray_check_none_borrowed.exit763
  %36 = load i64, ptr %24, align 4
  %37 = and i64 %36, 2
  %.not1010 = icmp eq i64 %37, 0
  br i1 %.not1010, label %__barray_mask_borrow.exit.1, label %cond_exit_369.1

__barray_mask_borrow.exit.1:                      ; preds = %cond_exit_369
  ...
  br i1 %.fca.0.extract605.1, label %cond_393_case_1.1, label %cond_exit_369.1

cond_393_case_1.1:                                ; preds = %__barray_mask_borrow.exit.1
  %.fca.1.extract606.1 = extractvalue { i1, i64, i1 } %40, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract606.1)
  br label %cond_exit_369.1

cond_exit_369.1:                                  ; preds = %cond_393_case_1.1, %__barray_mask_borrow.exit.1, %cond_exit_369
...
loop_out:                                         ; preds = %cond_exit_369.1
...
__barray_check_none_borrowed.exit792:             ; preds = %__hugr__.__tk2_qalloc.161.exit
  ...
  br i1 %.fca.0.extract118.i793, label %cond_490_case_1.i809, label %cond_490_case_0.i794

mask_block_err.i790:                              ; preds = %__hugr__.__tk2_qalloc.161.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_490_case_0.i794:                             ; preds = %__barray_check_none_borrowed.exit792
  %.fca.2.extract120.i795 = extractvalue { i1, i64, i1 } %70, 2
  br label %cond_exit_490.i796

cond_490_case_1.i809:                             ; preds = %__barray_check_none_borrowed.exit792
  %.fca.1.extract119.i810 = extractvalue { i1, i64, i1 } %70, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i810)
  br label %cond_exit_490.i796

cond_exit_490.i796:                               ; preds = %cond_490_case_1.i809, %cond_490_case_0.i794
  %"03.sroa.3.0.i797" = phi i64 [ %.fca.1.extract119.i810, %cond_490_case_1.i809 ], [ undef, %cond_490_case_0.i794 ]
  %"03.sroa.6.0.i798" = phi i1 [ undef, %cond_490_case_1.i809 ], [ %.fca.2.extract120.i795, %cond_490_case_0.i794 ]
  %71 = load i64, ptr %64, align 4
  %72 = trunc i64 %71 to i1
  br i1 %72, label %panic.i.i808, label %cond_487_case_1.i800

panic.i.i808:                                     ; preds = %cond_exit_490.i796.1, %cond_exit_490.i796
  call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_487_case_1.i800:                             ; preds = %cond_exit_490.i796
  ...
  br i1 %.fca.2.0.extract.i803, label %cond_486_case_1.i807, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811"

cond_486_case_1.i807:                             ; preds = %cond_487_case_1.i800.1, %cond_487_case_1.i800
  call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811": ; preds = %cond_487_case_1.i800
  ...
  br i1 %.fca.0.extract118.i793.1, label %cond_490_case_1.i809.1, label %cond_490_case_0.i794.1

cond_490_case_0.i794.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811"
  %.fca.2.extract120.i795.1 = extractvalue { i1, i64, i1 } %74, 2
  br label %cond_exit_490.i796.1

cond_490_case_1.i809.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811"
  %.fca.1.extract119.i810.1 = extractvalue { i1, i64, i1 } %74, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i810.1)
  br label %cond_exit_490.i796.1

cond_exit_490.i796.1:                             ; preds = %cond_490_case_0.i794.1, %cond_490_case_1.i809.1
  %"03.sroa.3.0.i797.1" = phi i64 [ %.fca.1.extract119.i810.1, %cond_490_case_1.i809.1 ], [ undef, %cond_490_case_0.i794.1 ]
  %"03.sroa.6.0.i798.1" = phi i1 [ undef, %cond_490_case_1.i809.1 ], [ %.fca.2.extract120.i795.1, %cond_490_case_0.i794.1 ]
  %75 = load i64, ptr %64, align 4
  %76 = and i64 %75, 2
  %.not995 = icmp eq i64 %76, 0
  br i1 %.not995, label %cond_487_case_1.i800.1, label %panic.i.i808

cond_487_case_1.i800.1:                           ; preds = %cond_exit_490.i796.1
  ...
  br i1 %.fca.2.0.extract.i803.1, label %cond_486_case_1.i807, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811.1": ; preds = %cond_487_case_1.i800.1
...
__barray_check_none_borrowed.exit820:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811.1"
...
mask_block_err.i818:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit811.1"
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable
...
__barray_check_none_borrowed.exit852:             ; preds = %__hugr__.__tk2_qalloc.226.exit
  ...
  br i1 %.fca.0.extract118.i853, label %cond_490_case_1.i869, label %cond_490_case_0.i854

mask_block_err.i850:                              ; preds = %__hugr__.__tk2_qalloc.226.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_490_case_0.i854:                             ; preds = %__barray_check_none_borrowed.exit852
  %.fca.2.extract120.i855 = extractvalue { i1, i64, i1 } %130, 2
  br label %cond_exit_490.i856

cond_490_case_1.i869:                             ; preds = %__barray_check_none_borrowed.exit852
  %.fca.1.extract119.i870 = extractvalue { i1, i64, i1 } %130, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i870)
  br label %cond_exit_490.i856

cond_exit_490.i856:                               ; preds = %cond_490_case_1.i869, %cond_490_case_0.i854
  %"03.sroa.3.0.i857" = phi i64 [ %.fca.1.extract119.i870, %cond_490_case_1.i869 ], [ undef, %cond_490_case_0.i854 ]
  %"03.sroa.6.0.i858" = phi i1 [ undef, %cond_490_case_1.i869 ], [ %.fca.2.extract120.i855, %cond_490_case_0.i854 ]
  %131 = load i64, ptr %124, align 4
  %132 = trunc i64 %131 to i1
  br i1 %132, label %panic.i.i868, label %cond_487_case_1.i860

panic.i.i868:                                     ; preds = %cond_exit_490.i856.1, %cond_exit_490.i856
  call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_487_case_1.i860:                             ; preds = %cond_exit_490.i856
  ...
  br i1 %.fca.2.0.extract.i863, label %cond_486_case_1.i867, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871"

cond_486_case_1.i867:                             ; preds = %cond_487_case_1.i860.1, %cond_487_case_1.i860
  call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871": ; preds = %cond_487_case_1.i860
  ...
  br i1 %.fca.0.extract118.i853.1, label %cond_490_case_1.i869.1, label %cond_490_case_0.i854.1

cond_490_case_0.i854.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871"
  %.fca.2.extract120.i855.1 = extractvalue { i1, i64, i1 } %134, 2
  br label %cond_exit_490.i856.1

cond_490_case_1.i869.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871"
  %.fca.1.extract119.i870.1 = extractvalue { i1, i64, i1 } %134, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i870.1)
  br label %cond_exit_490.i856.1

cond_exit_490.i856.1:                             ; preds = %cond_490_case_0.i854.1, %cond_490_case_1.i869.1
  %"03.sroa.3.0.i857.1" = phi i64 [ %.fca.1.extract119.i870.1, %cond_490_case_1.i869.1 ], [ undef, %cond_490_case_0.i854.1 ]
  %"03.sroa.6.0.i858.1" = phi i1 [ undef, %cond_490_case_1.i869.1 ], [ %.fca.2.extract120.i855.1, %cond_490_case_0.i854.1 ]
  %135 = load i64, ptr %124, align 4
  %136 = and i64 %135, 2
  %.not996 = icmp eq i64 %136, 0
  br i1 %.not996, label %cond_487_case_1.i860.1, label %panic.i.i868

cond_487_case_1.i860.1:                           ; preds = %cond_exit_490.i856.1
  ...
  br i1 %.fca.2.0.extract.i863.1, label %cond_486_case_1.i867, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871.1": ; preds = %cond_487_case_1.i860.1
...
__barray_check_none_borrowed.exit880:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871.1"
...
mask_block_err.i878:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit871.1"
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable
...
__barray_check_none_borrowed.exit912:             ; preds = %__hugr__.__tk2_qalloc.291.exit
  ...
  br i1 %.fca.0.extract118.i913, label %cond_490_case_1.i929, label %cond_490_case_0.i914

mask_block_err.i910:                              ; preds = %__hugr__.__tk2_qalloc.291.exit
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_490_case_0.i914:                             ; preds = %__barray_check_none_borrowed.exit912
  %.fca.2.extract120.i915 = extractvalue { i1, i64, i1 } %190, 2
  br label %cond_exit_490.i916

cond_490_case_1.i929:                             ; preds = %__barray_check_none_borrowed.exit912
  %.fca.1.extract119.i930 = extractvalue { i1, i64, i1 } %190, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i930)
  br label %cond_exit_490.i916

cond_exit_490.i916:                               ; preds = %cond_490_case_1.i929, %cond_490_case_0.i914
  %"03.sroa.3.0.i917" = phi i64 [ %.fca.1.extract119.i930, %cond_490_case_1.i929 ], [ undef, %cond_490_case_0.i914 ]
  %"03.sroa.6.0.i918" = phi i1 [ undef, %cond_490_case_1.i929 ], [ %.fca.2.extract120.i915, %cond_490_case_0.i914 ]
  %191 = load i64, ptr %184, align 4
  %192 = trunc i64 %191 to i1
  br i1 %192, label %panic.i.i928, label %cond_487_case_1.i920

panic.i.i928:                                     ; preds = %cond_exit_490.i916.1, %cond_exit_490.i916
  call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_487_case_1.i920:                             ; preds = %cond_exit_490.i916
  ...
  br i1 %.fca.2.0.extract.i923, label %cond_486_case_1.i927, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931"

cond_486_case_1.i927:                             ; preds = %cond_487_case_1.i920.1, %cond_487_case_1.i920
  call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931": ; preds = %cond_487_case_1.i920
  ...
  br i1 %.fca.0.extract118.i913.1, label %cond_490_case_1.i929.1, label %cond_490_case_0.i914.1

cond_490_case_0.i914.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931"
  %.fca.2.extract120.i915.1 = extractvalue { i1, i64, i1 } %194, 2
  br label %cond_exit_490.i916.1

cond_490_case_1.i929.1:                           ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931"
  %.fca.1.extract119.i930.1 = extractvalue { i1, i64, i1 } %194, 1
  call void @___inc_future_refcount(i64 %.fca.1.extract119.i930.1)
  br label %cond_exit_490.i916.1

cond_exit_490.i916.1:                             ; preds = %cond_490_case_0.i914.1, %cond_490_case_1.i929.1
  %"03.sroa.3.0.i917.1" = phi i64 [ %.fca.1.extract119.i930.1, %cond_490_case_1.i929.1 ], [ undef, %cond_490_case_0.i914.1 ]
  %"03.sroa.6.0.i918.1" = phi i1 [ undef, %cond_490_case_1.i929.1 ], [ %.fca.2.extract120.i915.1, %cond_490_case_0.i914.1 ]
  %195 = load i64, ptr %184, align 4
  %196 = and i64 %195, 2
  %.not997 = icmp eq i64 %196, 0
  br i1 %.not997, label %cond_487_case_1.i920.1, label %panic.i.i928

cond_487_case_1.i920.1:                           ; preds = %cond_exit_490.i916.1
  ...
  br i1 %.fca.2.0.extract.i923.1, label %cond_486_case_1.i927, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931.1": ; preds = %cond_487_case_1.i920.1
...
__barray_check_none_borrowed.exit940:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931.1"
...
mask_block_err.i938:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).494.exit931.1"
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable
...
alloca_block:
  ...
  br i1 %.fca.0.extract, label %cond_399_case_1, label %cond_399_case_0

cond_399_case_0:                                  ; preds = %alloca_block
  %.fca.2.extract = extractvalue { i1, i64, i1 } %0, 2
  br label %cond_exit_399

cond_399_case_1:                                  ; preds = %alloca_block
...
cond_exit_399:                                    ; preds = %cond_399_case_1, %cond_399_case_0
  %"03.0" = phi i1 [ %read_bool, %cond_399_case_1 ], [ %.fca.2.extract, %cond_399_case_0 ]
  ret i1 %"03.0"
}
