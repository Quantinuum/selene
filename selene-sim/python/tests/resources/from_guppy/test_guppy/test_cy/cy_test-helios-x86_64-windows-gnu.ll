...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_64_case_0.i, label %__hugr__.__tk2_helios_qalloc.60.exit

cond_64_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit:             ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %qalloc.i249 = tail call i64 @___qalloc()
  %not_max.not.not.i250 = icmp eq i64 %qalloc.i249, -1
  br i1 %not_max.not.not.i250, label %cond_64_case_0.i251, label %__hugr__.__tk2_helios_qalloc.60.exit252

cond_64_case_0.i251:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit252:          ; preds = %__hugr__.__tk2_helios_qalloc.60.exit
  tail call void @___reset(i64 %qalloc.i249)
  tail call void @___rxy(i64 %qalloc.i249, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i, double 0x400921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i249, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i249, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  ...
  tail call void @___rxy(i64 %qalloc.i249, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___lazy_measure6 = tail call i64 @___lazy_measure(i64 %qalloc.i249)
  tail call void @___qfree(i64 %qalloc.i249)
  %read_bool = tail call i1 @___read_future_bool(i64 %___lazy_measure6)
  tail call void @___dec_future_refcount(i64 %___lazy_measure6)
  %read_bool9 = tail call i1 @___read_future_bool(i64 %___lazy_measure)
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.60.exit252
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_helios_qalloc.60.exit252
...
__barray_check_none_borrowed.exit256:             ; preds = %__barray_mask_check_not_borrowed.exit254
  ...
  br i1 %not_max.not.not.i258, label %cond_64_case_0.i259, label %__hugr__.__tk2_helios_qalloc.60.exit260
...
__hugr__.__tk2_helios_qalloc.60.exit260:          ; preds = %__barray_check_none_borrowed.exit256
  call void @___reset(i64 %qalloc.i257)
  %qalloc.i261 = call i64 @___qalloc()
  %not_max.not.not.i262 = icmp eq i64 %qalloc.i261, -1
  br i1 %not_max.not.not.i262, label %cond_64_case_0.i263, label %__hugr__.__tk2_helios_qalloc.60.exit264

cond_64_case_0.i263:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit260
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit264:          ; preds = %__hugr__.__tk2_helios_qalloc.60.exit260
  call void @___reset(i64 %qalloc.i261)
  call void @___rxy(i64 %qalloc.i261, double 0x400921FB54442D18, double 0.000000e+00)
  call void @___rxy(i64 %qalloc.i261, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i257, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i257, i64 %qalloc.i261, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i261, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i261, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i257, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  call void @___rz(i64 %qalloc.i257, double 0xBFF921FB54442D18)
  %___lazy_measure31 = call i64 @___lazy_measure(i64 %qalloc.i257)
  call void @___qfree(i64 %qalloc.i257)
  call void @___rxy(i64 %qalloc.i261, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___lazy_measure34 = call i64 @___lazy_measure(i64 %qalloc.i261)
  call void @___qfree(i64 %qalloc.i261)
  %read_bool36 = call i1 @___read_future_bool(i64 %___lazy_measure34)
  call void @___dec_future_refcount(i64 %___lazy_measure34)
  %read_bool39 = call i1 @___read_future_bool(i64 %___lazy_measure31)
  call void @___dec_future_refcount(i64 %___lazy_measure31)
...
mask_block_err.i267:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit264
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit268:             ; preds = %__hugr__.__tk2_helios_qalloc.60.exit264
...
__barray_check_none_borrowed.exit274:             ; preds = %__barray_mask_check_not_borrowed.exit272
  ...
  br i1 %not_max.not.not.i276, label %cond_64_case_0.i277, label %__hugr__.__tk2_helios_qalloc.60.exit278

cond_64_case_0.i277:                              ; preds = %__barray_check_none_borrowed.exit274
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit278:          ; preds = %__barray_check_none_borrowed.exit274
  call void @___reset(i64 %qalloc.i275)
  call void @___rxy(i64 %qalloc.i275, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i279 = call i64 @___qalloc()
  %not_max.not.not.i280 = icmp eq i64 %qalloc.i279, -1
  br i1 %not_max.not.not.i280, label %cond_64_case_0.i281, label %__hugr__.__tk2_helios_qalloc.60.exit282

cond_64_case_0.i281:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit278
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit282:          ; preds = %__hugr__.__tk2_helios_qalloc.60.exit278
  call void @___reset(i64 %qalloc.i279)
  call void @___rxy(i64 %qalloc.i279, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i275, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i275, i64 %qalloc.i279, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i279, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i279, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i275, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  call void @___rz(i64 %qalloc.i275, double 0xBFF921FB54442D18)
  %___lazy_measure71 = call i64 @___lazy_measure(i64 %qalloc.i275)
  call void @___qfree(i64 %qalloc.i275)
  call void @___rxy(i64 %qalloc.i279, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___lazy_measure74 = call i64 @___lazy_measure(i64 %qalloc.i279)
  call void @___qfree(i64 %qalloc.i279)
  %read_bool76 = call i1 @___read_future_bool(i64 %___lazy_measure74)
  call void @___dec_future_refcount(i64 %___lazy_measure74)
  %read_bool79 = call i1 @___read_future_bool(i64 %___lazy_measure71)
  call void @___dec_future_refcount(i64 %___lazy_measure71)
...
mask_block_err.i285:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit282
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit286:             ; preds = %__hugr__.__tk2_helios_qalloc.60.exit282
...
__barray_check_none_borrowed.exit292:             ; preds = %__barray_mask_check_not_borrowed.exit290
  ...
  br i1 %not_max.not.not.i294, label %cond_64_case_0.i295, label %__hugr__.__tk2_helios_qalloc.60.exit296

cond_64_case_0.i295:                              ; preds = %__barray_check_none_borrowed.exit292
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit296:          ; preds = %__barray_check_none_borrowed.exit292
  call void @___reset(i64 %qalloc.i293)
  call void @___rxy(i64 %qalloc.i293, double 0x400921FB54442D18, double 0.000000e+00)
  %qalloc.i297 = call i64 @___qalloc()
  %not_max.not.not.i298 = icmp eq i64 %qalloc.i297, -1
  br i1 %not_max.not.not.i298, label %cond_64_case_0.i299, label %__hugr__.__tk2_helios_qalloc.60.exit300

cond_64_case_0.i299:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit296
  call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.60.exit300:          ; preds = %__hugr__.__tk2_helios_qalloc.60.exit296
  call void @___reset(i64 %qalloc.i297)
  call void @___rxy(i64 %qalloc.i297, double 0x400921FB54442D18, double 0.000000e+00)
  call void @___rxy(i64 %qalloc.i297, double 0xBFF921FB54442D18, double 0x400921FB54442D18)
  call void @___rxy(i64 %qalloc.i293, double 0x400921FB54442D18, double 0x400921FB54442D18)
  call void @___rzz(i64 %qalloc.i293, i64 %qalloc.i297, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i297, double 0xBFF921FB54442D18, double 0xBFF921FB54442D18)
  call void @___rz(i64 %qalloc.i297, double 0x3FF921FB54442D18)
  call void @___rxy(i64 %qalloc.i293, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  call void @___rz(i64 %qalloc.i293, double 0xBFF921FB54442D18)
  %___lazy_measure112 = call i64 @___lazy_measure(i64 %qalloc.i293)
  call void @___qfree(i64 %qalloc.i293)
  call void @___rxy(i64 %qalloc.i297, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  %___lazy_measure115 = call i64 @___lazy_measure(i64 %qalloc.i297)
  call void @___qfree(i64 %qalloc.i297)
  %read_bool117 = call i1 @___read_future_bool(i64 %___lazy_measure115)
  call void @___dec_future_refcount(i64 %___lazy_measure115)
  %read_bool120 = call i1 @___read_future_bool(i64 %___lazy_measure112)
  call void @___dec_future_refcount(i64 %___lazy_measure112)
...
mask_block_err.i303:                              ; preds = %__hugr__.__tk2_helios_qalloc.60.exit300
  call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit304:             ; preds = %__hugr__.__tk2_helios_qalloc.60.exit300
