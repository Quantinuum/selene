...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_36_case_0.i, label %__hugr__.__tk2_helios_qalloc.32.exit

cond_36_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.32.exit:             ; preds = %alloca_block
...
0:                                                ; preds = %__hugr__.__tk2_helios_qalloc.32.exit
  tail call void @print_bool(ptr nonnull @res_c.1C9EF4D1.0, i64 11, i1 false)
  ret void

1:                                                ; preds = %__hugr__.__tk2_helios_qalloc.32.exit
