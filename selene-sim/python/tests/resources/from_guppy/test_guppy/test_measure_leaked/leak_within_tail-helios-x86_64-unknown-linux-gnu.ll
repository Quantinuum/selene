...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_547_case_0.i, label %__hugr__.__tk2_helios_qalloc.543.exit

cond_547_case_0.i:                                ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.543.exit:            ; preds = %alloca_block
...
cond_21_case_1:                                   ; preds = %__hugr__.__tk2_helios_qalloc.543.exit, %cond_exit_21
  %"16_0.sroa.0.0671" = phi i64 [ 0, %__hugr__.__tk2_helios_qalloc.543.exit ], [ %54, %cond_exit_21 ]
  %54 = add nuw nsw i64 %"16_0.sroa.0.0671", 1
  %qalloc.i596 = tail call i64 @___qalloc()
  %not_max.not.not.i597 = icmp eq i64 %qalloc.i596, -1
  br i1 %not_max.not.not.i597, label %cond_631_case_0.i, label %__barray_check_bounds.exit

cond_631_case_0.i:                                ; preds = %cond_21_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable
...
__barray_mask_borrow.exit:                        ; preds = %loop_out
  ...
  tail call void @___rxy(i64 %64, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %64, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %64, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %64, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit612:                    ; preds = %__barray_mask_borrow.exit604
  ...
  tail call void @___rxy(i64 %81, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %75, i64 %81, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %75, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %81, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %81, double 0xBFF921FB54442D18)
...
loop_body.preheader.i:                            ; preds = %loop_body254
  %"651_1.sroa.10.0.i" = extractvalue { ptr, ptr, i64 } %151, 2
  %"651_1.sroa.5.0.i" = extractvalue { ptr, ptr, i64 } %151, 1
  %"651_1.sroa.0.0.i" = extractvalue { ptr, ptr, i64 } %151, 0
...
cond_654_case_0.i:                                ; preds = %cond_exit_654.thread.i
  %107 = lshr i64 %"651_1.sroa.10.0.i", 6
  %108 = getelementptr i64, ptr %"651_1.sroa.5.0.i", i64 %107
  %109 = load i64, ptr %108, align 4
  %110 = and i64 %"651_1.sroa.10.0.i", 63
  ...
  %last_valid.i.i = add i64 %"651_1.sroa.10.0.i", 19
  %116 = lshr i64 %last_valid.i.i, 6
  %117 = getelementptr inbounds nuw i64, ptr %"651_1.sroa.5.0.i", i64 %116
...
mask_block_ok.i.i:                                ; preds = %cond_654_case_0.i, %124
  %.02.i.i = phi i64 [ %125, %124 ], [ 0, %cond_654_case_0.i ]
...
__barray_check_bounds.exit224.i:                  ; preds = %cond_exit_654.thread.i, %loop_body.preheader.i
  %"651_0.0239.i" = phi i64 [ 0, %loop_body.preheader.i ], [ %128, %cond_exit_654.thread.i ]
  %128 = add nuw nsw i64 %"651_0.0239.i", 1
  %129 = add i64 %"651_0.0239.i", %"651_1.sroa.10.0.i"
  %130 = lshr i64 %129, 6
  %131 = getelementptr inbounds nuw i64, ptr %"651_1.sroa.5.0.i", i64 %130
  %132 = load i64, ptr %131, align 4
  %133 = and i64 %129, 63
  %134 = lshr i64 %132, %133
  %135 = trunc i64 %134 to i1
  br i1 %135, label %cond_exit_654.thread.i, label %__barray_mask_borrow.exit228.i

__barray_mask_borrow.exit228.i:                   ; preds = %__barray_check_bounds.exit224.i
  %136 = shl nuw i64 1, %133
  %137 = xor i64 %136, %132
  store i64 %137, ptr %131, align 4
  %138 = getelementptr inbounds i64, ptr %"651_1.sroa.0.0.i", i64 %129
  %139 = load i64, ptr %138, align 4
  tail call void @___dec_future_refcount(i64 %139)
  br label %cond_exit_654.thread.i

cond_exit_654.thread.i:                           ; preds = %__barray_mask_borrow.exit228.i, %__barray_check_bounds.exit224.i
  %exitcond.i = icmp eq i64 %128, 20
  br i1 %exitcond.i, label %cond_654_case_0.i, label %__barray_check_bounds.exit224.i

"__hugr__.guppylang.std.array.ArrayIter.__next__$Measurement&20.413.exit": ; preds = %124, %cond_654_case_0.i
  tail call void @heap_free(ptr %"651_1.sroa.0.0.i")
  tail call void @heap_free(ptr nonnull %"651_1.sroa.5.0.i")
