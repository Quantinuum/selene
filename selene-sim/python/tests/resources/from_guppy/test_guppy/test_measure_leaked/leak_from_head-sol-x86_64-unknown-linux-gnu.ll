...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_512_case_0.i, label %__hugr__.__tk2_sol_qalloc.508.exit

cond_512_case_0.i:                                ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.508.exit:               ; preds = %alloca_block
...
cond_21_case_1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.508.exit, %cond_exit_21
  %"16_0.sroa.0.0627" = phi i64 [ 0, %__hugr__.__tk2_sol_qalloc.508.exit ], [ %54, %cond_exit_21 ]
  %54 = add nuw nsw i64 %"16_0.sroa.0.0627", 1
  %qalloc.i566 = tail call i64 @___qalloc()
  %not_max.not.not.i567 = icmp eq i64 %qalloc.i566, -1
  br i1 %not_max.not.not.i567, label %cond_577_case_0.i, label %__barray_check_bounds.exit

cond_577_case_0.i:                                ; preds = %cond_21_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable
...
__barray_check_bounds.exit572:                    ; preds = %__barray_check_bounds.exit569
  ...
  tail call void @___rpp(i64 %qalloc.i, i64 %68, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %68, double 0xBFF921FB54442D18, double 0.000000e+00)
...
loop_body.preheader.i:                            ; preds = %loop_body226
  %"597_1.sroa.10.0.i" = extractvalue { ptr, ptr, i64 } %134, 2
  %"597_1.sroa.5.0.i" = extractvalue { ptr, ptr, i64 } %134, 1
  %"597_1.sroa.0.0.i" = extractvalue { ptr, ptr, i64 } %134, 0
...
cond_600_case_0.i:                                ; preds = %cond_exit_600.thread.i
  %90 = lshr i64 %"597_1.sroa.10.0.i", 6
  %91 = getelementptr i64, ptr %"597_1.sroa.5.0.i", i64 %90
  %92 = load i64, ptr %91, align 4
  %93 = and i64 %"597_1.sroa.10.0.i", 63
  ...
  %last_valid.i.i = add i64 %"597_1.sroa.10.0.i", 19
  %99 = lshr i64 %last_valid.i.i, 6
  %100 = getelementptr inbounds nuw i64, ptr %"597_1.sroa.5.0.i", i64 %99
...
mask_block_ok.i.i:                                ; preds = %cond_600_case_0.i, %107
  %.02.i.i = phi i64 [ %108, %107 ], [ 0, %cond_600_case_0.i ]
...
__barray_check_bounds.exit224.i:                  ; preds = %cond_exit_600.thread.i, %loop_body.preheader.i
  %"597_0.0239.i" = phi i64 [ 0, %loop_body.preheader.i ], [ %111, %cond_exit_600.thread.i ]
  %111 = add nuw nsw i64 %"597_0.0239.i", 1
  %112 = add i64 %"597_0.0239.i", %"597_1.sroa.10.0.i"
  %113 = lshr i64 %112, 6
  ...
  br i1 %118, label %cond_exit_600.thread.i, label %__barray_mask_borrow.exit228.i
...
cond_exit_600.thread.i:                           ; preds = %__barray_mask_borrow.exit228.i, %__barray_check_bounds.exit224.i
  %exitcond.i = icmp eq i64 %111, 20
  br i1 %exitcond.i, label %cond_600_case_0.i, label %__barray_check_bounds.exit224.i

"__hugr__.guppylang.std.array.ArrayIter.__next__$Measurement&20.379.exit": ; preds = %107, %cond_600_case_0.i
