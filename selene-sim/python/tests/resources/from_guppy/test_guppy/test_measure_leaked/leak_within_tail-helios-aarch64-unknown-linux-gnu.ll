...
cond_21_case_1:                                   ; preds = %__hugr__.__tk2_qalloc.402.exit, %cond_exit_21
  ...
  br i1 %not_max.not.not.i635, label %cond_354_case_0.i, label %__barray_check_bounds.exit

cond_354_case_0.i:                                ; preds = %cond_21_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable
...
__barray_mask_borrow.exit:                        ; preds = %loop_out
  ...
  tail call void @___rxy(i64 %63, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %63, double 0x3FF921FB54442D18)
  tail call void @___rxy(i64 %63, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %63, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit650:                    ; preds = %__barray_mask_borrow.exit642
  ...
  tail call void @___rxy(i64 %80, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %74, i64 %80, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %74, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %80, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %80, double 0xBFF921FB54442D18)
...
89:                                               ; preds = %cond_exit_91
  ...
  br i1 %.not, label %cond_150_case_0, label %cond_183_case_0
...
95:                                               ; preds = %__barray_check_none_borrowed.exit, %"__hugr__.$__copy_scan$$n(20)$t([Bool]+[Future(Bool)])$n(1).592.exit"
  %storemerge593710 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %103, %"__hugr__.$__copy_scan$$n(20)$t([Bool]+[Future(Bool)])$n(1).592.exit" ]
  ...
  br i1 %.fca.0.extract118.i, label %cond_596_case_1.i, label %cond_596_case_0.i

cond_596_case_0.i:                                ; preds = %95
  %.fca.2.extract120.i = extractvalue { i1, i64, i1 } %97, 2
  br label %cond_exit_596.i

cond_596_case_1.i:                                ; preds = %95
  %.fca.1.extract119.i = extractvalue { i1, i64, i1 } %97, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i)
  br label %cond_exit_596.i

cond_exit_596.i:                                  ; preds = %cond_596_case_0.i, %cond_596_case_1.i
  %"04.sroa.3.0.i" = phi i64 [ %.fca.1.extract119.i, %cond_596_case_1.i ], [ undef, %cond_596_case_0.i ]
  %"04.sroa.6.0.i" = phi i1 [ undef, %cond_596_case_1.i ], [ %.fca.2.extract120.i, %cond_596_case_0.i ]
  %98 = load i64, ptr %49, align 4
  %99 = lshr i64 %98, %storemerge593710
  %100 = trunc i64 %99 to i1
  br i1 %100, label %panic.i.i661, label %cond_599_case_1.i

panic.i.i661:                                     ; preds = %cond_exit_596.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_599_case_1.i:                                ; preds = %cond_exit_596.i
  ...
  br i1 %.fca.2.0.extract.i, label %cond_600_case_1.i, label %"__hugr__.$__copy_scan$$n(20)$t([Bool]+[Future(Bool)])$n(1).592.exit"

cond_600_case_1.i:                                ; preds = %cond_599_case_1.i
  tail call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(20)$t([Bool]+[Future(Bool)])$n(1).592.exit": ; preds = %cond_599_case_1.i
...
mask_block_ok.i662:                               ; preds = %"__hugr__.$__copy_scan$$n(20)$t([Bool]+[Future(Bool)])$n(1).592.exit"
...
110:                                              ; preds = %__barray_check_none_borrowed.exit667, %110
  ...
  %113 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).638"({ i1, { i1, i64, i1 } } %112)
...
cond_729_case_0:                                  ; preds = %cond_exit_729
...
mask_block_err.i671:                              ; preds = %cond_729_case_0
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable

__barray_check_bounds.exit674:                    ; preds = %117, %cond_exit_729
  %"726_0.0718" = phi i64 [ 0, %117 ], [ %121, %cond_exit_729 ]
  %121 = add nuw nsw i64 %"726_0.0718", 1
  %122 = load i64, ptr %109, align 4
  %123 = lshr i64 %122, %"726_0.0718"
  %124 = trunc i64 %123 to i1
  br i1 %124, label %cond_exit_729, label %__barray_mask_borrow.exit678

__barray_mask_borrow.exit678:                     ; preds = %__barray_check_bounds.exit674
  %125 = shl nuw nsw i64 1, %"726_0.0718"
  %126 = xor i64 %122, %125
  store i64 %126, ptr %109, align 4
  %127 = getelementptr inbounds nuw { i1, i64, i1 }, ptr %108, i64 %"726_0.0718"
  %128 = load { i1, i64, i1 }, ptr %127, align 4
  %.fca.0.extract392 = extractvalue { i1, i64, i1 } %128, 0
  br i1 %.fca.0.extract392, label %cond_752_case_1, label %cond_exit_729

cond_exit_729:                                    ; preds = %cond_752_case_1, %__barray_mask_borrow.exit678, %__barray_check_bounds.exit674
  %129 = icmp samesign ugt i64 %"726_0.0718", 18
  br i1 %129, label %cond_729_case_0, label %__barray_check_bounds.exit674

loop_out304:                                      ; preds = %cond_729_case_0
...
cond_752_case_1:                                  ; preds = %__barray_mask_borrow.exit678
...
135:                                              ; preds = %__barray_check_none_borrowed.exit684, %135
  %storemerge599712 = phi i64 [ 0, %__barray_check_none_borrowed.exit684 ], [ %141, %135 ]
  %136 = getelementptr inbounds nuw { i1, i64, i1 }, ptr %93, i64 %storemerge599712
  %137 = load { i1, i64, i1 }, ptr %136, align 4
  %138 = tail call { i1 } @__hugr__.array.__read_bool.3.364({ i1, i64, i1 } %137)
  %139 = getelementptr inbounds nuw i1, ptr %133, i64 %storemerge599712
  %140 = extractvalue { i1 } %138, 0
  store i1 %140, ptr %139, align 1
  %141 = add nuw nsw i64 %storemerge599712, 1
  %exitcond716.not = icmp eq i64 %141, 20
  br i1 %exitcond716.not, label %mask_block_ok.i685, label %135

mask_block_ok.i685:                               ; preds = %135
  ...
  br i1 %144, label %__barray_check_none_borrowed.exit690, label %mask_block_err.i688

__barray_check_none_borrowed.exit690:             ; preds = %mask_block_ok.i685
...
define internal { i1, i64, i1 } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).638"({ i1, { i1, i64, i1 } } %0) unnamed_addr {
alloca_block:
  %.fca.0.extract11 = extractvalue { i1, { i1, i64, i1 } } %0, 0
  br i1 %.fca.0.extract11, label %cond_641_case_1, label %cond_641_case_0

cond_641_case_1:                                  ; preds = %alloca_block
  %1 = extractvalue { i1, { i1, i64, i1 } } %0, 1
  ret { i1, i64, i1 } %1

cond_641_case_0:                                  ; preds = %alloca_block
