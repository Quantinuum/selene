...
cond_exit_647.i:                                  ; preds = %cond_647_case_1.i, %66
  ...
  %exitcond700.not = icmp eq i64 %storemerge609691, 20
  br i1 %exitcond700.not, label %cond_650_case_0.i, label %71

71:                                               ; preds = %cond_exit_647.i
  %72 = lshr i64 %67, 6
...
__hugr__.const_fun_310.313.exit:                  ; preds = %cond_650_case_1.i
  ...
  %exitcond701.not = icmp eq i64 %84, 20
  br i1 %exitcond701.not, label %mask_block_ok.i643, label %66
...
92:                                               ; preds = %__barray_check_none_borrowed.exit645, %__hugr__.const_fun_306.310.exit
  %storemerge596692 = phi i64 [ 0, %__barray_check_none_borrowed.exit645 ], [ %97, %__hugr__.const_fun_306.310.exit ]
  %93 = getelementptr inbounds { i1, { i1, i64, i1 } }, { i1, { i1, i64, i1 } }* %65, i64 %storemerge596692
  %94 = load { i1, { i1, i64, i1 } }, { i1, { i1, i64, i1 } }* %93, align 4
  %.fca.0.extract11.i = extractvalue { i1, { i1, i64, i1 } } %94, 0
  br i1 %.fca.0.extract11.i, label %__hugr__.const_fun_306.310.exit, label %cond_692_case_0.i

cond_692_case_0.i:                                ; preds = %92
  tail call void @panic(i32 1001, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @"e_Expected v.E6312129.0", i64 0, i64 0))
  unreachable

__hugr__.const_fun_306.310.exit:                  ; preds = %92
  %95 = extractvalue { i1, { i1, i64, i1 } } %94, 1
  %96 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %89, i64 %storemerge596692
  store { i1, i64, i1 } %95, { i1, i64, i1 }* %96, align 4
  %97 = add nuw nsw i64 %storemerge596692, 1
  %exitcond702.not = icmp eq i64 %97, 20
  br i1 %exitcond702.not, label %98, label %92

98:                                               ; preds = %__hugr__.const_fun_306.310.exit
...
cond_606_case_0:                                  ; preds = %cond_exit_606
  %99 = load i64, i64* %91, align 4
  %100 = or i64 %99, -1048576
  store i64 %100, i64* %91, align 4
  %101 = icmp eq i64 %100, -1
  br i1 %101, label %loop_out282, label %mask_block_err.i649

mask_block_err.i649:                              ; preds = %cond_606_case_0
  tail call void @panic(i32 1002, i8* getelementptr inbounds ([70 x i8], [70 x i8]* @"e_Array cont.EFA5AC45.0", i64 0, i64 0))
  unreachable

__barray_check_bounds.exit651:                    ; preds = %98, %cond_exit_606
  %"603_0.0705" = phi i64 [ 0, %98 ], [ %102, %cond_exit_606 ]
  %102 = add nuw nsw i64 %"603_0.0705", 1
  %103 = lshr i64 %"603_0.0705", 6
  %104 = getelementptr inbounds i64, i64* %91, i64 %103
  %105 = load i64, i64* %104, align 4
  %106 = shl nuw nsw i64 1, %"603_0.0705"
  %107 = and i64 %105, %106
  %.not681 = icmp eq i64 %107, 0
...
__barray_mask_borrow.exit656:                     ; preds = %__barray_check_bounds.exit651
  ...
  %109 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %89, i64 %"603_0.0705"
  %110 = load { i1, i64, i1 }, { i1, i64, i1 }* %109, align 4
  %.fca.0.extract369 = extractvalue { i1, i64, i1 } %110, 0
...
cond_exit_606:                                    ; preds = %cond_629_case_1, %__barray_mask_borrow.exit656, %__barray_check_bounds.exit651
  %111 = icmp ult i64 %"603_0.0705", 19
  br i1 %111, label %__barray_check_bounds.exit651, label %cond_606_case_0

loop_out282:                                      ; preds = %cond_606_case_0
  tail call void @heap_free(i8* %88)
  tail call void @heap_free(i8* nonnull %90)
  %112 = load i64, i64* %64, align 4
  %113 = and i64 %112, 1048575
  store i64 %113, i64* %64, align 4
  %114 = icmp eq i64 %113, 0
  br i1 %114, label %__barray_check_none_borrowed.exit661, label %mask_block_err.i660

__barray_check_none_borrowed.exit661:             ; preds = %loop_out282
  %115 = tail call i8* @heap_alloc(i64 20)
  %116 = tail call i8* @heap_alloc(i64 8)
...
cond_629_case_1:                                  ; preds = %__barray_mask_borrow.exit656
  %.fca.1.extract370 = extractvalue { i1, i64, i1 } %110, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract370)
  br label %cond_exit_606

118:                                              ; preds = %__barray_check_none_borrowed.exit661, %__hugr__.array.__read_bool.3.346.exit
  %storemerge693 = phi i64 [ 0, %__barray_check_none_borrowed.exit661 ], [ %123, %__hugr__.array.__read_bool.3.346.exit ]
  %119 = getelementptr inbounds { i1, i64, i1 }, { i1, i64, i1 }* %62, i64 %storemerge693
  %120 = load { i1, i64, i1 }, { i1, i64, i1 }* %119, align 4
  %.fca.0.extract.i662 = extractvalue { i1, i64, i1 } %120, 0
  %.fca.1.extract.i663 = extractvalue { i1, i64, i1 } %120, 1
  br i1 %.fca.0.extract.i662, label %cond_358_case_1.i, label %cond_358_case_0.i

cond_358_case_0.i:                                ; preds = %118
  %.fca.2.extract.i = extractvalue { i1, i64, i1 } %120, 2
  br label %__hugr__.array.__read_bool.3.346.exit

cond_358_case_1.i:                                ; preds = %118
...
__hugr__.array.__read_bool.3.346.exit:            ; preds = %cond_358_case_0.i, %cond_358_case_1.i
  ...
  %121 = getelementptr inbounds i8, i8* %115, i64 %storemerge693
  %122 = bitcast i8* %121 to i1*
  store i1 %"03.0.i", i1* %122, align 1
  %123 = add nuw nsw i64 %storemerge693, 1
  %exitcond703.not = icmp eq i64 %123, 20
  br i1 %exitcond703.not, label %mask_block_ok.i666, label %118
...
mask_block_ok.i666:                               ; preds = %__hugr__.array.__read_bool.3.346.exit
  ...
  %124 = load i64, i64* %117, align 4
  %125 = and i64 %124, 1048575
  store i64 %125, i64* %117, align 4
  %126 = icmp eq i64 %125, 0
  br i1 %126, label %__barray_check_none_borrowed.exit668, label %mask_block_err.i667
...
__barray_check_none_borrowed.exit668:             ; preds = %mask_block_ok.i666
  ...
  %127 = alloca [20 x i1], align 1
  %.sub = getelementptr inbounds [20 x i1], [20 x i1]* %127, i64 0, i64 0
  %128 = bitcast [20 x i1]* %127 to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(20) %128, i8 0, i64 20, i1 false)
  store i32 20, i32* %x_ptr, align 8
  store i32 1, i32* %y_ptr, align 4
  %129 = bitcast i1** %arr_ptr to i8**
  store i8* %115, i8** %129, align 8
