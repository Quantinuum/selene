...
loop_body.preheader.i.i:                          ; preds = %loop_body.i457
  %"661_1.sroa.10.0.i.i" = extractvalue { ptr, ptr, i64 } %111, 2
  %"661_1.sroa.5.0.i.i" = extractvalue { ptr, ptr, i64 } %111, 1
  %"661_1.sroa.0.0.i.i" = extractvalue { ptr, ptr, i64 } %111, 0
...
cond_664_case_0.i.i:                              ; preds = %cond_exit_664.thread.i.i
  %70 = lshr i64 %"661_1.sroa.10.0.i.i", 6
  %71 = getelementptr i64, ptr %"661_1.sroa.5.0.i.i", i64 %70
  %72 = load i64, ptr %71, align 4
  %73 = and i64 %"661_1.sroa.10.0.i.i", 63
  ...
  %last_valid.i.i.i459 = add i64 %"661_1.sroa.10.0.i.i", 19
  %79 = lshr i64 %last_valid.i.i.i459, 6
  %80 = getelementptr inbounds nuw i64, ptr %"661_1.sroa.5.0.i.i", i64 %79
...
mask_block_ok.i.i.i462:                           ; preds = %cond_664_case_0.i.i, %87
  %.02.i.i.i463 = phi i64 [ %88, %87 ], [ 0, %cond_664_case_0.i.i ]
...
__barray_check_bounds.exit224.i.i:                ; preds = %cond_exit_664.thread.i.i, %loop_body.preheader.i.i
  %"661_0.0239.i.i" = phi i64 [ 0, %loop_body.preheader.i.i ], [ %91, %cond_exit_664.thread.i.i ]
  %91 = add nuw nsw i64 %"661_0.0239.i.i", 1
  %92 = add i64 %"661_0.0239.i.i", %"661_1.sroa.10.0.i.i"
  %93 = lshr i64 %92, 6
  %94 = getelementptr inbounds nuw i64, ptr %"661_1.sroa.5.0.i.i", i64 %93
  %95 = load i64, ptr %94, align 4
  %96 = and i64 %92, 63
  %97 = lshr i64 %95, %96
  %98 = trunc i64 %97 to i1
  br i1 %98, label %cond_exit_664.thread.i.i, label %__barray_mask_borrow.exit228.i.i

__barray_mask_borrow.exit228.i.i:                 ; preds = %__barray_check_bounds.exit224.i.i
  %99 = shl nuw i64 1, %96
  %100 = xor i64 %99, %95
  store i64 %100, ptr %94, align 4
  %101 = getelementptr inbounds i64, ptr %"661_1.sroa.0.0.i.i", i64 %92
  %102 = load i64, ptr %101, align 4
  tail call void @___dec_future_refcount(i64 %102)
  br label %cond_exit_664.thread.i.i

cond_exit_664.thread.i.i:                         ; preds = %__barray_mask_borrow.exit228.i.i, %__barray_check_bounds.exit224.i.i
  %exitcond.i.i = icmp eq i64 %91, 20
  br i1 %exitcond.i.i, label %cond_664_case_0.i.i, label %__barray_check_bounds.exit224.i.i
...
"__hugr__.guppylang.std.quantum.collect_measurements$20.329.exit": ; preds = %87, %cond_664_case_0.i.i
  tail call void @heap_free(ptr %"661_1.sroa.0.0.i.i")
  tail call void @heap_free(ptr nonnull %"661_1.sroa.5.0.i.i")
...
cond_21_case_1:                                   ; preds = %__hugr__.__tk2_helios_qalloc.553.exit, %cond_exit_21
  %"16_0.sroa.0.0517" = phi i64 [ 0, %__hugr__.__tk2_helios_qalloc.553.exit ], [ %121, %cond_exit_21 ]
  %121 = add nuw nsw i64 %"16_0.sroa.0.0517", 1
  %qalloc.i479 = tail call i64 @___qalloc()
  %not_max.not.not.i480 = icmp eq i64 %qalloc.i479, -1
  br i1 %not_max.not.not.i480, label %cond_641_case_0.i, label %__barray_check_bounds.exit

cond_641_case_0.i:                                ; preds = %cond_21_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable
...
__barray_mask_borrow.exit:                        ; preds = %loop_out
  ...
  tail call void @___rxy(i64 %131, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %131, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %131, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %131, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit495:                    ; preds = %__barray_mask_borrow.exit487
  ...
  tail call void @___rxy(i64 %148, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %142, i64 %148, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %142, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %148, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %148, double 0xBFF921FB54442D18)
