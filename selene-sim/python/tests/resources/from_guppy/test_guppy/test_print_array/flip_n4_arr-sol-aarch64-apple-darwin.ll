...
panic.i:                                          ; preds = %__barray_check_bounds.exit.9, %__hugr__.__tk2_sol_qalloc.553.exit.8, %__hugr__.__tk2_sol_qalloc.553.exit.7, %__hugr__.__tk2_sol_qalloc.553.exit.6, %__hugr__.__tk2_sol_qalloc.553.exit.5, %__hugr__.__tk2_sol_qalloc.553.exit.4, %__hugr__.__tk2_sol_qalloc.553.exit.3, %__hugr__.__tk2_sol_qalloc.553.exit.2, %__hugr__.__tk2_sol_qalloc.553.exit.1, %__hugr__.__tk2_sol_qalloc.553.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_12:                                     ; preds = %__hugr__.__tk2_sol_qalloc.553.exit
  %12 = and i64 %10, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.1

__hugr__.__tk2_sol_qalloc.553.exit.1:             ; preds = %cond_exit_12
...
cond_exit_12.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.1
  %15 = and i64 %13, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.2

__hugr__.__tk2_sol_qalloc.553.exit.2:             ; preds = %cond_exit_12.1
...
cond_exit_12.2:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.2
  %19 = and i64 %17, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.3

__hugr__.__tk2_sol_qalloc.553.exit.3:             ; preds = %cond_exit_12.2
...
cond_exit_12.3:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.3
  %23 = and i64 %21, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.4

__hugr__.__tk2_sol_qalloc.553.exit.4:             ; preds = %cond_exit_12.3
...
cond_exit_12.4:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.4
  %27 = and i64 %25, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.5

__hugr__.__tk2_sol_qalloc.553.exit.5:             ; preds = %cond_exit_12.4
...
cond_exit_12.5:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.5
  %31 = and i64 %29, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.6

__hugr__.__tk2_sol_qalloc.553.exit.6:             ; preds = %cond_exit_12.5
...
cond_exit_12.6:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.6
  %35 = and i64 %33, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.7

__hugr__.__tk2_sol_qalloc.553.exit.7:             ; preds = %cond_exit_12.6
...
cond_exit_12.7:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.7
  %39 = and i64 %37, -129
  ...
  br i1 %not_max.not.not.i.8, label %cond_557_case_0.i, label %__hugr__.__tk2_sol_qalloc.553.exit.8

__hugr__.__tk2_sol_qalloc.553.exit.8:             ; preds = %cond_exit_12.7
...
cond_exit_12.8:                                   ; preds = %__hugr__.__tk2_sol_qalloc.553.exit.8
  %43 = and i64 %41, -257
...
__barray_mask_borrow.exit1604:                    ; preds = %__barray_mask_return.exit1602
  ...
  tail call void @___rp(i64 %59, double 0x400921FB54442D18, double 0.000000e+00)
...
__barray_mask_borrow.exit1612:                    ; preds = %__barray_mask_return.exit1610
  ...
  tail call void @___rp(i64 %73, double 0x400921FB54442D18, double 0.000000e+00)
