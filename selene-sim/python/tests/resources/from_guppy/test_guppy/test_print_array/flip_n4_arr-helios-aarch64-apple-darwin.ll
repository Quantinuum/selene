...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit
...
__hugr__.__tk2_helios_qalloc.488.exit:            ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %8 = load i64, ptr %7, align 4
  %9 = trunc i64 %8 to i1
  br i1 %9, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.9, %__hugr__.__tk2_helios_qalloc.488.exit.8, %__hugr__.__tk2_helios_qalloc.488.exit.7, %__hugr__.__tk2_helios_qalloc.488.exit.6, %__hugr__.__tk2_helios_qalloc.488.exit.5, %__hugr__.__tk2_helios_qalloc.488.exit.4, %__hugr__.__tk2_helios_qalloc.488.exit.3, %__hugr__.__tk2_helios_qalloc.488.exit.2, %__hugr__.__tk2_helios_qalloc.488.exit.1, %__hugr__.__tk2_helios_qalloc.488.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_helios_qalloc.488.exit
  %10 = and i64 %8, -2
  store i64 %10, ptr %7, align 4
  store i64 %qalloc.i, ptr %6, align 4
  %qalloc.i.1 = tail call i64 @___qalloc()
  %not_max.not.not.i.1 = icmp eq i64 %qalloc.i.1, -1
  br i1 %not_max.not.not.i.1, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.1

__hugr__.__tk2_helios_qalloc.488.exit.1:          ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.1
  %13 = and i64 %11, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.2

__hugr__.__tk2_helios_qalloc.488.exit.2:          ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.2
  %17 = and i64 %15, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.3

__hugr__.__tk2_helios_qalloc.488.exit.3:          ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.3
  %21 = and i64 %19, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.4

__hugr__.__tk2_helios_qalloc.488.exit.4:          ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.4
  %25 = and i64 %23, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.5

__hugr__.__tk2_helios_qalloc.488.exit.5:          ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.5
  %29 = and i64 %27, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.6

__hugr__.__tk2_helios_qalloc.488.exit.6:          ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.6
  %33 = and i64 %31, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.7

__hugr__.__tk2_helios_qalloc.488.exit.7:          ; preds = %cond_exit_20.6
...
cond_exit_20.7:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.7
  %37 = and i64 %35, -129
  ...
  br i1 %not_max.not.not.i.8, label %cond_515_case_0.i, label %__hugr__.__tk2_helios_qalloc.488.exit.8

__hugr__.__tk2_helios_qalloc.488.exit.8:          ; preds = %cond_exit_20.7
...
cond_exit_20.8:                                   ; preds = %__hugr__.__tk2_helios_qalloc.488.exit.8
  %41 = and i64 %39, -257
...
__barray_mask_borrow.exit:                        ; preds = %cond_exit_20.9
  ...
  tail call void @___rxy(i64 %50, double 0x400921FB54442D18, double 0.000000e+00)
...
__barray_mask_borrow.exit823:                     ; preds = %__barray_mask_return.exit821
  ...
  tail call void @___rxy(i64 %57, double 0x400921FB54442D18, double 0.000000e+00)
...
__barray_mask_borrow.exit831:                     ; preds = %__barray_mask_return.exit829
  ...
  tail call void @___rxy(i64 %71, double 0x400921FB54442D18, double 0.000000e+00)
