...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit
...
__hugr__.__tk2_sol_qalloc.498.exit:               ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %6 = load i64, ptr %5, align 4
  %7 = trunc i64 %6 to i1
  br i1 %7, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.9, %__hugr__.__tk2_sol_qalloc.498.exit.8, %__hugr__.__tk2_sol_qalloc.498.exit.7, %__hugr__.__tk2_sol_qalloc.498.exit.6, %__hugr__.__tk2_sol_qalloc.498.exit.5, %__hugr__.__tk2_sol_qalloc.498.exit.4, %__hugr__.__tk2_sol_qalloc.498.exit.3, %__hugr__.__tk2_sol_qalloc.498.exit.2, %__hugr__.__tk2_sol_qalloc.498.exit.1, %__hugr__.__tk2_sol_qalloc.498.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_sol_qalloc.498.exit
  %8 = and i64 %6, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.1

__hugr__.__tk2_sol_qalloc.498.exit.1:             ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.1
  %11 = and i64 %9, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.2

__hugr__.__tk2_sol_qalloc.498.exit.2:             ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.2
  %15 = and i64 %13, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.3

__hugr__.__tk2_sol_qalloc.498.exit.3:             ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.3
  %19 = and i64 %17, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.4

__hugr__.__tk2_sol_qalloc.498.exit.4:             ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.4
  %23 = and i64 %21, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.5

__hugr__.__tk2_sol_qalloc.498.exit.5:             ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.5
  %27 = and i64 %25, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.6

__hugr__.__tk2_sol_qalloc.498.exit.6:             ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.6
  %31 = and i64 %29, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.7

__hugr__.__tk2_sol_qalloc.498.exit.7:             ; preds = %cond_exit_20.6
...
cond_exit_20.7:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.7
  %35 = and i64 %33, -129
  ...
  br i1 %not_max.not.not.i.8, label %cond_525_case_0.i, label %__hugr__.__tk2_sol_qalloc.498.exit.8

__hugr__.__tk2_sol_qalloc.498.exit.8:             ; preds = %cond_exit_20.7
...
cond_exit_20.8:                                   ; preds = %__hugr__.__tk2_sol_qalloc.498.exit.8
  %39 = and i64 %37, -257
