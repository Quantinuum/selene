...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_250_case_0.i, label %__hugr__.__tk2_helios_qalloc.246.exit

cond_250_case_0.i:                                ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.246.exit:            ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i296, label %cond_264_case_0.i, label %__hugr__.__tk2_helios_qalloc.260.exit

cond_264_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.246.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.260.exit:            ; preds = %__hugr__.__tk2_helios_qalloc.246.exit
  tail call void @___reset(i64 %qalloc.i295)
  %qalloc.i297 = tail call i64 @___qalloc()
  %not_max.not.not.i298 = icmp eq i64 %qalloc.i297, -1
  br i1 %not_max.not.not.i298, label %cond_278_case_0.i, label %__hugr__.__tk2_helios_qalloc.274.exit

cond_278_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.260.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.274.exit:            ; preds = %__hugr__.__tk2_helios_qalloc.260.exit
  tail call void @___reset(i64 %qalloc.i297)
  %qalloc.i299 = tail call i64 @___qalloc()
  %not_max.not.not.i300 = icmp eq i64 %qalloc.i299, -1
  br i1 %not_max.not.not.i300, label %cond_292_case_0.i, label %__hugr__.__tk2_helios_qalloc.288.exit

cond_292_case_0.i:                                ; preds = %__hugr__.__tk2_helios_qalloc.274.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.288.exit:            ; preds = %__hugr__.__tk2_helios_qalloc.274.exit
...
0:                                                ; preds = %__hugr__.__tk2_helios_qalloc.288.exit
  tail call void @___rxy(i64 %qalloc.i299, double 0x400921FB54442D18, double 0.000000e+00)
  tail call void @___rxy(i64 %qalloc.i295, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i295, i64 %qalloc.i297, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i295, double 0xBFF921FB54442D18)
  br label %2

1:                                                ; preds = %__hugr__.__tk2_helios_qalloc.288.exit
  tail call void @___rz(i64 %qalloc.i299, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i295, double 0x400921FB54442D18, double 0.000000e+00)
  tail call void @___rxy(i64 %qalloc.i297, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i295, i64 %qalloc.i297, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i295, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i297, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  br label %2
