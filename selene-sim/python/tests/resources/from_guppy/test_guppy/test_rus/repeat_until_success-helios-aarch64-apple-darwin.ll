...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_87_case_0.i, label %__hugr__.__tk2_helios_qalloc.83.exit

cond_87_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.83.exit:             ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %qalloc.i97.i = tail call i64 @___qalloc()
  %not_max.not.not.i98.i = icmp eq i64 %qalloc.i97.i, -1
  br i1 %not_max.not.not.i98.i, label %cond_101_case_0.i.i, label %__hugr__.__tk2_helios_qalloc.97.exit.i

cond_101_case_0.i.i:                              ; preds = %.backedge.i, %__hugr__.__tk2_helios_qalloc.83.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.97.exit.i:           ; preds = %__hugr__.__tk2_helios_qalloc.83.exit, %.backedge.i
  %qalloc.i99.i = phi i64 [ %qalloc.i.i, %.backedge.i ], [ %qalloc.i97.i, %__hugr__.__tk2_helios_qalloc.83.exit ]
  ...
  br i1 %not_max.not.not.i94.i, label %cond_115_case_0.i.i, label %__hugr__.__tk2_helios_qalloc.111.exit.i

cond_115_case_0.i.i:                              ; preds = %__hugr__.__tk2_helios_qalloc.97.exit.i
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.111.exit.i:          ; preds = %__hugr__.__tk2_helios_qalloc.97.exit.i
  tail call void @___reset(i64 %qalloc.i93.i)
  tail call void @___rxy(i64 %qalloc.i93.i, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i93.i, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i99.i, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  ...
  tail call void @___rxy(i64 %qalloc.i99.i, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i93.i, i64 %qalloc.i99.i, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i93.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i99.i, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i99.i, double 0xBFF921FB54442D18)
...
0:                                                ; preds = %__hugr__.__tk2_helios_qalloc.111.exit.i
...
.backedge.i:                                      ; preds = %2, %0
  ...
  br i1 %not_max.not.not.i.i, label %cond_101_case_0.i.i, label %__hugr__.__tk2_helios_qalloc.97.exit.i

1:                                                ; preds = %__hugr__.__tk2_helios_qalloc.111.exit.i
  tail call void @___rz(i64 %qalloc.i, double 0x3FE921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i93.i, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i93.i, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i93.i, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  tail call void @___rz(i64 %qalloc.i93.i, double 0xBFF921FB54442D18)
