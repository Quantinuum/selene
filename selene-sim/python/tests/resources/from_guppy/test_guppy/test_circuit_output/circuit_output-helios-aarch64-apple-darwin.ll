...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_56_case_0.i, label %__hugr__.__tk2_helios_qalloc.52.exit

cond_56_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.52.exit:             ; preds = %alloca_block
...
0:                                                ; preds = %__hugr__.__tk2_helios_qalloc.52.exit
  %qalloc.i44 = tail call i64 @___qalloc()
  %not_max.not.not.i45 = icmp eq i64 %qalloc.i44, -1
  br i1 %not_max.not.not.i45, label %cond_56_case_0.i46, label %__hugr__.__tk2_helios_qalloc.52.exit47

cond_56_case_0.i46:                               ; preds = %0
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.52.exit47:           ; preds = %0
...
1:                                                ; preds = %__hugr__.__tk2_helios_qalloc.52.exit47
  %qalloc.i48 = tail call i64 @___qalloc()
  %not_max.not.not.i49 = icmp eq i64 %qalloc.i48, -1
  br i1 %not_max.not.not.i49, label %cond_56_case_0.i50, label %__hugr__.__tk2_helios_qalloc.52.exit51

cond_56_case_0.i50:                               ; preds = %1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.52.exit51:           ; preds = %1
...
2:                                                ; preds = %__hugr__.__tk2_helios_qalloc.52.exit51, %__hugr__.__tk2_helios_qalloc.52.exit47, %__hugr__.__tk2_helios_qalloc.52.exit
  ret void
}
