...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_19_case_0.i, label %__hugr__.__tk2_helios_qalloc.15.exit

cond_19_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.15.exit:             ; preds = %alloca_block
