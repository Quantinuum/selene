...
cond_397_case_1.i:                                ; preds = %2, %1
  ...
  br i1 %read_bool73.i, label %cond_411_case_1.i, label %cond_exit_79.i

1:                                                ; preds = %__hugr__.__tk2_qalloc.295.exit.i
  tail call void @___rxy(i64 %qalloc.i489.i, double 0x400921FB54442D18, double 0.000000e+00)
  tail call void @___rxy(i64 %qalloc.i485.i, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i485.i, i64 %qalloc.i487.i, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i485.i, double 0xBFF921FB54442D18)
  br label %cond_397_case_1.i

2:                                                ; preds = %__hugr__.__tk2_qalloc.295.exit.i
  tail call void @___rz(i64 %qalloc.i489.i, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i485.i, double 0x400921FB54442D18, double 0.000000e+00)
  tail call void @___rxy(i64 %qalloc.i487.i, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i485.i, i64 %qalloc.i487.i, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i485.i, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i487.i, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  br label %cond_397_case_1.i

cond_exit_79.i:                                   ; preds = %cond_397_case_1.i
...
cond_411_case_1.i:                                ; preds = %cond_397_case_1.i
...
__hugr__.__main__.main.1.exit:                    ; preds = %cond_exit_79.i, %cond_411_case_1.i
