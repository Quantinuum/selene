...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_277_case_0.i, label %__hugr__.__tk2_helios_qalloc.273.exit

cond_277_case_0.i:                                ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.273.exit:            ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i378, label %cond_277_case_0.i379, label %__hugr__.__tk2_helios_qalloc.273.exit380

cond_277_case_0.i379:                             ; preds = %__hugr__.__tk2_helios_qalloc.273.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.273.exit380:         ; preds = %__hugr__.__tk2_helios_qalloc.273.exit
  tail call void @___reset(i64 %qalloc.i377)
  %qalloc.i381 = tail call i64 @___qalloc()
  %not_max.not.not.i382 = icmp eq i64 %qalloc.i381, -1
  br i1 %not_max.not.not.i382, label %cond_277_case_0.i383, label %__hugr__.__tk2_helios_qalloc.273.exit384

cond_277_case_0.i383:                             ; preds = %__hugr__.__tk2_helios_qalloc.273.exit380
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.273.exit384:         ; preds = %__hugr__.__tk2_helios_qalloc.273.exit380
  tail call void @___reset(i64 %qalloc.i381)
  %qalloc.i385 = tail call i64 @___qalloc()
  %not_max.not.not.i386 = icmp eq i64 %qalloc.i385, -1
  br i1 %not_max.not.not.i386, label %cond_277_case_0.i387, label %__hugr__.__tk2_helios_qalloc.273.exit388

cond_277_case_0.i387:                             ; preds = %__hugr__.__tk2_helios_qalloc.273.exit384
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable
...
0:                                                ; preds = %__hugr__.__tk2_helios_qalloc.273.exit388
  tail call void @___rxy(i64 %qalloc.i385, double 0x400921FB54442D18, double 0.000000e+00)
  tail call void @___rxy(i64 %qalloc.i377, double 0x400921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i377, i64 %qalloc.i381, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i377, double 0xBFF921FB54442D18)
  br label %2

1:                                                ; preds = %__hugr__.__tk2_helios_qalloc.273.exit388
  tail call void @___rz(i64 %qalloc.i385, double 0x400921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i377, double 0x400921FB54442D18, double 0.000000e+00)
  tail call void @___rxy(i64 %qalloc.i381, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rzz(i64 %qalloc.i377, i64 %qalloc.i381, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %qalloc.i377, double 0xBFF921FB54442D18)
  tail call void @___rxy(i64 %qalloc.i381, double 0x3FF921FB54442D18, double 0x400921FB54442D18)
  br label %2
