...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_361_case_0.i, label %__hugr__.__tk2_sol_qalloc.357.exit

cond_361_case_0.i:                                ; preds = %cond_exit_12.1, %cond_exit_12, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.357.exit:               ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %6 = load i64, ptr %5, align 4
  %7 = trunc i64 %6 to i1
  br i1 %7, label %cond_exit_12, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.2, %__hugr__.__tk2_sol_qalloc.357.exit.1, %__hugr__.__tk2_sol_qalloc.357.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_12:                                     ; preds = %__hugr__.__tk2_sol_qalloc.357.exit
  %8 = and i64 %6, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_361_case_0.i, label %__hugr__.__tk2_sol_qalloc.357.exit.1

__hugr__.__tk2_sol_qalloc.357.exit.1:             ; preds = %cond_exit_12
...
cond_exit_12.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.357.exit.1
  %11 = and i64 %9, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_361_case_0.i, label %__barray_check_bounds.exit.2
...
__barray_mask_borrow.exit:                        ; preds = %cond_exit_12.2
  ...
  tail call void @___rp(i64 %20, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_mask_borrow.exit837:                     ; preds = %__barray_mask_borrow.exit835
  ...
  tail call void @___rp(i64 %27, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %27, double 0xC002D97C7F3321D2)
  tail call void @___rp(i64 %24, double 0x3FF921FB54442D18, double 0xC002D97C7F3321D2)
  tail call void @___rz(i64 %24, double 0xC002D97C7F3321D2)
  tail call void @___rp(i64 %20, double 0x3FF921FB54442D18, double 0xC002D97C7F3321D2)
  tail call void @___rz(i64 %20, double 0xC002D97C7F3321D2)
  tail call void @___rpp(i64 %20, i64 %27, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %27, double 0x3FE921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %27, double 0x3FF921FB54442D18)
  tail call void @___rp(i64 %20, double 0xBFF921FB54442D18, double 0.000000e+00)
  tail call void @___rpp(i64 %20, i64 %24, double 0xBFE921FB54442D18, double 0.000000e+00)
  tail call void @___rpp(i64 %24, i64 %27, double 0x3FE921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %27, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %27, double 0x400921FB54442D18)
  tail call void @___rpp(i64 %20, i64 %27, double 0x3FF921FB54442D18, double 0.000000e+00)
  tail call void @___rp(i64 %27, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %27, double 0x3FF921FB54442D18)
  tail call void @___rpp(i64 %24, i64 %27, double 0xBFE921FB54442D18, double 0.000000e+00)
  ...
  tail call void @___rp(i64 %20, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rz(i64 %20, double 0x3FF921FB54442D18)
...
.thread:                                          ; preds = %__barray_mask_return.exit843
  ...
  %___future_measure = tail call i64 @___future_measure(i64 %40, i64 0)
...
.thread.1:                                        ; preds = %cond_exit_137
  ...
  %___future_measure.1 = tail call i64 @___future_measure(i64 %48, i64 0)
...
cond_exit_137.1:                                  ; preds = %.thread.1
  ...
  store i64 %___future_measure.1, ptr %52, align 4
...
.thread.2:                                        ; preds = %cond_exit_137.1
  ...
  %___future_measure.2 = tail call i64 @___future_measure(i64 %57, i64 0)
...
cond_exit_137.2:                                  ; preds = %.thread.2
  ...
  store i64 %___future_measure.2, ptr %61, align 4
...
mask_block_err.i867:                              ; preds = %cond_exit_407.2
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable
...
__barray_mask_borrow.exit875:                     ; preds = %cond_exit_203.2
  ...
  br label %cond_exit_407

cond_exit_407:                                    ; preds = %__barray_mask_borrow.exit875, %cond_exit_203.2
  %76 = load i64, ptr %3, align 4
  %77 = and i64 %76, 2
  %.not920 = icmp eq i64 %77, 0
  br i1 %.not920, label %__barray_mask_borrow.exit875.1, label %cond_exit_407.1

__barray_mask_borrow.exit875.1:                   ; preds = %cond_exit_407
  %78 = or disjoint i64 %76, 2
  store i64 %78, ptr %3, align 4
  %79 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %80 = load i64, ptr %79, align 4
  tail call void @___dec_future_refcount(i64 %80)
  br label %cond_exit_407.1

cond_exit_407.1:                                  ; preds = %__barray_mask_borrow.exit875.1, %cond_exit_407
  %81 = load i64, ptr %3, align 4
  %82 = and i64 %81, 4
  %.not921 = icmp eq i64 %82, 0
  br i1 %.not921, label %__barray_mask_borrow.exit875.2, label %cond_exit_407.2

__barray_mask_borrow.exit875.2:                   ; preds = %cond_exit_407.1
  %83 = or disjoint i64 %81, 4
  store i64 %83, ptr %3, align 4
  %84 = getelementptr inbounds nuw i8, ptr %2, i64 16
  %85 = load i64, ptr %84, align 4
  tail call void @___dec_future_refcount(i64 %85)
  br label %cond_exit_407.2

cond_exit_407.2:                                  ; preds = %__barray_mask_borrow.exit875.2, %cond_exit_407.1
...
cond_exit_203.2:                                  ; preds = %__barray_check_bounds.exit861.2
  ...
  br i1 %115, label %cond_exit_407, label %__barray_mask_borrow.exit875

loop_out295:                                      ; preds = %cond_exit_407.2
