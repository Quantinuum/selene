...
cond_13_case_1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.485.exit, %cond_exit_13
  %"9_2.01321" = phi i64 [ 0, %__hugr__.__tk2_sol_qalloc.485.exit ], [ %6, %cond_exit_13 ]
...
mask_block_err.i1292:                             ; preds = %cond_565_case_0
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable

__barray_check_bounds.exit1296:                   ; preds = %cond_exit_380, %cond_exit_565
  %"562_0.01331" = phi i64 [ %84, %cond_exit_565 ], [ 0, %cond_exit_380 ]
  %84 = add nuw nsw i64 %"562_0.01331", 1
  %85 = load i64, ptr %3, align 4
  %86 = lshr i64 %85, %"562_0.01331"
  %87 = trunc i64 %86 to i1
  br i1 %87, label %cond_exit_565, label %__barray_mask_borrow.exit1300

__barray_mask_borrow.exit1300:                    ; preds = %__barray_check_bounds.exit1296
  %88 = shl nuw nsw i64 1, %"562_0.01331"
  %89 = xor i64 %85, %88
  store i64 %89, ptr %3, align 4
  %90 = getelementptr inbounds nuw i64, ptr %2, i64 %"562_0.01331"
  %91 = load i64, ptr %90, align 4
  tail call void @___dec_future_refcount(i64 %91)
  br label %cond_exit_565

cond_exit_565:                                    ; preds = %__barray_mask_borrow.exit1300, %__barray_check_bounds.exit1296
  %92 = icmp samesign ugt i64 %"562_0.01331", 18
  br i1 %92, label %cond_565_case_0, label %__barray_check_bounds.exit1296
...
loop_out537:                                      ; preds = %cond_565_case_0
