...
entry:
  ...
  br i1 %not_max.not.not.i.i, label %cond_45_case_0.i.i, label %__hugr__.__tk2_qalloc.41.exit.i

cond_45_case_0.i.i:                               ; preds = %entry
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.41.exit.i:                  ; preds = %entry
...
1:                                                ; preds = %__hugr__.__tk2_qalloc.41.exit.i
  tail call void @panic(i32 42, ptr nonnull @s_Postselect.13DF1CD0.0)
  unreachable

__hugr__.__main__.main.1.exit:                    ; preds = %__hugr__.__tk2_qalloc.41.exit.i
  %read_bool66.i = tail call i1 @___read_future_bool(i64 %lazy_measure.i)
  tail call void @___dec_future_refcount(i64 %lazy_measure.i)
  tail call void @print_bool(ptr nonnull @res_c.1C9EF4D1.0, i64 11, i1 %read_bool66.i)
