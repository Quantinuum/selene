...
__hugr__.__tk2_qalloc.65.exit:                    ; preds = %__hugr__.__tk2_qalloc.51.exit
  ...
  tail call void @___rp(i64 %qalloc.i, double 0x40316444CB580C0B, double 0x3FF921FB54442D18)
  tail call void @___rp(i64 %qalloc.i177, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rp(i64 %qalloc.i, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rpp(i64 %qalloc.i, i64 %qalloc.i177, double 0x3FF921FB54442D18, double 0xC00921FB54442D18)
  tail call void @___rp(i64 %qalloc.i177, double 0x3FF921FB54442D18, double 0x3FF921FB54442D18)
...
__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_qalloc.65.exit
  ...
  br i1 %.fca.0.extract118.i, label %cond_144_case_1.i, label %cond_144_case_0.i

mask_block_err.i:                                 ; preds = %__hugr__.__tk2_qalloc.65.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

cond_144_case_0.i:                                ; preds = %__barray_check_none_borrowed.exit
  %.fca.2.extract120.i = extractvalue { i1, i64, i1 } %10, 2
  br label %cond_exit_144.i

cond_144_case_1.i:                                ; preds = %__barray_check_none_borrowed.exit
  %.fca.1.extract119.i = extractvalue { i1, i64, i1 } %10, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i)
  br label %cond_exit_144.i

cond_exit_144.i:                                  ; preds = %cond_144_case_1.i, %cond_144_case_0.i
  %"04.sroa.3.0.i" = phi i64 [ %.fca.1.extract119.i, %cond_144_case_1.i ], [ undef, %cond_144_case_0.i ]
  %"04.sroa.6.0.i" = phi i1 [ undef, %cond_144_case_1.i ], [ %.fca.2.extract120.i, %cond_144_case_0.i ]
  %11 = load i64, ptr %4, align 4
  %12 = trunc i64 %11 to i1
  br i1 %12, label %panic.i.i, label %cond_147_case_1.i

panic.i.i:                                        ; preds = %cond_exit_144.i.1, %cond_exit_144.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_147_case_1.i:                                ; preds = %cond_exit_144.i
  ...
  br i1 %.fca.2.0.extract.i, label %cond_148_case_1.i, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit"

cond_148_case_1.i:                                ; preds = %cond_147_case_1.i.1, %cond_147_case_1.i
  tail call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit": ; preds = %cond_147_case_1.i
  ...
  br i1 %.fca.0.extract118.i.1, label %cond_144_case_1.i.1, label %cond_144_case_0.i.1

cond_144_case_0.i.1:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit"
  %.fca.2.extract120.i.1 = extractvalue { i1, i64, i1 } %14, 2
  br label %cond_exit_144.i.1

cond_144_case_1.i.1:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit"
  %.fca.1.extract119.i.1 = extractvalue { i1, i64, i1 } %14, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i.1)
  br label %cond_exit_144.i.1

cond_exit_144.i.1:                                ; preds = %cond_144_case_0.i.1, %cond_144_case_1.i.1
  %"04.sroa.3.0.i.1" = phi i64 [ %.fca.1.extract119.i.1, %cond_144_case_1.i.1 ], [ undef, %cond_144_case_0.i.1 ]
  %"04.sroa.6.0.i.1" = phi i1 [ undef, %cond_144_case_1.i.1 ], [ %.fca.2.extract120.i.1, %cond_144_case_0.i.1 ]
  %15 = load i64, ptr %4, align 4
  %16 = and i64 %15, 2
  %.not = icmp eq i64 %16, 0
  br i1 %.not, label %cond_147_case_1.i.1, label %panic.i.i

cond_147_case_1.i.1:                              ; preds = %cond_exit_144.i.1
  ...
  br i1 %.fca.2.0.extract.i.1, label %cond_148_case_1.i, label %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit.1"

"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit.1": ; preds = %cond_147_case_1.i.1
...
__barray_check_none_borrowed.exit186:             ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit.1"
  ...
  %26 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).186"({ i1, { i1, i64, i1 } } %25)
  %27 = extractvalue { { i1, i64, i1 } } %26, 0
  store { i1, i64, i1 } %27, ptr %23, align 4
  %28 = load { i1, { i1, i64, i1 } }, ptr %18, align 4
  %29 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).186"({ i1, { i1, i64, i1 } } %28)
  ...
  br i1 %33, label %cond_exit_212, label %__barray_mask_borrow.exit

mask_block_err.i184:                              ; preds = %"__hugr__.$__copy_scan$$n(2)$t([Bool]+[Future(Bool)])$n(1).140.exit.1"
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i190:                              ; preds = %cond_exit_212.1
...
__barray_mask_borrow.exit:                        ; preds = %__barray_check_none_borrowed.exit186
  ...
  br i1 %.fca.0.extract112, label %cond_235_case_1, label %cond_exit_212

cond_exit_212:                                    ; preds = %cond_235_case_1, %__barray_mask_borrow.exit, %__barray_check_none_borrowed.exit186
  %36 = load i64, ptr %24, align 4
  %37 = and i64 %36, 2
  %.not214 = icmp eq i64 %37, 0
  br i1 %.not214, label %__barray_mask_borrow.exit.1, label %cond_exit_212.1

__barray_mask_borrow.exit.1:                      ; preds = %cond_exit_212
  ...
  br i1 %.fca.0.extract112.1, label %cond_235_case_1.1, label %cond_exit_212.1

cond_235_case_1.1:                                ; preds = %__barray_mask_borrow.exit.1
  %.fca.1.extract113.1 = extractvalue { i1, i64, i1 } %40, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract113.1)
  br label %cond_exit_212.1

cond_exit_212.1:                                  ; preds = %cond_235_case_1.1, %__barray_mask_borrow.exit.1, %cond_exit_212
...
loop_out:                                         ; preds = %cond_exit_212.1
...
alloca_block:
  ...
  br i1 %.fca.0.extract, label %cond_110_case_1, label %cond_110_case_0

cond_110_case_0:                                  ; preds = %alloca_block
  %.fca.2.extract = extractvalue { i1, i64, i1 } %0, 2
  br label %cond_exit_110

cond_110_case_1:                                  ; preds = %alloca_block
...
cond_exit_110:                                    ; preds = %cond_110_case_1, %cond_110_case_0
  %"03.0" = phi i1 [ %read_bool, %cond_110_case_1 ], [ %.fca.2.extract, %cond_110_case_0 ]
  ret i1 %"03.0"
}
...
define internal { i1, i64, i1 } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).186"({ i1, { i1, i64, i1 } } %0) unnamed_addr {
alloca_block:
  %.fca.0.extract11 = extractvalue { i1, { i1, i64, i1 } } %0, 0
  br i1 %.fca.0.extract11, label %cond_189_case_1, label %cond_189_case_0

cond_189_case_1:                                  ; preds = %alloca_block
  %1 = extractvalue { i1, { i1, i64, i1 } } %0, 1
  ret { i1, i64, i1 } %1

cond_189_case_0:                                  ; preds = %alloca_block
