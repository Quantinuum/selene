...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_51_case_0.i, label %__hugr__.__tk2_sol_qalloc.47.exit

cond_51_case_0.i:                                 ; preds = %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.47.exit:                ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %qalloc.i49 = tail call i64 @___qalloc()
  %not_max.not.not.i50 = icmp eq i64 %qalloc.i49, -1
  br i1 %not_max.not.not.i50, label %cond_65_case_0.i, label %__hugr__.__tk2_sol_qalloc.61.exit

cond_65_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.47.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.61.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.47.exit
  ...
  tail call void @___rp(i64 %qalloc.i49, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rp(i64 %qalloc.i, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  tail call void @___rpp(i64 %qalloc.i, i64 %qalloc.i49, double 0x3FF921FB54442D18, double 0xC00921FB54442D18)
  tail call void @___rp(i64 %qalloc.i49, double 0x3FF921FB54442D18, double 0x3FF921FB54442D18)
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.61.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.61.exit
