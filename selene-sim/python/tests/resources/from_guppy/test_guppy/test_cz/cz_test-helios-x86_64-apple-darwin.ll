...
__hugr__.__tk2_helios_qalloc.23.exit:             ; preds = %alloca_block
  ...
  tail call void @___rxy(i64 %qalloc.i, double 0x40134D1C84D7D5F9, double 0x3FF921FB54442D18)
  %qalloc.i44 = tail call i64 @___qalloc()
  %not_max.not.not.i45 = icmp eq i64 %qalloc.i44, -1
  br i1 %not_max.not.not.i45, label %cond_27_case_0.i46, label %__hugr__.__tk2_helios_qalloc.23.exit47

cond_27_case_0.i46:                               ; preds = %__hugr__.__tk2_helios_qalloc.23.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.23.exit47:           ; preds = %__hugr__.__tk2_helios_qalloc.23.exit
  tail call void @___reset(i64 %qalloc.i44)
  tail call void @___rzz(i64 %qalloc.i, i64 %qalloc.i44, double 0x3FF921FB54442D18)
  ...
  %___lazy_measure11 = tail call i64 @___lazy_measure(i64 %qalloc.i44)
  tail call void @___qfree(i64 %qalloc.i44)
  %read_bool = tail call i1 @___read_future_bool(i64 %___lazy_measure11)
  tail call void @___dec_future_refcount(i64 %___lazy_measure11)
  %read_bool14 = tail call i1 @___read_future_bool(i64 %___lazy_measure)
...
mask_block_err.i:                                 ; preds = %__hugr__.__tk2_helios_qalloc.23.exit47
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit:                ; preds = %__hugr__.__tk2_helios_qalloc.23.exit47
  ...
  %11 = icmp eq i64 %10, 0
  br i1 %11, label %__barray_check_none_borrowed.exit51, label %mask_block_err.i50

mask_block_err.i50:                               ; preds = %__barray_check_none_borrowed.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

__barray_check_none_borrowed.exit51:              ; preds = %__barray_check_none_borrowed.exit
  ...
  %.repack43 = getelementptr inbounds nuw i8, ptr %12, i64 1
  store i1 false, ptr %.repack43, align 1
