...
__hugr__.__tk2_sol_qalloc.36.exit:                ; preds = %alloca_block
  ...
  br i1 %not_max.not.not.i35, label %cond_54_case_0.i, label %__hugr__.__tk2_sol_qalloc.50.exit
...
__hugr__.__tk2_sol_qalloc.50.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.36.exit
  ...
  br i1 %not_max.not.not.i37, label %cond_68_case_0.i, label %__hugr__.__tk2_sol_qalloc.64.exit

cond_68_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.50.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.64.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.50.exit
  ...
  br i1 %not_max.not.not.i39, label %cond_82_case_0.i, label %__hugr__.__tk2_sol_qalloc.78.exit

cond_82_case_0.i:                                 ; preds = %__hugr__.__tk2_sol_qalloc.64.exit
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.78.exit:                ; preds = %__hugr__.__tk2_sol_qalloc.64.exit
  ...
  tail call void @___rp(i64 %qalloc.i38, double 0x400921FB54442D18, double 0.000000e+00)
