...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_575_case_0.i, label %__hugr__.__tk2_helios_qalloc.571.exit

cond_575_case_0.i:                                ; preds = %cond_exit_20.3, %cond_exit_20.2, %cond_exit_20.1, %cond_exit_20, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.571.exit:            ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %2 = load i64, ptr %1, align 4
  %3 = trunc i64 %2 to i1
  br i1 %3, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.4, %__hugr__.__tk2_helios_qalloc.571.exit.3, %__hugr__.__tk2_helios_qalloc.571.exit.2, %__hugr__.__tk2_helios_qalloc.571.exit.1, %__hugr__.__tk2_helios_qalloc.571.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_helios_qalloc.571.exit
  %4 = and i64 %2, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_575_case_0.i, label %__hugr__.__tk2_helios_qalloc.571.exit.1

__hugr__.__tk2_helios_qalloc.571.exit.1:          ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_helios_qalloc.571.exit.1
  %7 = and i64 %5, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_575_case_0.i, label %__hugr__.__tk2_helios_qalloc.571.exit.2

__hugr__.__tk2_helios_qalloc.571.exit.2:          ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_helios_qalloc.571.exit.2
  %11 = and i64 %9, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_575_case_0.i, label %__hugr__.__tk2_helios_qalloc.571.exit.3

__hugr__.__tk2_helios_qalloc.571.exit.3:          ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_helios_qalloc.571.exit.3
  %15 = and i64 %13, -9
...
__barray_check_bounds.exit711.1:                  ; preds = %__barray_mask_return.exit713
  ...
  tail call void @___rxy(i64 %31, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit711.2:                  ; preds = %__barray_mask_return.exit713.1
  ...
  tail call void @___rxy(i64 %38, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit711.3:                  ; preds = %__barray_mask_return.exit713.2
  ...
  tail call void @___rxy(i64 %45, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit711.4:                  ; preds = %__barray_check_bounds.exit708.4
  ...
  tail call void @___rxy(i64 %52, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
