...
.thread:                                          ; preds = %__barray_mask_return.exit1120.4
  ...
  %___future_measure = tail call i64 @___future_measure(i64 %66, i64 0)
...
cond_exit_298:                                    ; preds = %.thread
  ...
  store i64 %___future_measure, ptr %0, align 4
...
.thread.1:                                        ; preds = %cond_exit_298
  ...
  %___future_measure.1 = tail call i64 @___future_measure(i64 %73, i64 0)
...
cond_exit_298.1:                                  ; preds = %.thread.1
  ...
  store i64 %___future_measure.1, ptr %77, align 4
...
.thread.2:                                        ; preds = %cond_exit_298.1
  ...
  %___future_measure.2 = tail call i64 @___future_measure(i64 %81, i64 0)
...
cond_exit_298.2:                                  ; preds = %.thread.2
  ...
  store i64 %___future_measure.2, ptr %85, align 4
...
.thread.3:                                        ; preds = %cond_exit_298.2
  ...
  %___future_measure.3 = tail call i64 @___future_measure(i64 %89, i64 0)
...
__barray_check_bounds.exit1126.4:                 ; preds = %.thread.3
  ...
  store i64 %___future_measure.3, ptr %93, align 4
...
__barray_check_bounds.exit1122.4:                 ; preds = %__barray_check_bounds.exit1126.4
  ...
  %___future_measure.4 = tail call i64 @___future_measure(i64 %97, i64 0)
...
cond_exit_298.4:                                  ; preds = %__barray_check_bounds.exit1122.4
  ...
  store i64 %___future_measure.4, ptr %101, align 4
