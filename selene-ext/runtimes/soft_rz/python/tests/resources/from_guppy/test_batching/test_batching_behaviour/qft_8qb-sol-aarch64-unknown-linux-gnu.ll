...
cond_278_case_1:                                  ; preds = %loop_body
  ...
  br i1 %not_max.not.not.i, label %cond_631_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit

cond_631_case_0.i:                                ; preds = %cond_278_case_1
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.627.exit:               ; preds = %cond_278_case_1
  tail call void @___reset(i64 %qalloc.i)
  %9 = icmp ult i64 %"274_2.0", 8
  br i1 %9, label %__barray_check_bounds.exit, label %out_of_bounds.i

out_of_bounds.i:                                  ; preds = %__hugr__.__tk2_sol_qalloc.627.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Index out .DD115165.0")
  unreachable

__barray_check_bounds.exit:                       ; preds = %__hugr__.__tk2_sol_qalloc.627.exit
...
__barray_check_bounds.exit1605:                   ; preds = %done
  ...
  tail call void @___rp(i64 %42, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
  %54 = fmul double %reciprocal, 0x400921FB54442D18
  %55 = fmul double %54, 5.000000e-01
  %56 = fneg double %55
  tail call void @___rpp(i64 %42, i64 %49, double %56, double 0xC00921FB54442D18)
  tail call void @___rp(i64 %49, double 0x3FF921FB54442D18, double 0x3FF921FB54442D18)
  tail call void @___rz(i64 %49, double %55)
  tail call void @___rp(i64 %42, double 0x3FF921FB54442D18, double 0x3FF921FB54442D18)
...
.thread:                                          ; preds = %__barray_check_bounds.exit1617
  ...
  %___future_measure = tail call i64 @___future_measure(i64 %79, i64 0)
...
cond_exit_410:                                    ; preds = %__barray_check_bounds.exit1613
  ...
  store i64 %___future_measure, ptr %84, align 4
...
mask_block_err.i1635:                             ; preds = %cond_exit_677.7
  tail call void @panic(i32 1002, ptr nonnull @"e_Array cont.EFA5AC45.0")
  unreachable
...
__barray_mask_borrow.exit1643:                    ; preds = %__barray_check_bounds.exit1639.preheader
  ...
  br label %cond_exit_677

cond_exit_677:                                    ; preds = %__barray_mask_borrow.exit1643, %__barray_check_bounds.exit1639.preheader
  %103 = load i64, ptr %3, align 4
  %104 = and i64 %103, 2
  %.not = icmp eq i64 %104, 0
  br i1 %.not, label %__barray_mask_borrow.exit1643.1, label %cond_exit_677.1

__barray_mask_borrow.exit1643.1:                  ; preds = %cond_exit_677
  %105 = or disjoint i64 %103, 2
  store i64 %105, ptr %3, align 4
  %106 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %107 = load i64, ptr %106, align 4
  tail call void @___dec_future_refcount(i64 %107)
  br label %cond_exit_677.1

cond_exit_677.1:                                  ; preds = %__barray_mask_borrow.exit1643.1, %cond_exit_677
  %108 = load i64, ptr %3, align 4
  %109 = and i64 %108, 4
  %.not1687 = icmp eq i64 %109, 0
  br i1 %.not1687, label %__barray_mask_borrow.exit1643.2, label %cond_exit_677.2

__barray_mask_borrow.exit1643.2:                  ; preds = %cond_exit_677.1
  ...
  br label %cond_exit_677.2

cond_exit_677.2:                                  ; preds = %__barray_mask_borrow.exit1643.2, %cond_exit_677.1
  %113 = load i64, ptr %3, align 4
  %114 = and i64 %113, 8
  %.not1688 = icmp eq i64 %114, 0
  br i1 %.not1688, label %__barray_mask_borrow.exit1643.3, label %cond_exit_677.3

__barray_mask_borrow.exit1643.3:                  ; preds = %cond_exit_677.2
  ...
  br label %cond_exit_677.3

cond_exit_677.3:                                  ; preds = %__barray_mask_borrow.exit1643.3, %cond_exit_677.2
  %118 = load i64, ptr %3, align 4
  %119 = and i64 %118, 16
  %.not1689 = icmp eq i64 %119, 0
  br i1 %.not1689, label %__barray_mask_borrow.exit1643.4, label %cond_exit_677.4

__barray_mask_borrow.exit1643.4:                  ; preds = %cond_exit_677.3
  ...
  br label %cond_exit_677.4

cond_exit_677.4:                                  ; preds = %__barray_mask_borrow.exit1643.4, %cond_exit_677.3
  %123 = load i64, ptr %3, align 4
  %124 = and i64 %123, 32
  %.not1690 = icmp eq i64 %124, 0
  br i1 %.not1690, label %__barray_mask_borrow.exit1643.5, label %cond_exit_677.5

__barray_mask_borrow.exit1643.5:                  ; preds = %cond_exit_677.4
  ...
  br label %cond_exit_677.5

cond_exit_677.5:                                  ; preds = %__barray_mask_borrow.exit1643.5, %cond_exit_677.4
  %128 = load i64, ptr %3, align 4
  %129 = and i64 %128, 64
  %.not1691 = icmp eq i64 %129, 0
  br i1 %.not1691, label %__barray_mask_borrow.exit1643.6, label %cond_exit_677.6

__barray_mask_borrow.exit1643.6:                  ; preds = %cond_exit_677.5
  ...
  br label %cond_exit_677.6

cond_exit_677.6:                                  ; preds = %__barray_mask_borrow.exit1643.6, %cond_exit_677.5
  %133 = load i64, ptr %3, align 4
  %134 = and i64 %133, 128
  %.not1692 = icmp eq i64 %134, 0
  br i1 %.not1692, label %__barray_mask_borrow.exit1643.7, label %cond_exit_677.7

__barray_mask_borrow.exit1643.7:                  ; preds = %cond_exit_677.6
  ...
  br label %cond_exit_677.7

cond_exit_677.7:                                  ; preds = %__barray_mask_borrow.exit1643.7, %cond_exit_677.6
...
__barray_check_bounds.exit1639.preheader:         ; preds = %cond_exit_476
  ...
  br i1 %145, label %cond_exit_677, label %__barray_mask_borrow.exit1643

loop_out738:                                      ; preds = %cond_exit_677.7
