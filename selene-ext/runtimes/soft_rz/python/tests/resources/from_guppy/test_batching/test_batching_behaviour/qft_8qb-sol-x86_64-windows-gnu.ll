...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit
...
cond_654_case_0.i:                                ; preds = %cond_exit_20.6, %cond_exit_20.5, %cond_exit_20.4, %cond_exit_20.3, %cond_exit_20.2, %cond_exit_20.1, %cond_exit_20, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_sol_qalloc.627.exit:               ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %8 = load i64, ptr %1, align 4
  %9 = trunc i64 %8 to i1
  br i1 %9, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.7, %__hugr__.__tk2_sol_qalloc.627.exit.6, %__hugr__.__tk2_sol_qalloc.627.exit.5, %__hugr__.__tk2_sol_qalloc.627.exit.4, %__hugr__.__tk2_sol_qalloc.627.exit.3, %__hugr__.__tk2_sol_qalloc.627.exit.2, %__hugr__.__tk2_sol_qalloc.627.exit.1, %__hugr__.__tk2_sol_qalloc.627.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_sol_qalloc.627.exit
  %10 = and i64 %8, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit.1

__hugr__.__tk2_sol_qalloc.627.exit.1:             ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_sol_qalloc.627.exit.1
  %13 = and i64 %11, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit.2

__hugr__.__tk2_sol_qalloc.627.exit.2:             ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_sol_qalloc.627.exit.2
  %17 = and i64 %15, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit.3

__hugr__.__tk2_sol_qalloc.627.exit.3:             ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_sol_qalloc.627.exit.3
  %21 = and i64 %19, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit.4

__hugr__.__tk2_sol_qalloc.627.exit.4:             ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_sol_qalloc.627.exit.4
  %25 = and i64 %23, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit.5

__hugr__.__tk2_sol_qalloc.627.exit.5:             ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_sol_qalloc.627.exit.5
  %29 = and i64 %27, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_654_case_0.i, label %__hugr__.__tk2_sol_qalloc.627.exit.6

__hugr__.__tk2_sol_qalloc.627.exit.6:             ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_sol_qalloc.627.exit.6
  %33 = and i64 %31, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_654_case_0.i, label %__barray_check_bounds.exit.7
...
loop_body.preheader.i:                            ; preds = %loop_body128
  %"674_1.sroa.10.0.i" = extractvalue { ptr, ptr, i64 } %180, 2
  %"674_1.sroa.5.0.i" = extractvalue { ptr, ptr, i64 } %180, 1
  %"674_1.sroa.0.0.i" = extractvalue { ptr, ptr, i64 } %180, 0
  %51 = lshr i64 %"674_1.sroa.10.0.i", 6
  %52 = getelementptr i64, ptr %"674_1.sroa.5.0.i", i64 %51
  %53 = load i64, ptr %52, align 4
  %54 = and i64 %"674_1.sroa.10.0.i", 63
  %55 = lshr i64 %53, %54
  %56 = trunc i64 %55 to i1
  br i1 %56, label %cond_exit_677.thread.i, label %__barray_mask_borrow.exit228.i
...
mask_block_ok.i.i:                                ; preds = %cond_exit_677.thread.7.i, %73
  %.02.i.i = phi i64 [ %74, %73 ], [ 0, %cond_exit_677.thread.7.i ]
...
__barray_mask_borrow.exit228.i:                   ; preds = %loop_body.preheader.i
  ...
  %79 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %"674_1.sroa.10.0.i"
  %80 = load i64, ptr %79, align 4
  tail call void @___dec_future_refcount(i64 %80)
  br label %cond_exit_677.thread.i

cond_exit_677.thread.i:                           ; preds = %__barray_mask_borrow.exit228.i, %loop_body.preheader.i
  %81 = add i64 %"674_1.sroa.10.0.i", 1
  %82 = lshr i64 %81, 6
  %83 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %82
  %84 = load i64, ptr %83, align 4
  %85 = and i64 %81, 63
  %86 = lshr i64 %84, %85
  %87 = trunc i64 %86 to i1
  br i1 %87, label %cond_exit_677.thread.1.i, label %__barray_mask_borrow.exit228.1.i

__barray_mask_borrow.exit228.1.i:                 ; preds = %cond_exit_677.thread.i
  %88 = shl nuw i64 1, %85
  %89 = xor i64 %84, %88
  store i64 %89, ptr %83, align 4
  %90 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %81
  %91 = load i64, ptr %90, align 4
  tail call void @___dec_future_refcount(i64 %91)
  br label %cond_exit_677.thread.1.i

cond_exit_677.thread.1.i:                         ; preds = %__barray_mask_borrow.exit228.1.i, %cond_exit_677.thread.i
  %92 = add i64 %"674_1.sroa.10.0.i", 2
  %93 = lshr i64 %92, 6
  %94 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %93
  %95 = load i64, ptr %94, align 4
  %96 = and i64 %92, 63
  %97 = lshr i64 %95, %96
  %98 = trunc i64 %97 to i1
  br i1 %98, label %cond_exit_677.thread.2.i, label %__barray_mask_borrow.exit228.2.i

__barray_mask_borrow.exit228.2.i:                 ; preds = %cond_exit_677.thread.1.i
  %99 = shl nuw i64 1, %96
  %100 = xor i64 %95, %99
  store i64 %100, ptr %94, align 4
  %101 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %92
  %102 = load i64, ptr %101, align 4
  tail call void @___dec_future_refcount(i64 %102)
  br label %cond_exit_677.thread.2.i

cond_exit_677.thread.2.i:                         ; preds = %__barray_mask_borrow.exit228.2.i, %cond_exit_677.thread.1.i
  %103 = add i64 %"674_1.sroa.10.0.i", 3
  %104 = lshr i64 %103, 6
  %105 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %104
  %106 = load i64, ptr %105, align 4
  %107 = and i64 %103, 63
  %108 = lshr i64 %106, %107
  %109 = trunc i64 %108 to i1
  br i1 %109, label %cond_exit_677.thread.3.i, label %__barray_mask_borrow.exit228.3.i

__barray_mask_borrow.exit228.3.i:                 ; preds = %cond_exit_677.thread.2.i
  %110 = shl nuw i64 1, %107
  %111 = xor i64 %106, %110
  store i64 %111, ptr %105, align 4
  %112 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %103
  %113 = load i64, ptr %112, align 4
  tail call void @___dec_future_refcount(i64 %113)
  br label %cond_exit_677.thread.3.i

cond_exit_677.thread.3.i:                         ; preds = %__barray_mask_borrow.exit228.3.i, %cond_exit_677.thread.2.i
  %114 = add i64 %"674_1.sroa.10.0.i", 4
  %115 = lshr i64 %114, 6
  %116 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %115
  %117 = load i64, ptr %116, align 4
  %118 = and i64 %114, 63
  %119 = lshr i64 %117, %118
  %120 = trunc i64 %119 to i1
  br i1 %120, label %cond_exit_677.thread.4.i, label %__barray_mask_borrow.exit228.4.i

__barray_mask_borrow.exit228.4.i:                 ; preds = %cond_exit_677.thread.3.i
  %121 = shl nuw i64 1, %118
  %122 = xor i64 %117, %121
  store i64 %122, ptr %116, align 4
  %123 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %114
  %124 = load i64, ptr %123, align 4
  tail call void @___dec_future_refcount(i64 %124)
  br label %cond_exit_677.thread.4.i

cond_exit_677.thread.4.i:                         ; preds = %__barray_mask_borrow.exit228.4.i, %cond_exit_677.thread.3.i
  %125 = add i64 %"674_1.sroa.10.0.i", 5
  %126 = lshr i64 %125, 6
  %127 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %126
  %128 = load i64, ptr %127, align 4
  %129 = and i64 %125, 63
  %130 = lshr i64 %128, %129
  %131 = trunc i64 %130 to i1
  br i1 %131, label %cond_exit_677.thread.5.i, label %__barray_mask_borrow.exit228.5.i

__barray_mask_borrow.exit228.5.i:                 ; preds = %cond_exit_677.thread.4.i
  %132 = shl nuw i64 1, %129
  %133 = xor i64 %128, %132
  store i64 %133, ptr %127, align 4
  %134 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %125
  %135 = load i64, ptr %134, align 4
  tail call void @___dec_future_refcount(i64 %135)
  br label %cond_exit_677.thread.5.i

cond_exit_677.thread.5.i:                         ; preds = %__barray_mask_borrow.exit228.5.i, %cond_exit_677.thread.4.i
  %136 = add i64 %"674_1.sroa.10.0.i", 6
  %137 = lshr i64 %136, 6
  %138 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %137
  %139 = load i64, ptr %138, align 4
  %140 = and i64 %136, 63
  %141 = lshr i64 %139, %140
  %142 = trunc i64 %141 to i1
  br i1 %142, label %cond_exit_677.thread.6.i, label %__barray_mask_borrow.exit228.6.i

__barray_mask_borrow.exit228.6.i:                 ; preds = %cond_exit_677.thread.5.i
  %143 = shl nuw i64 1, %140
  %144 = xor i64 %139, %143
  store i64 %144, ptr %138, align 4
  %145 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %136
  %146 = load i64, ptr %145, align 4
  tail call void @___dec_future_refcount(i64 %146)
  br label %cond_exit_677.thread.6.i

cond_exit_677.thread.6.i:                         ; preds = %__barray_mask_borrow.exit228.6.i, %cond_exit_677.thread.5.i
  %147 = add i64 %"674_1.sroa.10.0.i", 7
  %148 = lshr i64 %147, 6
  %149 = getelementptr inbounds nuw i64, ptr %"674_1.sroa.5.0.i", i64 %148
  %150 = load i64, ptr %149, align 4
  %151 = and i64 %147, 63
  %152 = lshr i64 %150, %151
  %153 = trunc i64 %152 to i1
  br i1 %153, label %cond_exit_677.thread.7.i, label %__barray_mask_borrow.exit228.7.i

__barray_mask_borrow.exit228.7.i:                 ; preds = %cond_exit_677.thread.6.i
  %154 = shl nuw i64 1, %151
  %155 = xor i64 %150, %154
  store i64 %155, ptr %149, align 4
  %156 = getelementptr inbounds i64, ptr %"674_1.sroa.0.0.i", i64 %147
  %157 = load i64, ptr %156, align 4
  tail call void @___dec_future_refcount(i64 %157)
  br label %cond_exit_677.thread.7.i

cond_exit_677.thread.7.i:                         ; preds = %__barray_mask_borrow.exit228.7.i, %cond_exit_677.thread.6.i
...
"__hugr__.guppylang.std.array.ArrayIter.__next__$Measurement&8.378.exit": ; preds = %73, %cond_exit_677.thread.7.i
  tail call void @heap_free(ptr %"674_1.sroa.0.0.i")
  tail call void @heap_free(ptr nonnull %"674_1.sroa.5.0.i")
...
__barray_mask_borrow.exit878:                     ; preds = %cond_exit_120
  ...
  tail call void @___rp(i64 %193, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
