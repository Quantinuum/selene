...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit
...
cond_652_case_0.i:                                ; preds = %cond_exit_20.6, %cond_exit_20.5, %cond_exit_20.4, %cond_exit_20.3, %cond_exit_20.2, %cond_exit_20.1, %cond_exit_20, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_helios_qalloc.625.exit:            ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %8 = load i64, ptr %1, align 4
  %9 = trunc i64 %8 to i1
  br i1 %9, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.7, %__hugr__.__tk2_helios_qalloc.625.exit.6, %__hugr__.__tk2_helios_qalloc.625.exit.5, %__hugr__.__tk2_helios_qalloc.625.exit.4, %__hugr__.__tk2_helios_qalloc.625.exit.3, %__hugr__.__tk2_helios_qalloc.625.exit.2, %__hugr__.__tk2_helios_qalloc.625.exit.1, %__hugr__.__tk2_helios_qalloc.625.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_helios_qalloc.625.exit
  %10 = and i64 %8, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit.1

__hugr__.__tk2_helios_qalloc.625.exit.1:          ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_helios_qalloc.625.exit.1
  %13 = and i64 %11, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit.2

__hugr__.__tk2_helios_qalloc.625.exit.2:          ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_helios_qalloc.625.exit.2
  %17 = and i64 %15, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit.3

__hugr__.__tk2_helios_qalloc.625.exit.3:          ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_helios_qalloc.625.exit.3
  %21 = and i64 %19, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit.4

__hugr__.__tk2_helios_qalloc.625.exit.4:          ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_helios_qalloc.625.exit.4
  %25 = and i64 %23, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit.5

__hugr__.__tk2_helios_qalloc.625.exit.5:          ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_helios_qalloc.625.exit.5
  %29 = and i64 %27, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_652_case_0.i, label %__hugr__.__tk2_helios_qalloc.625.exit.6

__hugr__.__tk2_helios_qalloc.625.exit.6:          ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_helios_qalloc.625.exit.6
  %33 = and i64 %31, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_652_case_0.i, label %__barray_check_bounds.exit.7
...
__barray_mask_borrow.exit735:                     ; preds = %cond_exit_89
  ...
  tail call void @___rxy(i64 %54, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
loop_body.preheader.i.i:                          ; preds = %loop_body.i741
  %"672_1.sroa.10.0.i.i" = extractvalue { ptr, ptr, i64 } %232, 2
  %"672_1.sroa.5.0.i.i" = extractvalue { ptr, ptr, i64 } %232, 1
  %"672_1.sroa.0.0.i.i" = extractvalue { ptr, ptr, i64 } %232, 0
  %106 = lshr i64 %"672_1.sroa.10.0.i.i", 6
  %107 = getelementptr i64, ptr %"672_1.sroa.5.0.i.i", i64 %106
  %108 = load i64, ptr %107, align 4
  %109 = and i64 %"672_1.sroa.10.0.i.i", 63
  %110 = lshr i64 %108, %109
  %111 = trunc i64 %110 to i1
  br i1 %111, label %cond_exit_675.thread.i.i, label %__barray_mask_borrow.exit228.i.i
...
mask_block_ok.i.i.i745:                           ; preds = %cond_exit_675.thread.7.i.i, %128
  %.02.i.i.i746 = phi i64 [ %129, %128 ], [ 0, %cond_exit_675.thread.7.i.i ]
...
__barray_mask_borrow.exit228.i.i:                 ; preds = %loop_body.preheader.i.i
  ...
  %134 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %"672_1.sroa.10.0.i.i"
  %135 = load i64, ptr %134, align 4
  tail call void @___dec_future_refcount(i64 %135)
  br label %cond_exit_675.thread.i.i

cond_exit_675.thread.i.i:                         ; preds = %__barray_mask_borrow.exit228.i.i, %loop_body.preheader.i.i
  %136 = add i64 %"672_1.sroa.10.0.i.i", 1
  %137 = lshr i64 %136, 6
  %138 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %137
  %139 = load i64, ptr %138, align 4
  %140 = and i64 %136, 63
  %141 = lshr i64 %139, %140
  %142 = trunc i64 %141 to i1
  br i1 %142, label %cond_exit_675.thread.1.i.i, label %__barray_mask_borrow.exit228.1.i.i

__barray_mask_borrow.exit228.1.i.i:               ; preds = %cond_exit_675.thread.i.i
  %143 = shl nuw i64 1, %140
  %144 = xor i64 %139, %143
  store i64 %144, ptr %138, align 4
  %145 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %136
  %146 = load i64, ptr %145, align 4
  tail call void @___dec_future_refcount(i64 %146)
  br label %cond_exit_675.thread.1.i.i

cond_exit_675.thread.1.i.i:                       ; preds = %__barray_mask_borrow.exit228.1.i.i, %cond_exit_675.thread.i.i
  %147 = add i64 %"672_1.sroa.10.0.i.i", 2
  %148 = lshr i64 %147, 6
  %149 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %148
  %150 = load i64, ptr %149, align 4
  %151 = and i64 %147, 63
  %152 = lshr i64 %150, %151
  %153 = trunc i64 %152 to i1
  br i1 %153, label %cond_exit_675.thread.2.i.i, label %__barray_mask_borrow.exit228.2.i.i

__barray_mask_borrow.exit228.2.i.i:               ; preds = %cond_exit_675.thread.1.i.i
  %154 = shl nuw i64 1, %151
  %155 = xor i64 %150, %154
  store i64 %155, ptr %149, align 4
  %156 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %147
  %157 = load i64, ptr %156, align 4
  tail call void @___dec_future_refcount(i64 %157)
  br label %cond_exit_675.thread.2.i.i

cond_exit_675.thread.2.i.i:                       ; preds = %__barray_mask_borrow.exit228.2.i.i, %cond_exit_675.thread.1.i.i
  %158 = add i64 %"672_1.sroa.10.0.i.i", 3
  %159 = lshr i64 %158, 6
  %160 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %159
  %161 = load i64, ptr %160, align 4
  %162 = and i64 %158, 63
  %163 = lshr i64 %161, %162
  %164 = trunc i64 %163 to i1
  br i1 %164, label %cond_exit_675.thread.3.i.i, label %__barray_mask_borrow.exit228.3.i.i

__barray_mask_borrow.exit228.3.i.i:               ; preds = %cond_exit_675.thread.2.i.i
  %165 = shl nuw i64 1, %162
  %166 = xor i64 %161, %165
  store i64 %166, ptr %160, align 4
  %167 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %158
  %168 = load i64, ptr %167, align 4
  tail call void @___dec_future_refcount(i64 %168)
  br label %cond_exit_675.thread.3.i.i

cond_exit_675.thread.3.i.i:                       ; preds = %__barray_mask_borrow.exit228.3.i.i, %cond_exit_675.thread.2.i.i
  %169 = add i64 %"672_1.sroa.10.0.i.i", 4
  %170 = lshr i64 %169, 6
  %171 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %170
  %172 = load i64, ptr %171, align 4
  %173 = and i64 %169, 63
  %174 = lshr i64 %172, %173
  %175 = trunc i64 %174 to i1
  br i1 %175, label %cond_exit_675.thread.4.i.i, label %__barray_mask_borrow.exit228.4.i.i

__barray_mask_borrow.exit228.4.i.i:               ; preds = %cond_exit_675.thread.3.i.i
  %176 = shl nuw i64 1, %173
  %177 = xor i64 %172, %176
  store i64 %177, ptr %171, align 4
  %178 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %169
  %179 = load i64, ptr %178, align 4
  tail call void @___dec_future_refcount(i64 %179)
  br label %cond_exit_675.thread.4.i.i

cond_exit_675.thread.4.i.i:                       ; preds = %__barray_mask_borrow.exit228.4.i.i, %cond_exit_675.thread.3.i.i
  %180 = add i64 %"672_1.sroa.10.0.i.i", 5
  %181 = lshr i64 %180, 6
  %182 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %181
  %183 = load i64, ptr %182, align 4
  %184 = and i64 %180, 63
  %185 = lshr i64 %183, %184
  %186 = trunc i64 %185 to i1
  br i1 %186, label %cond_exit_675.thread.5.i.i, label %__barray_mask_borrow.exit228.5.i.i

__barray_mask_borrow.exit228.5.i.i:               ; preds = %cond_exit_675.thread.4.i.i
  %187 = shl nuw i64 1, %184
  %188 = xor i64 %183, %187
  store i64 %188, ptr %182, align 4
  %189 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %180
  %190 = load i64, ptr %189, align 4
  tail call void @___dec_future_refcount(i64 %190)
  br label %cond_exit_675.thread.5.i.i

cond_exit_675.thread.5.i.i:                       ; preds = %__barray_mask_borrow.exit228.5.i.i, %cond_exit_675.thread.4.i.i
  %191 = add i64 %"672_1.sroa.10.0.i.i", 6
  %192 = lshr i64 %191, 6
  %193 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %192
  %194 = load i64, ptr %193, align 4
  %195 = and i64 %191, 63
  %196 = lshr i64 %194, %195
  %197 = trunc i64 %196 to i1
  br i1 %197, label %cond_exit_675.thread.6.i.i, label %__barray_mask_borrow.exit228.6.i.i

__barray_mask_borrow.exit228.6.i.i:               ; preds = %cond_exit_675.thread.5.i.i
  %198 = shl nuw i64 1, %195
  %199 = xor i64 %194, %198
  store i64 %199, ptr %193, align 4
  %200 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %191
  %201 = load i64, ptr %200, align 4
  tail call void @___dec_future_refcount(i64 %201)
  br label %cond_exit_675.thread.6.i.i

cond_exit_675.thread.6.i.i:                       ; preds = %__barray_mask_borrow.exit228.6.i.i, %cond_exit_675.thread.5.i.i
  %202 = add i64 %"672_1.sroa.10.0.i.i", 7
  %203 = lshr i64 %202, 6
  %204 = getelementptr inbounds nuw i64, ptr %"672_1.sroa.5.0.i.i", i64 %203
  %205 = load i64, ptr %204, align 4
  %206 = and i64 %202, 63
  %207 = lshr i64 %205, %206
  %208 = trunc i64 %207 to i1
  br i1 %208, label %cond_exit_675.thread.7.i.i, label %__barray_mask_borrow.exit228.7.i.i

__barray_mask_borrow.exit228.7.i.i:               ; preds = %cond_exit_675.thread.6.i.i
  %209 = shl nuw i64 1, %206
  %210 = xor i64 %205, %209
  store i64 %210, ptr %204, align 4
  %211 = getelementptr inbounds i64, ptr %"672_1.sroa.0.0.i.i", i64 %202
  %212 = load i64, ptr %211, align 4
  tail call void @___dec_future_refcount(i64 %212)
  br label %cond_exit_675.thread.7.i.i

cond_exit_675.thread.7.i.i:                       ; preds = %__barray_mask_borrow.exit228.7.i.i, %cond_exit_675.thread.6.i.i
...
"__hugr__.guppylang.std.quantum.collect_measurements$8.294.exit": ; preds = %128, %cond_exit_675.thread.7.i.i
  tail call void @heap_free(ptr %"672_1.sroa.0.0.i.i")
  tail call void @heap_free(ptr nonnull %"672_1.sroa.5.0.i.i")
