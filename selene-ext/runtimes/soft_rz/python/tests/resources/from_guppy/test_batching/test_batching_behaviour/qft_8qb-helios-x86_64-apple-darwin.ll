...
alloca_block:
  ...
  br i1 %not_max.not.not.i, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit
...
cond_485_case_0.i:                                ; preds = %cond_exit_20.6, %cond_exit_20.5, %cond_exit_20.4, %cond_exit_20.3, %cond_exit_20.2, %cond_exit_20.1, %cond_exit_20, %alloca_block
  tail call void @panic(i32 1001, ptr nonnull @"e_No more qu.3B2EEBF0.0")
  unreachable

__hugr__.__tk2_qalloc.431.exit:                   ; preds = %alloca_block
  tail call void @___reset(i64 %qalloc.i)
  %8 = load i64, ptr %1, align 4
  %9 = trunc i64 %8 to i1
  br i1 %9, label %cond_exit_20, label %panic.i

panic.i:                                          ; preds = %__barray_check_bounds.exit.7, %__hugr__.__tk2_qalloc.431.exit.6, %__hugr__.__tk2_qalloc.431.exit.5, %__hugr__.__tk2_qalloc.431.exit.4, %__hugr__.__tk2_qalloc.431.exit.3, %__hugr__.__tk2_qalloc.431.exit.2, %__hugr__.__tk2_qalloc.431.exit.1, %__hugr__.__tk2_qalloc.431.exit
  tail call void @panic(i32 1002, ptr nonnull @"e_Array alre.5A300C2A.0")
  unreachable

cond_exit_20:                                     ; preds = %__hugr__.__tk2_qalloc.431.exit
  %10 = and i64 %8, -2
  ...
  br i1 %not_max.not.not.i.1, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit.1

__hugr__.__tk2_qalloc.431.exit.1:                 ; preds = %cond_exit_20
...
cond_exit_20.1:                                   ; preds = %__hugr__.__tk2_qalloc.431.exit.1
  %13 = and i64 %11, -3
  ...
  br i1 %not_max.not.not.i.2, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit.2

__hugr__.__tk2_qalloc.431.exit.2:                 ; preds = %cond_exit_20.1
...
cond_exit_20.2:                                   ; preds = %__hugr__.__tk2_qalloc.431.exit.2
  %17 = and i64 %15, -5
  ...
  br i1 %not_max.not.not.i.3, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit.3

__hugr__.__tk2_qalloc.431.exit.3:                 ; preds = %cond_exit_20.2
...
cond_exit_20.3:                                   ; preds = %__hugr__.__tk2_qalloc.431.exit.3
  %21 = and i64 %19, -9
  ...
  br i1 %not_max.not.not.i.4, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit.4

__hugr__.__tk2_qalloc.431.exit.4:                 ; preds = %cond_exit_20.3
...
cond_exit_20.4:                                   ; preds = %__hugr__.__tk2_qalloc.431.exit.4
  %25 = and i64 %23, -17
  ...
  br i1 %not_max.not.not.i.5, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit.5

__hugr__.__tk2_qalloc.431.exit.5:                 ; preds = %cond_exit_20.4
...
cond_exit_20.5:                                   ; preds = %__hugr__.__tk2_qalloc.431.exit.5
  %29 = and i64 %27, -33
  ...
  br i1 %not_max.not.not.i.6, label %cond_485_case_0.i, label %__hugr__.__tk2_qalloc.431.exit.6

__hugr__.__tk2_qalloc.431.exit.6:                 ; preds = %cond_exit_20.5
...
cond_exit_20.6:                                   ; preds = %__hugr__.__tk2_qalloc.431.exit.6
  %33 = and i64 %31, -65
  ...
  br i1 %not_max.not.not.i.7, label %cond_485_case_0.i, label %__barray_check_bounds.exit.7
...
53:                                               ; preds = %__barray_check_none_borrowed.exit, %"__hugr__.$__copy_scan$$n(8)$t([Bool]+[Future(Bool)])$n(1).311.exit"
  %storemerge832971 = phi i64 [ 0, %__barray_check_none_borrowed.exit ], [ %61, %"__hugr__.$__copy_scan$$n(8)$t([Bool]+[Future(Bool)])$n(1).311.exit" ]
  ...
  br i1 %.fca.0.extract118.i, label %cond_307_case_1.i, label %cond_307_case_0.i

cond_307_case_0.i:                                ; preds = %53
  %.fca.2.extract120.i = extractvalue { i1, i64, i1 } %55, 2
  br label %cond_exit_307.i

cond_307_case_1.i:                                ; preds = %53
  %.fca.1.extract119.i = extractvalue { i1, i64, i1 } %55, 1
  tail call void @___inc_future_refcount(i64 %.fca.1.extract119.i)
  br label %cond_exit_307.i

cond_exit_307.i:                                  ; preds = %cond_307_case_0.i, %cond_307_case_1.i
  %"03.sroa.3.0.i" = phi i64 [ %.fca.1.extract119.i, %cond_307_case_1.i ], [ undef, %cond_307_case_0.i ]
  %"03.sroa.6.0.i" = phi i1 [ undef, %cond_307_case_1.i ], [ %.fca.2.extract120.i, %cond_307_case_0.i ]
  %56 = load i64, ptr %248, align 4
  %57 = lshr i64 %56, %storemerge832971
  %58 = trunc i64 %57 to i1
  br i1 %58, label %panic.i.i, label %cond_304_case_1.i

panic.i.i:                                        ; preds = %cond_exit_307.i
  tail call void @panic(i32 1002, ptr nonnull @"e_Array elem.E746B1A3.0")
  unreachable

cond_304_case_1.i:                                ; preds = %cond_exit_307.i
  ...
  br i1 %.fca.2.0.extract.i, label %cond_303_case_1.i, label %"__hugr__.$__copy_scan$$n(8)$t([Bool]+[Future(Bool)])$n(1).311.exit"

cond_303_case_1.i:                                ; preds = %cond_304_case_1.i
  tail call void @panic(i32 1001, ptr nonnull @"e_Expected v.2F17E0A9.0")
  unreachable

"__hugr__.$__copy_scan$$n(8)$t([Bool]+[Future(Bool)])$n(1).311.exit": ; preds = %cond_304_case_1.i
...
mask_block_ok.i875:                               ; preds = %"__hugr__.$__copy_scan$$n(8)$t([Bool]+[Future(Bool)])$n(1).311.exit"
...
__barray_check_none_borrowed.exit880:             ; preds = %mask_block_ok.i875
  ...
  %69 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %68)
  ...
  %73 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %72)
  ...
  %78 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %77)
  ...
  %83 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %82)
  ...
  %88 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %87)
  ...
  %93 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %92)
  ...
  %98 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %97)
  ...
  %103 = tail call { { i1, i64, i1 } } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %102)
  ...
  br i1 %107, label %cond_exit_719, label %__barray_mask_borrow.exit891

mask_block_err.i878:                              ; preds = %mask_block_ok.i875
  tail call void @panic(i32 1002, ptr nonnull @"e_Some array.A77EF32E.0")
  unreachable

mask_block_err.i884:                              ; preds = %cond_exit_719.7
...
__barray_mask_borrow.exit891:                     ; preds = %__barray_check_none_borrowed.exit880
  ...
  br i1 %.fca.0.extract601, label %cond_742_case_1, label %cond_exit_719

cond_exit_719:                                    ; preds = %cond_742_case_1, %__barray_mask_borrow.exit891, %__barray_check_none_borrowed.exit880
  %110 = load i64, ptr %67, align 4
  %111 = and i64 %110, 2
  %.not998 = icmp eq i64 %111, 0
  br i1 %.not998, label %__barray_mask_borrow.exit891.1, label %cond_exit_719.1

__barray_mask_borrow.exit891.1:                   ; preds = %cond_exit_719
  ...
  br i1 %.fca.0.extract601.1, label %cond_742_case_1.1, label %cond_exit_719.1

cond_742_case_1.1:                                ; preds = %__barray_mask_borrow.exit891.1
  %.fca.1.extract602.1 = extractvalue { i1, i64, i1 } %114, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.1)
  br label %cond_exit_719.1

cond_exit_719.1:                                  ; preds = %cond_742_case_1.1, %__barray_mask_borrow.exit891.1, %cond_exit_719
  %115 = load i64, ptr %67, align 4
  %116 = and i64 %115, 4
  %.not999 = icmp eq i64 %116, 0
  br i1 %.not999, label %__barray_mask_borrow.exit891.2, label %cond_exit_719.2

__barray_mask_borrow.exit891.2:                   ; preds = %cond_exit_719.1
  ...
  br i1 %.fca.0.extract601.2, label %cond_742_case_1.2, label %cond_exit_719.2

cond_742_case_1.2:                                ; preds = %__barray_mask_borrow.exit891.2
  %.fca.1.extract602.2 = extractvalue { i1, i64, i1 } %119, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.2)
  br label %cond_exit_719.2

cond_exit_719.2:                                  ; preds = %cond_742_case_1.2, %__barray_mask_borrow.exit891.2, %cond_exit_719.1
  %120 = load i64, ptr %67, align 4
  %121 = and i64 %120, 8
  %.not1000 = icmp eq i64 %121, 0
  br i1 %.not1000, label %__barray_mask_borrow.exit891.3, label %cond_exit_719.3

__barray_mask_borrow.exit891.3:                   ; preds = %cond_exit_719.2
  ...
  br i1 %.fca.0.extract601.3, label %cond_742_case_1.3, label %cond_exit_719.3

cond_742_case_1.3:                                ; preds = %__barray_mask_borrow.exit891.3
  %.fca.1.extract602.3 = extractvalue { i1, i64, i1 } %124, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.3)
  br label %cond_exit_719.3

cond_exit_719.3:                                  ; preds = %cond_742_case_1.3, %__barray_mask_borrow.exit891.3, %cond_exit_719.2
  %125 = load i64, ptr %67, align 4
  %126 = and i64 %125, 16
  %.not1001 = icmp eq i64 %126, 0
  br i1 %.not1001, label %__barray_mask_borrow.exit891.4, label %cond_exit_719.4

__barray_mask_borrow.exit891.4:                   ; preds = %cond_exit_719.3
  ...
  br i1 %.fca.0.extract601.4, label %cond_742_case_1.4, label %cond_exit_719.4

cond_742_case_1.4:                                ; preds = %__barray_mask_borrow.exit891.4
  %.fca.1.extract602.4 = extractvalue { i1, i64, i1 } %129, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.4)
  br label %cond_exit_719.4

cond_exit_719.4:                                  ; preds = %cond_742_case_1.4, %__barray_mask_borrow.exit891.4, %cond_exit_719.3
  %130 = load i64, ptr %67, align 4
  %131 = and i64 %130, 32
  %.not1002 = icmp eq i64 %131, 0
  br i1 %.not1002, label %__barray_mask_borrow.exit891.5, label %cond_exit_719.5

__barray_mask_borrow.exit891.5:                   ; preds = %cond_exit_719.4
  ...
  br i1 %.fca.0.extract601.5, label %cond_742_case_1.5, label %cond_exit_719.5

cond_742_case_1.5:                                ; preds = %__barray_mask_borrow.exit891.5
  %.fca.1.extract602.5 = extractvalue { i1, i64, i1 } %134, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.5)
  br label %cond_exit_719.5

cond_exit_719.5:                                  ; preds = %cond_742_case_1.5, %__barray_mask_borrow.exit891.5, %cond_exit_719.4
  %135 = load i64, ptr %67, align 4
  %136 = and i64 %135, 64
  %.not1003 = icmp eq i64 %136, 0
  br i1 %.not1003, label %__barray_mask_borrow.exit891.6, label %cond_exit_719.6

__barray_mask_borrow.exit891.6:                   ; preds = %cond_exit_719.5
  ...
  br i1 %.fca.0.extract601.6, label %cond_742_case_1.6, label %cond_exit_719.6

cond_742_case_1.6:                                ; preds = %__barray_mask_borrow.exit891.6
  %.fca.1.extract602.6 = extractvalue { i1, i64, i1 } %139, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.6)
  br label %cond_exit_719.6

cond_exit_719.6:                                  ; preds = %cond_742_case_1.6, %__barray_mask_borrow.exit891.6, %cond_exit_719.5
  %140 = load i64, ptr %67, align 4
  %141 = and i64 %140, 128
  %.not1004 = icmp eq i64 %141, 0
  br i1 %.not1004, label %__barray_mask_borrow.exit891.7, label %cond_exit_719.7

__barray_mask_borrow.exit891.7:                   ; preds = %cond_exit_719.6
  ...
  br i1 %.fca.0.extract601.7, label %cond_742_case_1.7, label %cond_exit_719.7

cond_742_case_1.7:                                ; preds = %__barray_mask_borrow.exit891.7
  %.fca.1.extract602.7 = extractvalue { i1, i64, i1 } %144, 1
  tail call void @___dec_future_refcount(i64 %.fca.1.extract602.7)
  br label %cond_exit_719.7

cond_exit_719.7:                                  ; preds = %cond_742_case_1.7, %__barray_mask_borrow.exit891.7, %cond_exit_719.6
...
loop_out153:                                      ; preds = %cond_exit_719.7
...
__barray_mask_borrow.exit905:                     ; preds = %cond_exit_91
  ...
  tail call void @___rxy(i64 %198, double 0x3FF921FB54442D18, double 0xBFF921FB54442D18)
...
__barray_check_bounds.exit920:                    ; preds = %__barray_check_bounds.exit915
  ...
  %266 = fneg double %265
  tail call void @___rzz(i64 %3, i64 %263, double %266)
...
alloca_block:
  ...
  br i1 %.fca.0.extract, label %cond_418_case_1, label %cond_418_case_0

cond_418_case_0:                                  ; preds = %alloca_block
  %.fca.2.extract = extractvalue { i1, i64, i1 } %0, 2
  br label %cond_exit_418

cond_418_case_1:                                  ; preds = %alloca_block
...
cond_exit_418:                                    ; preds = %cond_418_case_1, %cond_418_case_0
  %"03.0" = phi i1 [ %read_bool, %cond_418_case_1 ], [ %.fca.2.extract, %cond_418_case_0 ]
  ret i1 %"03.0"
}

declare void @heap_free(ptr) local_unnamed_addr

define internal { i1, i64, i1 } @"__hugr__.$__unwrap$$t([Bool]+[Future(Bool)]).624"({ i1, { i1, i64, i1 } } %0) unnamed_addr {
alloca_block:
  %.fca.0.extract11 = extractvalue { i1, { i1, i64, i1 } } %0, 0
  br i1 %.fca.0.extract11, label %cond_627_case_1, label %cond_627_case_0

cond_627_case_1:                                  ; preds = %alloca_block
  %1 = extractvalue { i1, { i1, i64, i1 } } %0, 1
  ret { i1, i64, i1 } %1

cond_627_case_0:                                  ; preds = %alloca_block
